...
欢迎使用 .NET API 浏览器，这是 Microsoft 提供的所有 .NET API 的一站式商店。 在下面的框中键入字词，开始搜索任意托管 API 吧。 可以通过[我们的博文](https://aka.ms/apibrowser)详细了解 API 浏览器。 如有任何反馈意见，请访问 [UserVoice 网站](https://aka.ms/apibrowserfeedback)。
