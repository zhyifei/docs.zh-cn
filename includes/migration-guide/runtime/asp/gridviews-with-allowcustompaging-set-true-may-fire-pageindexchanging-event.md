...
|   |   |
|---|---|
|详细信息|.NET Framework 4.5 中的 bug 导致 <xref:System.Web.UI.WebControls.GridView.PageIndexChanging?displayProperty=name> 有时在遇到已启用 <xref:System.Web.UI.WebControls.GridView?displayProperty=name> 的 <xref:System.Web.UI.WebControls.GridView.AllowCustomPaging?displayProperty=name> 时不会触发。|
