...
|建议|若要在 Windows 10 创意者更新中使用旧堆栈，请将 <code>UseXpsOMPrinting</code> 注册表项的 <code>HKEY_CURRENT_USER\Software\Microsoft\.NETFramework\Windows Presentation Foundation\Printing</code> REG_DWORD 值设置为 <code>1</code>。|
|范围|边缘|
|Version|4.7|
|类型|运行时|
