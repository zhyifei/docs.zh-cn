...
|   |   |
|---|---|
|详细信息|在 .NET Framework 4.6.2 和更低版本中，当工作流活动的 Execute 方法引发 <code>null</code> 属性 <xref:System.Exception.Message> 值的异常，那么 System.Activities 工作流运行时引发 <xref:System.NullReferenceException?displayProperty=name> 掩码原始异常。在 .NET Framework 4.7 中，引发之前掩码的异常。|
