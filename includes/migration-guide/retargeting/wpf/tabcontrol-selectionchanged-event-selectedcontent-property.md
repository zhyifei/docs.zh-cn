...
|   |   |
|---|---|
|详细信息|从 .NET Framework 4.7.1 开始，当选择发生变化时，<xref:System.Windows.Controls.TabControl> 在引发 <xref:System.Windows.Controls.TabControl.SelectedContent> 事件之前更新其 <xref:System.Windows.Controls.Primitives.Selector.SelectionChanged> 属性的值。而在 .NET Framework 4.7 和更早版本中，在事件发生之后才更新到 SelectedContent。|
