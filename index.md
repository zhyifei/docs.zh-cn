                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/dotnet/desktop-wpf/">桌面指南 (WPF)</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/xamarin/cross-platform/">跨平台开发</a></p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/dotnet/csharp/whats-new/">C# 中的新增功能</a></p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/dotnet/visual-basic/getting-started/">入门</a></p>
                                                <p><a href="/dotnet/visual-basic/walkthroughs">演练</a></p>
                                                <p><a href="/dotnet/visual-basic/language-reference/">Visual Basic 语言参考</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p><a href="/dotnet/machine-learning/resources/glossary">术语表</a></p>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ASP.NET Core 教程</h3>
                                                    <p>发现适用于你的不同分步指南，了解如何开发 ASP.NET Core 应用程序。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>了解使用 Visual Studio 生成 ASP.NET Core MVC Web 应用的基础知识。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 容器中的 ASP.NET MVC 应用</h3>
                                                    <p>了解如何利用 Docker 部署 ASP.NET MVC 应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure for .NET 文档</h3>
                                                    <p>了解 Azure 服务，例如 Web 应用、WebJobs、云服务和 VM。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure 存储</h3>
                                                    <p>了解 Azure 存储，并了解如何使用 Azure Blob、表格、队列和文件创建应用程序。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>在 Azure 上使用 F#</h3>
                                                    <p>了解如何在 F# 使用各种 Azure 服务，例如 Azure 存储、云服务和 Azure Functions。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin.iOS</h3>
                                                    <p>通过 Xamarin.iOS，利用 C# 和 F# 创建本机 iOS 应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>通过 Xamarin.Android，利用 C# 和 F# 创建本机 Android 应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Xamarin.Forms</h3>
                                                    <p>通过 Xamarin.Forms，使用 C# 和 F# 创建跨平台移动 UI。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>通用 Windows 应用</h3>
                                                    <p>了解如何创建在所有 Windows 10 设备上运行的通用 Windows 应用。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>WPF 向开发人员提供了基于 XAML 的模型，用于在 Windows 上构建桌面应用程序。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>通过 Xamarin，利用 C# 和 F# 创建 macOS 版应用。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>利用 Visual Studio 开发游戏</h3>
                                                    <p>通过 Visual Studio，自行选择游戏引擎来编写和调试游戏。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>通过 MonoGame 库文档中心处的教程和设置说明，使用 C# 构建游戏。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Unity</h3>
                                                    <p>了解如何使用 Unity 结合 C# 和 Unity Manual 来构建 2D 和 3D 游戏。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ML.NET</h3>
                                                    <p>生成自定义 AI 解决方案并将其集成到 .NET 应用程序。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>认知服务</h3>
                                                    <p>为应用、网站和机器人注入智能，从而执行看、听、说和理解操作。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure 机器学习</h3>
                                                    <p>通过不断的试验和模型管理，打造端到端且可缩放的受信任平台，借助该平台可让每个人都能使用 AI。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>在编写 .NET 代码的任何地方处理批量数据、实时流、机器学习和临时查询。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>.NET 微服务：适用于容器化 .NET 应用程序的体系结构</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 Microsoft 平台和工具的容器化 Docker 应用程序的生命周期</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 Azure 云和 Windows 容器现代化现有 .NET 应用程序</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 ASP.NET Core 和 Azure 构建新式 Web 应用程序</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>无服务器应用：体系结构、模式和 Azure 实现</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>预览</strong>为 Azure 构建云本机 .NET 应用程序</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>预览</strong> Blazor for ASP.NET Web Forms 开发人员</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3><strong>预览</strong>适用于 WCF 开发人员的 ASP.NET Core gRPC</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
