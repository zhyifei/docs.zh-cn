...
## <a name="remarks"></a>备注  
 有关的方法和属性的信息`My.Computer.Ports`对象，请参阅<xref:Microsoft.VisualBasic.Devices.Ports>。  
  
 有关详细信息，请参阅[访问计算机的端口](../../../visual-basic/developing-apps/programming/computer-resources/accessing-the-computer-s-ports.md)。  
  
> [!NOTE]
>  你还可以使用的属性和方法<xref:System.IO.Ports.SerialPort?displayProperty=nameWithType>类来访问计算机的串行端口。  
