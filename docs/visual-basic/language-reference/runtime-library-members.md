...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="f4dff-102">Visual Basic 运行库成员</span><span class="sxs-lookup"><span data-stu-id="f4dff-102">Visual Basic Runtime Library Members</span></span>

<span data-ttu-id="f4dff-103">`Microsoft.VisualBasic` 命名空间包含构成 Visual Basic 运行时库的类、模块、常量和枚举。</span><span class="sxs-lookup"><span data-stu-id="f4dff-103">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="f4dff-104">这些库成员提供您可以在代码中使用的过程、属性和常量值。</span><span class="sxs-lookup"><span data-stu-id="f4dff-104">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="f4dff-105">每个模块和类表示一种特定的功能类别。</span><span class="sxs-lookup"><span data-stu-id="f4dff-105">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="f4dff-106">Microsoft. 集合类</span><span class="sxs-lookup"><span data-stu-id="f4dff-106">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="f4dff-107">ComClassAttribute 类</span><span class="sxs-lookup"><span data-stu-id="f4dff-107">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="f4dff-108">ControlChars 类</span><span class="sxs-lookup"><span data-stu-id="f4dff-108">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="f4dff-109">Microsoft. 常量类</span><span class="sxs-lookup"><span data-stu-id="f4dff-109">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="f4dff-110">Microsoft. 转换模块</span><span class="sxs-lookup"><span data-stu-id="f4dff-110">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="f4dff-111">Formatting.dateandtime.custom 模块</span><span class="sxs-lookup"><span data-stu-id="f4dff-111">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="f4dff-112">ErrObject 类</span><span class="sxs-lookup"><span data-stu-id="f4dff-112">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="f4dff-113">Microsoft.VisualBasic.FileSystem Module</span><span class="sxs-lookup"><span data-stu-id="f4dff-113">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="f4dff-114">Microsoft. 金融模块</span><span class="sxs-lookup"><span data-stu-id="f4dff-114">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="f4dff-115">Microsoft. Globals 模块</span><span class="sxs-lookup"><span data-stu-id="f4dff-115">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="f4dff-116">HideModuleNameAttribute 类</span><span class="sxs-lookup"><span data-stu-id="f4dff-116">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="f4dff-117">Microsoft. 信息模块</span><span class="sxs-lookup"><span data-stu-id="f4dff-117">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="f4dff-118">Microsoft。</span><span class="sxs-lookup"><span data-stu-id="f4dff-118">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="f4dff-119">MyGroupCollectionAttribute 类</span><span class="sxs-lookup"><span data-stu-id="f4dff-119">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="f4dff-120">Microsoft. 字符串模块</span><span class="sxs-lookup"><span data-stu-id="f4dff-120">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="f4dff-121">VBFixedArrayAttribute 类</span><span class="sxs-lookup"><span data-stu-id="f4dff-121">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="f4dff-122">VBFixedStringAttribute 类</span><span class="sxs-lookup"><span data-stu-id="f4dff-122">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="f4dff-123">VbMath 模块</span><span class="sxs-lookup"><span data-stu-id="f4dff-123">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="f4dff-124">Microsoft。</span><span class="sxs-lookup"><span data-stu-id="f4dff-124">Microsoft.VisualBasic Constants and Enumerations</span></span>  

 <span data-ttu-id="f4dff-125">`Microsoft.VisualBasic` 命名空间提供常量和枚举作为 Visual Basic 运行时库的一部分。</span><span class="sxs-lookup"><span data-stu-id="f4dff-125">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="f4dff-126">你可以在代码中使用这些常量值。</span><span class="sxs-lookup"><span data-stu-id="f4dff-126">You can use these constant values in your code.</span></span> <span data-ttu-id="f4dff-127">每个枚举表示一种特定的功能类别。</span><span class="sxs-lookup"><span data-stu-id="f4dff-127">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="f4dff-128">有关详细信息，请参阅[常量和枚举](../../visual-basic/language-reference/constants-and-enumerations.md)。</span><span class="sxs-lookup"><span data-stu-id="f4dff-128">For more information, see [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="f4dff-129">另请参阅</span><span class="sxs-lookup"><span data-stu-id="f4dff-129">See also</span></span>

- [<span data-ttu-id="f4dff-130">常量和枚举</span><span class="sxs-lookup"><span data-stu-id="f4dff-130">Constants and Enumerations</span></span>](../../visual-basic/language-reference/constants-and-enumerations.md)
- [<span data-ttu-id="f4dff-131">关键字</span><span class="sxs-lookup"><span data-stu-id="f4dff-131">Keywords</span></span>](../../visual-basic/language-reference/keywords/index.md)
