...
`Microsoft.VisualBasic` 命名空间包含构成 Visual Basic 运行时库的类、模块、常量和枚举。 这些库成员提供您可以在代码中使用的过程、属性和常量值。 每个模块和类表示一种特定的功能类别。  
  
## <a name="microsoftvisualbasiccollection-class"></a>Microsoft. 集合类  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a>ComClassAttribute 类  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a>ControlChars 类  
...
## <a name="microsoftvisualbasicconstants-class"></a>Microsoft. 常量类  
...
## <a name="microsoftvisualbasicconversion-module"></a>Microsoft. 转换模块  
...
## <a name="microsoftvisualbasicdateandtime-module"></a>Formatting.dateandtime.custom 模块  
...
## <a name="microsoftvisualbasicerrobject-class"></a>ErrObject 类  
...
## <a name="microsoftvisualbasicfinancial-module"></a>Microsoft. 金融模块  
...
## <a name="microsoftvisualbasicglobals-module"></a>Microsoft. Globals 模块  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a>HideModuleNameAttribute 类  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a>Microsoft. 信息模块  
...
## <a name="microsoftvisualbasicinteraction-module"></a>Microsoft。  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a>MyGroupCollectionAttribute 类  
...
## <a name="microsoftvisualbasicstrings-module"></a>Microsoft. 字符串模块  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a>VBFixedArrayAttribute 类  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a>VBFixedStringAttribute 类  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a>VbMath 模块  
...
## <a name="microsoftvisualbasic-constants-and-enumerations"></a>Microsoft。  
 ...
 `Microsoft.VisualBasic` 命名空间提供常量和枚举作为 Visual Basic 运行时库的一部分。 你可以在代码中使用这些常量值。 每个枚举表示一种特定的功能类别。 有关详细信息，请参阅[常量和枚举](../../visual-basic/language-reference/constants-and-enumerations.md)。  
