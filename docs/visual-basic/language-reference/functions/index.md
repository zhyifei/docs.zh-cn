...
ms.locfileid: "61802513"
---
# <a name="functions-visual-basic"></a>函数 (Visual Basic)
本节中的主题包含 Visual Basic 运行时成员函数表。  
  
> [!NOTE]
>  还可以创建函数并调用它们。 有关详细信息，请参阅[Function 语句](../../../visual-basic/language-reference/statements/function-statement.md)和[如何：创建一个过程，返回一个值](../../../visual-basic/programming-guide/language-features/procedures/how-to-create-a-procedure-that-returns-a-value.md)。  
