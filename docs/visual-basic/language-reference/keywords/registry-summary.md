...
ms.locfileid: "33602770"
---
# <a name="registry-summary-visual-basic"></a>注册表摘要 (Visual Basic)
Visual Studio 语言关键字和运行时库成员按目的组织和用途。  
  
 使用`My`功能让你更好的工作效率和注册表操作比使用这些元素中的性能。 有关详细信息，请参阅<xref:Microsoft.VisualBasic.MyServices.RegistryProxy>。  
