...
|调用的方法或属性。|<xref:Microsoft.VisualBasic.Interaction.CallByName%2A>|  
|从计算机提示音。|<xref:Microsoft.VisualBasic.Interaction.Beep%2A>|  
...
|控制对话框|<xref:Microsoft.VisualBasic.Interaction.InputBox%2A>, <xref:Microsoft.VisualBasic.Interaction.MsgBox%2A>|  
