...
|[CInt](../../../visual-basic/language-reference/functions/type-conversion-functions.md)|[Class Constraint](../../../visual-basic/language-reference/statements/type-list.md)|[Class 语句](../../../visual-basic/language-reference/statements/class-statement.md)|[CLng](../../../visual-basic/language-reference/functions/type-conversion-functions.md)|  
...
|[错误](../../../visual-basic/language-reference/statements/on-error-statement.md)|[Event](../../../visual-basic/language-reference/statements/event-statement.md)|[退出](../../../visual-basic/language-reference/statements/exit-statement.md)|[False](../../../visual-basic/language-reference/data-types/boolean-data-type.md)|  
...
|[如果](../../../visual-basic/language-reference/statements/if-then-else-statement.md)|[If()](../../../visual-basic/language-reference/operators/if-operator.md)|[Implements](../../../visual-basic/language-reference/statements/implements-clause.md)|[Implements 语句](../../../visual-basic/language-reference/statements/implements-statement.md)|  
|[Imports (.NET Namespace and Type)](../../../visual-basic/language-reference/statements/imports-statement-net-namespace-and-type.md)|[Imports (XML Namespace)](../../../visual-basic/language-reference/statements/imports-statement-xml-namespace.md)|[In](../../../visual-basic/language-reference/statements/in-clause.md)|[In（泛型修饰符）](../../../visual-basic/language-reference/modifiers/in-generic-modifier.md)|  
...
|[对象](../../../visual-basic/language-reference/data-types/object-data-type.md)|[Of](../../../visual-basic/language-reference/statements/of-clause.md)|[On](../../../visual-basic/misc/on.md)|[“运算符”](../../../visual-basic/language-reference/statements/operator-statement.md)|  
...
|[Out（泛型修饰符）](../../../visual-basic/language-reference/modifiers/out-generic-modifier.md)|[重载](../../../visual-basic/language-reference/modifiers/overloads.md)|[Overridable](../../../visual-basic/language-reference/modifiers/overridable.md)|[Overrides](../../../visual-basic/language-reference/modifiers/overrides.md)|  
...
> [!NOTE]
> `EndIf`、 `GoSub`、和`Wend`保留为保留关键字，不过它们不再用于 Visual Basic。 `Variant` `Let` 关键字的含义已更改。 `Let` 现用于 LINQ 查询。 有关详细信息，请参阅 [Let 子句](../../../visual-basic/language-reference/queries/let-clause.md)。  
...
|[自定义](../../../visual-basic/language-reference/statements/event-statement.md)|[Distinct](../../../visual-basic/language-reference/queries/distinct-clause.md)|[Equals](../../../visual-basic/language-reference/queries/equals-clause.md)|[Explicit](../../../visual-basic/language-reference/statements/option-explicit-statement.md)|  
...
|[Take](../../../visual-basic/language-reference/queries/take-clause.md)|[Take While](../../../visual-basic/language-reference/queries/take-while-clause.md)|[“文本”](../../../visual-basic/language-reference/statements/option-compare-statement.md)|[Unicode](../../../visual-basic/language-reference/modifiers/unicode.md)|  
...
|[日期和时间摘要](../../../visual-basic/language-reference/keywords/dates-and-times-summary.md)|列出了用于日期和时间的语言元素。|  
|[声明和常量摘要](../../../visual-basic/language-reference/keywords/declarations-and-constants-summary.md)|列出了用于声明变量、常量、类、模块和其他编程元素的语句。 此外，还列出了用于获取对象信息、处理事件并实现继承的语言元素。|  
|[目录和文件摘要](../../../visual-basic/language-reference/keywords/directories-and-files-summary.md)|列出了用于控制文件系统和处理文件的函数。|  
|[错误摘要](../../../visual-basic/language-reference/keywords/errors-summary.md)|列出了用于捕获和返回运行时错误值的语言元素。|  
|[财务摘要](../../../visual-basic/language-reference/keywords/financial-summary.md)|列出了用于执行财务计算的函数。|  
|[输入和输出摘要](../../../visual-basic/language-reference/keywords/input-and-output-summary.md)|列出了用于读取和写入文件、管理文件并打印输出的函数。|  
|[信息和交互摘要](../../../visual-basic/language-reference/keywords/information-and-interaction-summary.md)|列出了用于运行其他程序、获取命令行参数、操控 COM 对象、检索颜色信息和使用控制对话框的函数。|  
|[数学摘要](../../../visual-basic/language-reference/keywords/math-summary.md)|列出了用于执行三角函数和其他数学计算的函数。|  
|[My 引用](../../../visual-basic/language-reference/keywords/my-reference.md)|列出了 `My` 中包含的对象，这种功能可协助访问运行应用的计算机的常用方法、属性和事件、当前应用、应用资源以及应用设置等。|  
|[运算符摘要](../../../visual-basic/language-reference/keywords/operators-summary.md)|列出了赋值和比较表达式以及其他运算符。|  
