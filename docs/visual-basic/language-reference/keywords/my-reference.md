...
|访问主机计算机和其资源、 服务和数据。|`My.Computer` (<xref:Microsoft.VisualBasic.Devices.Computer>)|  
...
|访问当前的 web 请求。|[My.Request 对象](../../../visual-basic/language-reference/objects/my-request-object.md)|  
|访问资源的元素。|[My.Resources 对象](../../../visual-basic/language-reference/objects/my-resources-object.md)|  
|访问当前的 web 响应。|[My.Response 对象](../../../visual-basic/language-reference/objects/my-response-object.md)|  
|访问用户和应用程序级别设置。|[My.Settings 对象](../../../visual-basic/language-reference/objects/my-settings-object.md)|  
