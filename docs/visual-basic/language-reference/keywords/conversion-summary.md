...
|Convert time to hour, minute, or second.|<xref:Microsoft.VisualBasic.DateAndTime.Hour%2A>中， <xref:Microsoft.VisualBasic.DateAndTime.Minute%2A>中， <xref:Microsoft.VisualBasic.DateAndTime.Second%2A>|  
