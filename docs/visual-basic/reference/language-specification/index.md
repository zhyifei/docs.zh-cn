...
[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] 语言规范是解答有关 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] 语法和句法的所有问题的权威资源。 其中包含有关该语言的详细信息，包括 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] 参考文档中并未涵盖的许多要点。  
