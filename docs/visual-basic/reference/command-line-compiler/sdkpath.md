...
## <a name="remarks"></a>备注  
 此选项指示[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]编译器从非默认位置加载的 mscorlib.dll 和 Microsoft.VisualBasic.dll 文件。 `-sdkpath`选项旨在用于[-netcf](../../../visual-basic/reference/command-line-compiler/netcf.md)。 [!INCLUDE[Compact](~/includes/compact-md.md)]使用支持不同版本的这些库，以避免使用的类型和设备上未找到的语言功能。  
