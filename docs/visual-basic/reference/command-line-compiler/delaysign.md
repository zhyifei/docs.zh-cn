...
## <a name="arguments"></a>参数  
 `+` &#124; `-`  
 可选。 如果需要完全签名的程序集，则使用 `-delaysign-`。 如果希望将公钥放在程序集中，并为签名的哈希保留空间，请使用 `-delaysign+`。 默认值为 `-delaysign-`。  
  
## <a name="remarks"></a>备注  
 @No__t-0 选项不起作用，除非与[-keyfile](../../../visual-basic/reference/command-line-compiler/keyfile.md)或[-keycontainer](../../../visual-basic/reference/command-line-compiler/keycontainer.md)一起使用。  
