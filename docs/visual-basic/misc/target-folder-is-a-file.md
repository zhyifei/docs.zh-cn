...
## <a name="see-also"></a>另请参阅  
 ...
 [文件、 目录和驱动器属性，在 Visual Basic 中](http://msdn.microsoft.com/en-us/131593e9-d1b0-4c89-9c03-ae8afc458829)  
 [如何： 确定 Visual Basic 中文件的绝对路径](http://msdn.microsoft.com/en-us/4c6769df-e9b9-4b69-bfdf-ce4cfbda30ff)
