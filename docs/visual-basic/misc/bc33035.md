...
---
# <a name="type-lttypenamegt-must-define-operator-ltdeterminantoperatorgt-to-be-used-in-a-ltshortcircuitoperatorgt-expression"></a>类型&lt;typename&gt;必须定义运算符&lt;determinantoperator&gt;要在中使用 '&lt;shortcircuitoperator&gt;表达式
