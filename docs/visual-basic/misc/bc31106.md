...
---
# <a name="property-accessors-cannot-be-declared-39ltaccessmodifiergt39-in-a-39notoverridable39-property"></a>属性访问器不能声明为&#39;&lt;访问修饰符&gt;&#39;中&#39;NotOverridable&#39;属性
A [Get 语句](../../visual-basic/language-reference/statements/get-statement.md)或[Set 语句](../../visual-basic/language-reference/statements/set-statement.md)中`NotOverridable`属性包括`Private`关键字。  
