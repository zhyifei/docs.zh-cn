...
---
# <a name="property-propertyname-cannot-be-initialized-in-an-object-initializer-expression-because-all-accessible-overloads-require-arguments"></a>属性 '\<属性名称 > 不能在对象初始值设定项表达式中初始化因为所有可访问的重载都需要参数
