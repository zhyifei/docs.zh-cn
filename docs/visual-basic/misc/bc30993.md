...
---
# <a name="property-propertyname-cannot-be-initialized-in-an-object-initializer-expression-because-all-accessible-overloads-require-arguments"></a>无法在对象初始值设定项表达式中初始化属性 "@no__t 0propertyname >"，因为所有可访问的重载都需要参数
