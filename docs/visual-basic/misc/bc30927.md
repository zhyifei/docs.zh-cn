...
---
# <a name="mustoverride-cannot-be-specified-on-ltprocedurenamegt-because-it-is-in-a-partial-type-that-is-declared-notinheritable-in-another-partial-definition"></a>不能指定 MustOverride '&lt;过程名称&gt;是分部类型在另一个分部定义中声明 NotInheritable
