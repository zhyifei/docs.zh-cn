...
---
# <a name="ltmethod1gt-and-ltmethod2gt-cannot-overload-each-other-because-they-differ-only-by-optional-parameters"></a>'&lt;method1&gt;和&lt;method2&gt;不能相互重载，因为它们的差异仅在于可选参数
