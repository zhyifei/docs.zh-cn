...
---
# <a name="type-parameter-typeparametername1-must-have-either-a-new-constraint-or-a-structure-constraint-to-satisfy-the-new-constraint-for-type-parameter-typeparametername2"></a>类型参数\<typeparametername1 > 必须具有 New 约束或 Structure 约束，才能满足类型参数的 New 约束\<typeparametername2 >
