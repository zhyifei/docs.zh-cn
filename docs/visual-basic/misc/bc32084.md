...
---
# <a name="type-parameter-typeparametername1-must-have-either-a-new-constraint-or-a-structure-constraint-to-satisfy-the-new-constraint-for-type-parameter-typeparametername2"></a>类型参数 '\<e >' 必须具有 'new' 约束或 'Structure' 约束, 才能满足类型形参 '\<2 >' 的 'new' 约束
