...
---
# <a name="type-of-39ltvariablenamegt39-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>类型的 &#39;&lt;variablename&gt;&#39; 不明确，因为循环边界和步骤变量未扩大到同一类型
