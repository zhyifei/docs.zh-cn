...
---
# <a name="type-of-ltvariablenamegt-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>类型&lt;variablename&gt;不明确，因为循环边界和步骤变量未扩大到同一类型
