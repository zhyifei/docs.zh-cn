...
---
# <a name="type-of-variablename-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>"@No__t >" 的类型不明确，因为循环边界和步骤变量未扩大到同一类型
