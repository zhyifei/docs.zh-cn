...
---
# <a name="39readonly39-variable-cannot-be-the-target-of-an-assignment-in-a-lambda-expression-inside-a-constructor"></a>&#39;ReadOnly&#39;变量不能在构造函数内的 lambda 表达式中作为赋值目标
