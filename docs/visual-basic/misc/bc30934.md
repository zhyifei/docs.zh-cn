...
---
# <a name="conversion-from-lttype1gt-to-lttype2gt-cannot-occur-in-a-constant-expression-used-as-an-argument-to-an-attribute"></a>从转换&lt;type1&gt;到&lt;type2&gt;不能在用作属性参数的常量表达式中
