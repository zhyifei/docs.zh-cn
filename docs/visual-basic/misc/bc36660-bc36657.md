...
---
# <a name="data-types-of-the-type-parameters-in-method-39ltmethodnamegt39-cannot-be-inferred-from-these-arguments-because-they-do-not-convert-to-the-same-type"></a>在方法 &#39; 类型参数的数据类型&lt;methodname&gt;&#39; 因为它们没有转换为同一类型无法从这些实参推断
