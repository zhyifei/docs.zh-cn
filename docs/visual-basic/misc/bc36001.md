...
---
# <a name="39global39-not-allowed-in-this-context-identifier-expected"></a>&#39;全局&#39;不允许在此上下文中; 中应输入标识符
`Global` 关键字用于一个不允许它的语句中。  
  
 `Global` 关键字允许你访问在将要编译你的代码的命名空间层次结构以外定义的命名空间。 `Global` 在 .NET Framework 类库的最外层命名空间级别开始限定路径。 有关说明，请参阅[Global-删除](http://msdn.microsoft.com/library/18c8ba14-40f6-4978-8096-6a5852324635)。  
