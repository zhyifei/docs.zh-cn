...
---
# <a name="operands-of-type-object-used-for-operator-operatorsymbol-use-the-isnot-operator-to-test-object-identity"></a>为运算符使用的 Object 类型的操作数\<operatorsymbol >; 使用 IsNot 运算符来测试对象标识
