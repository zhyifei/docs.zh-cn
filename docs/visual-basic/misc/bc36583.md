...
---
# <a name="parameter-parametername-in-extension-method-methodname-defined-in-typename-already-has-a-matching-omitted-argument"></a>"2typename @no__t" 中定义的扩展方法 "\<methodname >" 中的参数 "\<parametername >" 已具有匹配的省略实参
