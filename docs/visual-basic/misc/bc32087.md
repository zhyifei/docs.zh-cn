...
---
# <a name="overload-resolution-failed-because-no-accessible-ltgenericprocedurenamegt-accepts-this-number-of-type-arguments"></a>重载决策失败，因为没有可访问&lt;genericprocedurename&gt;接受此数目的类型参数
