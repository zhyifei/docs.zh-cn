...
---
# <a name="option-strict-on-does-not-allow-narrowing-in-implicit-type-conversions-between-method-ltmethodnamegt-and-delegate-ltdelegatenamegt"></a>Option Strict On 不允许在方法之间的隐式类型转换进行收缩 '&lt;methodname&gt;和委托&lt;delegatename&gt;
