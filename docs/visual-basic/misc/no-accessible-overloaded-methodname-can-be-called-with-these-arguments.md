...
---
# <a name="no-accessible-overloaded-39ltmethodnamegt39-can-be-called-with-these-arguments-without-a-narrowing-conversion"></a>没有可访问重载 &#39;&lt;methodname&gt;&#39; 可以使用未进行收缩转换这些自变量调用
