...
---
# <a name="ltprocedurename1gt-cannot-override-ltprocedurename2gt-because-they-differ-by-parameters-declared-paramarray"></a>&lt;procedurename1&gt;不能重写&lt;procedurename2&gt;因为它们声明为 ParamArray 的参数上存在差异
