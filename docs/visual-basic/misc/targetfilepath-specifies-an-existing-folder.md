...
## <a name="see-also"></a>请参阅  
 ...
 [如何： 在 Visual Basic 中移动目录](https://msdn.microsoft.com/library/0f26d1ef-c0a0-4445-8eb0-9b7d0490411c)  
 [如何：重命名文件](../../visual-basic/developing-apps/programming/drives-directories-files/how-to-rename-a-file.md)  
 [如何： 重命名在 Visual Basic 中的目录](https://msdn.microsoft.com/library/780c7afc-a03c-4b01-865a-510fe331b1cc)
