...
---
# <a name="ltelementnamegt-for-the-imports-alias-to-ltqualifiedelementnamegt-does-not-refer-to-a-namespace-class-structure-interface-enum-or-module"></a>'&lt;elementname&gt;的 Imports 别名的'&lt;qualifiedelementname&gt;不引用 Namespace、 类、 结构、 接口、 枚举或模块
