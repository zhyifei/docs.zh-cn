...
ms.locfileid: "43252793"
---
# <a name="visual-basic-power-packs-controls"></a>Visual Basic Power Pack 控件

Visual Basic Power Packs 控件是附加的 Windows 窗体控件。 它们未包含在 Visual Studio 中。  你可以[下载这些](http://go.microsoft.com/fwlink/?LinkId=321343)，但作为提供的是，不支持。  
