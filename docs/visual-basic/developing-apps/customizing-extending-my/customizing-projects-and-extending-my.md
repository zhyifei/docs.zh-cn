...
## <a name="related-sections"></a>相关章节  
 ...
 讨论编译器如何使用条件编译来选择要编译并排除其他部分的代码的特定节。  
