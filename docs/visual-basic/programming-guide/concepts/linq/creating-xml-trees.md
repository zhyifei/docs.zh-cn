...
|[在 Visual Basic 中的 XML 文本简介](../../../../visual-basic/programming-guide/concepts/linq/introduction-to-xml-literals.md)|快速介绍如何使用 XML 文本在 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] 中创建树。 本主题包括到 XML 文本的 [!INCLUDE[vbprvb](~/includes/vbprvb-md.md)] 文档的链接。|  
