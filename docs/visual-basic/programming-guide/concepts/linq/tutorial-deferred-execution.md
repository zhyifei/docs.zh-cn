...
---
# <a name="tutorial-deferred-execution-visual-basic"></a>教程： 延迟执行 (Visual Basic)
...
|主题|描述|  
|-----------|-----------------|  
|[延迟的执行和迟缓计算中 LINQ to XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)|描述延迟执行和迟缓计算的概念。|  
