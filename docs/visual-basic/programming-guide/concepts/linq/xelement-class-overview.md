...
-   可以从包括 <xref:System.IO.TextReader>、文本文件或 Web 地址 (URL) 在内的各种源解析 XML。 有关详细信息，请参阅[分析 XML (Visual Basic 中)](../../../../visual-basic/programming-guide/concepts/linq/parsing-xml.md)。  
