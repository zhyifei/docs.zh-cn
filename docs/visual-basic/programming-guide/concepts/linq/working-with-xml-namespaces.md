...
|[如何： 使用命名空间 (LINQ to XML) 创建文档 (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-create-a-document-with-namespaces.md)|演示如何创建包含命名空间的文档。|  
...
|[在 Visual Basic 中的默认命名空间的作用域](../../../../visual-basic/programming-guide/concepts/linq/scope-of-default-namespaces.md)|演示为默认命名空间中的 XML 编写查询的适当方式。|  
