...
## [LINQ 入门](getting-started-with-linq.md)
### [编写第一个 LINQ 查询](writing-your-first-linq-query.md)
### [基本查询操作](basic-query-operations.md)
### [支持 LINQ 的 Visual Basic 功能](features-that-support-linq.md)
### [查询操作中的类型关系](type-relationships-in-query-operations.md)
### [演练：编写查询](walkthrough-writing-queries.md)
### [如何：创建项列表](how-to-create-a-list-of-items.md)
...
### [如何：查询包含一组指定词语的句子 (LINQ)](how-to-query-for-sentences-that-contain-a-specified-set-of-words.md)
