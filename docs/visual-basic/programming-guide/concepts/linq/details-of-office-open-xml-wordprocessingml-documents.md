...
---
# <a name="details-of-office-open-xml-wordprocessingml-documents-visual-basic"></a>Office Open XML WordprocessingML 文档的详细信息（Visual Basic）
...
|[输出 Office Open XML 文档部件的示例（Visual Basic）](../../../../visual-basic/programming-guide/concepts/linq/example-that-outputs-office-open-xml-document-parts.md)|提供一个打开 Office Open XML WordprocessingML 文档，并将文档和样式部分输出到控制台的示例。|  
