...
## <a name="object-relational-designer"></a>Object Relational Designer  
 对象关系设计器是一个可视化设计工具，你可以在使用[LINQ to SQL](../../../../../docs/framework/data/adonet/sql/linq/index.md)应用程序在 Visual Basic 中生成的类表示基础数据库中的关系数据。 有关详细信息，请参阅 [Visual Studio 中的 LINQ to SQL 工具](/visualstudio/data-tools/linq-to-sql-tools-in-visual-studio2)。  
