...
|[如何：从 CSV 文件生成 XML （Visual Basic）](../../../../visual-basic/programming-guide/concepts/linq/how-to-generate-xml-from-csv-files.md)|演示如何使用 LINQ 分析 CSV 文件并从它生成 XML。|  
