---
title: "示例 XML 文件︰ 客户和订单中&1;> |Microsoft 文档"
ms.custom: 
ms.date: 2015-07-20
ms.prod: .net
ms.reviewer: 
...
ms.openlocfilehash: 64f3020d63251a8bc52a673aebc94c3865c781fc
ms.contentlocale: zh-cn
ms.lasthandoff: 04/12/2017

---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="dafa7-102">示例 XML 文件：命名空间中的客户和订单</span><span class="sxs-lookup"><span data-stu-id="dafa7-102">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="dafa7-103">下面的 XML 文件用在 [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] 文档的很多示例中。</span><span class="sxs-lookup"><span data-stu-id="dafa7-103">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](../../../../csharp/programming-guide/concepts/linq/includes/sqltecxlinq_md.md)] documentation.</span></span> <span data-ttu-id="dafa7-104">此文件包含客户和订单。</span><span class="sxs-lookup"><span data-stu-id="dafa7-104">This file contains customers and orders.</span></span> <span data-ttu-id="dafa7-105">该 XML 在某个命名空间中。</span><span class="sxs-lookup"><span data-stu-id="dafa7-105">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="dafa7-106">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="dafa7-106">CustomersOrdersInNamespace.xml</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="dafa7-107">另请参阅</span><span class="sxs-lookup"><span data-stu-id="dafa7-107">See Also</span></span>  
 [<span data-ttu-id="dafa7-108">示例 XML 文档 (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="dafa7-108">Sample XML Documents (LINQ to XML)</span></span>](../../../../visual-basic/programming-guide/concepts/linq/sample-xml-documents-linq-to-xml.md)
