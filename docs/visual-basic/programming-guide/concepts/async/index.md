...
如果方法包含指定 <xref:System.Threading.Tasks.Task%601> 类型操作数的 [Return](../../../../visual-basic/language-reference/statements/return-statement.md) 语句，将 `TResult` 指定为返回类型。
...
## <a name="BKMK_CompleteExample"></a>完整的示例
