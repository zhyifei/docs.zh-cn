...
##  <a name="BKMK_RecognizingReentrancy"></a><span data-ttu-id="4a137-113">识别重新进入</span><span class="sxs-lookup"><span data-stu-id="4a137-113">Recognizing Reentrancy</span></span>  
...
##  <a name="BKMK_HandlingReentrancy"></a><span data-ttu-id="4a137-124">处理重新进入</span><span class="sxs-lookup"><span data-stu-id="4a137-124">Handling Reentrancy</span></span>  
...
###  <a name="BKMK_DisableTheStartButton"></a><span data-ttu-id="4a137-133">禁用“开始”按钮</span><span class="sxs-lookup"><span data-stu-id="4a137-133">Disable the Start Button</span></span>  
...
###  <a name="BKMK_CancelAndRestart"></a><span data-ttu-id="4a137-140">取消和重启操作</span><span class="sxs-lookup"><span data-stu-id="4a137-140">Cancel and Restart the Operation</span></span>  
...
###  <a name="BKMK_RunMultipleOperations"></a><span data-ttu-id="4a137-161">运行多个操作并将输出排入队列</span><span class="sxs-lookup"><span data-stu-id="4a137-161">Run Multiple Operations and Queue the Output</span></span>  
...
##  <a name="BKMD_SettingUpTheExample"></a><span data-ttu-id="4a137-207">检查并运行示例应用</span><span class="sxs-lookup"><span data-stu-id="4a137-207">Reviewing and Running the Example App</span></span>  
...
###  <a name="BKMK_DownloadingTheApp"></a><span data-ttu-id="4a137-210">下载应用</span><span class="sxs-lookup"><span data-stu-id="4a137-210">Downloading the App</span></span>  
...
###  <a name="BKMK_BuildingTheApp"></a><span data-ttu-id="4a137-217">生成应用</span><span class="sxs-lookup"><span data-stu-id="4a137-217">Building the App</span></span>  
