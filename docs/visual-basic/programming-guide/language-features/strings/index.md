...
## <a name="in-this-section"></a>本节内容  
 ...
 列出介绍 Visual Basic 中使用字符串的基本概念的主题。  
 ...
 [如何：字符串内的搜索](../../../../visual-basic/programming-guide/language-features/strings/how-to-search-within-a-string.md)  
 展示了如何确定子字符串的首次出现索引。  
 ...
 [演练：加密和解密在 Visual Basic 中的字符串](../../../../visual-basic/programming-guide/language-features/strings/walkthrough-encrypting-and-decrypting-strings.md)  
