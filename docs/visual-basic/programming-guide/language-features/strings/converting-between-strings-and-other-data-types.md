---
title: Visual Basic 中字符串和其他数据类型间的转换
ms.date: 07/20/2015
helpviewer_keywords:
...
ms.locfileid: "33648276"
---
# <a name="converting-between-strings-and-other-data-types-in-visual-basic"></a>Visual Basic 中字符串和其他数据类型间的转换
本部分介绍如何将字符串转换为其他数据类型。  
