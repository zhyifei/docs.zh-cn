...
2.  从列表中选择 Windows 应用程序[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]项目模板，以显示新项目。  
...
5.  将新类`UserNameInfo.vb`，然后单击**添加**以显示新的类的代码。  
    ...
    > [!NOTE]
    >  你可以使用[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]**代码编辑器**将类添加到启动窗体中，通过键入`Class`关键字后跟新类的名称。 **代码编辑器**提供相应`End Class`为你的语句。  
