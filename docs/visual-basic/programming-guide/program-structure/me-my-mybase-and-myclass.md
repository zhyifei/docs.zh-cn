...
`Me``My`， `MyBase`，和`MyClass`中[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]具有类似的名称，但不同的用途。 本主题将介绍上述每个实体以便将它们区分开来。  
...
## <a name="my"></a>My  
 `My`功能提供对大量的简单和直观访问[!INCLUDE[dnprdnshort](~/includes/dnprdnshort-md.md)]类，从而[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]用户与计算机、 应用程序、 设置、 资源和等等进行交互。  
