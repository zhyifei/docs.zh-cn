...
`#Region`指令可以折叠和隐藏中的代码段[!INCLUDE[vbprvb](~/includes/vbprvb-md.md)]文件。 `#Region`指令允许你在使用时指定的一段代码，你可以展开或折叠[!INCLUDE[vsprvs](~/includes/vsprvs-md.md)]代码编辑器。 有选择地隐藏代码的能力使你的文件更易于管理并且更易读。 有关详细信息，请参阅[大纲显示](/visualstudio/ide/outlining)。  
