...
2. Open a new Windows Application project by clicking **New** on the **File** menu, and then clicking **Project**. 此时将出现“新建项目”对话框。  
...
3. Add equivalent `Const` statements to your class or module to make these constants available to your application. 例如:  
...
1. Open a new Windows Application project by clicking **New** on the **File** menu, and then clicking **Project**. 此时将出现“新建项目”对话框。  
...
11. 按 F5 键启动该应用程序。 The main form appears.  
