...
-   是否需要顺序列表（其中通常在检索元素值后就将该元素丢弃）？  
    ...
    -   如果是，在需要先进先出 (FIFO) 行为时，请考虑使用 <xref:System.Collections.Queue> 类或 <xref:System.Collections.Generic.Queue%601> 泛型类。 如果需要后进先出 (LIFO) 行为，请考虑使用 <xref:System.Collections.Stack> 类或 <xref:System.Collections.Generic.Stack%601> 泛型类。 对于来自多个线程的安全访问，使用并发版本 <xref:System.Collections.Concurrent.ConcurrentQueue%601> 和 <xref:System.Collections.Concurrent.ConcurrentStack%601>。  
...
-   是否需要以特定顺序（如先进先出、后进先出或随机）访问元素？  
    ...
    -   <xref:System.Collections.Stack> 类和 <xref:System.Collections.Generic.Stack%601> 或 <xref:System.Collections.Concurrent.ConcurrentStack%601> 泛型类提供后进先出访问。 有关详细信息，请参阅[何时使用线程安全集合](../../../docs/standard/collections/thread-safe/when-to-use-a-thread-safe-collection.md)。  
...
-   是否每个元素都包含一个值、一个键和一个值的组合或一个键和多个值的组合？  
    ...
    -   一个值：使用基于 <xref:System.Collections.IList> 接口或 <xref:System.Collections.Generic.IList%601> 泛型接口的任何集合。  
...
-   是否需要以与输入方式不同的方式对元素进行排序？  
    ...
    -   <xref:System.Collections.Hashtable> 类按其哈希代码对元素进行排序。  
  
    -   <xref:System.Collections.SortedList> 以及 <xref:System.Collections.Generic.SortedDictionary%602> 和 <xref:System.Collections.Generic.SortedList%602> 泛型类基于 <xref:System.Collections.IComparer> 接口和 <xref:System.Collections.Generic.IComparer%601> 泛型接口的实现按键对元素进行排序。  
  
    -   <xref:System.Collections.ArrayList> 提供 <xref:System.Collections.ArrayList.Sort%2A> 方法，此方法将 <xref:System.Collections.IComparer> 实现作为参数。 其泛型对应项 <xref:System.Collections.Generic.List%601> 泛型类型提供将 <xref:System.Collections.Generic.IComparer%601> 泛型接口的实现用作参数的 <xref:System.Collections.Generic.List%601.Sort%2A> 方法。  
  
-   是否需要快速搜索和信息检索？  
  
    -   <xref:System.Collections.Specialized.ListDictionary> 比用于小集合的 <xref:System.Collections.Hashtable>（10 个项目或更少）速度快。 <xref:System.Collections.Generic.Dictionary%602> 泛型类提供相较于 <xref:System.Collections.Generic.SortedDictionary%602> 泛型类更快的查找。 多线程的实现是 <xref:System.Collections.Concurrent.ConcurrentDictionary%602>。 <xref:System.Collections.Concurrent.ConcurrentBag%601> 可快速实现无序数据的多线程插入。 有关这两种多线程类型的详细信息，请参阅[何时使用线程安全集合](../../../docs/standard/collections/thread-safe/when-to-use-a-thread-safe-collection.md)。  
...
-   是否需要只接受字符串的集合？  
    ...
    -   此外，通过指定其泛型类型参数的 <xref:System.String> 类，可以使用 <xref:System.Collections.Generic> 命名空间中的任何泛型集合类作为强类型字符串集合。  
