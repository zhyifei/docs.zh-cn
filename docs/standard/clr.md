...
-   使用委托取代函数指针，从而增强了类型安全和安全性。  有关委派的详细信息，请参阅[常规类型系统](../../docs/standard/base-types/common-type-system.md)。  
...
|[NIB: Overview of the .NET Framework](http://msdn.microsoft.com/zh-cn/ea38ac1e-92af-4d1b-8db1-e8a5ea10ed85)|描述关键的 .NET Framework 概念，例如通用类型系统、跨语言互操作性、托管执行、应用程序域和程序集。|  
