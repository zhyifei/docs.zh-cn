---
title: ".NET Framework 类库概述 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
helpviewer_keywords: 
  ...
  - "公共语言规范"
  - "数据类型 [.NET Framework]"
  - "数据类型 [.NET Framework], C#"
  - "数据类型 [.NET Framework], C++"
  - "数据类型 [.NET Framework], JScript"
  - "数据类型 [.NET Framework], Visual Basic"
  - "浮点型数值类型"
  - "整数值类型"
  - "JScript, 数据类型"
  - "库, .NET Framework 类库"
...
## 命名约定  
 ...
 有关命名空间和类型名的更多信息，请参见[常规类型系统](../../docs/standard/base-types/common-type-system.md)。  
...
|--------|--------|--------|-----------------------|--------------|----------------|------------------|  
|Integer|<xref:System.Byte>|8 位无符号整数。|**Byte**|**byte**|**unsigned char**|**Byte**|  
...
||<xref:System.Int64>|64 位的有符号整数。|**Long**|**long**|**\_\_int64**|**long**|  
...
||<xref:System.UInt64>|64 位无符号整数。<br /><br /> 不符合 CLS。|**ULong**|**ulong**|**unsigned \_\_int64**|**UInt64**|  
|浮点|<xref:System.Single>|单精度（32 位）浮点数字。|**Single**|**float**|**float**|**float**|  
||<xref:System.Double>|双精度（64 位）浮点数字。|**Double**|**double**|**double**|**double**|  
|逻辑运算|<xref:System.Boolean>|布尔值（真或假）。|**Boolean**|**bool**|**bool**|**bool**|  
|其他|<xref:System.Char>|Unicode（16 位）字符。|**Char**|**char**|**wchar\_t**|**char**|  
||<xref:System.Decimal>|十进制（128 位）值。|**Decimal**|**decimal**|**Decimal**|**Decimal**|  
...
|类对象|<xref:System.Object>|对象层次结构的根。|**对象**|**object**|**Object\***|**对象**|  
||<xref:System.String>|Unicode 字符的不变的定长串。|**String**|**string**|**String\***|**String**|  
