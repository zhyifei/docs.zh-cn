...
| `PackageProjectUrl`                | `projectUrl`               | <span data-ttu-id="8c0b1-138">项目主页或源存储库的 URL。</span><span class="sxs-lookup"><span data-stu-id="8c0b1-138">A URL for the project homepage or source repository.</span></span>             |
