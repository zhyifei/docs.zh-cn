...
| `PackageProjectUrl`                | `projectUrl`               | <span data-ttu-id="b6738-138">项目主页或源存储库的 URL。</span><span class="sxs-lookup"><span data-stu-id="b6738-138">A URL for the project homepage or source repository.</span></span>             |
