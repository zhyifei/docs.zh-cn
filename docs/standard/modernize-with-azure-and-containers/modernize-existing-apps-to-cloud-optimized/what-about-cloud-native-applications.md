...
了解可以使用.NET Core 的实现的微服务体系结构的详细信息，请参阅可下载 PDF 电子书[.NET 微服务： 为容器化的.NET 应用程序的体系结构](https://aka.ms/microservicesebook)。 本指南也是可用[联机](../../microservices-architecture/index.md)。
