...
---
# <a name="implementing-retries-with-exponential-backoff"></a>实现使用指数退避算法的重试
...
[上一篇] (partial-failure-strategies.md) [下一篇] (implement-resilient-entity-framework-core-sql-connections.md)
