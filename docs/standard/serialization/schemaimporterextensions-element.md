...
|元素|说明|  
|-------------|-----------------|  
|[\<为 \<schemaImporterExtensions 添加 > 元素 >](../../../docs/standard/serialization/add-element-for-schemaimporterextensions.md)|添加 <xref:System.Xml.Serialization.XmlSchemaImporter> 用来创建映射的类型。|  
