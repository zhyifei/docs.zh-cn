...
> [!NOTE]
>  <xref:System.Xml.Schema> 命名空间包含扩展方法，以便于在使用 [LINQ to XML](https://msdn.microsoft.com/library/f0fe21e9-ee43-4a55-b91a-0800e5782c13) 时轻松针对 XSD 文件验证 XML 树。 有关使用 LINQ to XML 验证 XML 文档的更多信息，请参阅[如何：使用 XSD 进行验证](https://msdn.microsoft.com/library/481a97fa-6e96-46f2-8c9a-415555fac33b)。  
