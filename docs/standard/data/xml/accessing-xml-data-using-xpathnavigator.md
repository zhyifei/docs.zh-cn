---
title: "使用 XPathNavigator 访问 XML 数据 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
ms.prod: ".net"
ms.reviewer: ""
...
## 本节内容  
 ...
 介绍用于在 <xref:System.Xml.XPath.XPathDocument> 或 <xref:System.Xml.XmlDocument> 对象中浏览节点的 <xref:System.Xml.XPath.XPathNavigator> 类的节点集浏览方法。  
 ...
 描述如何使用 <xref:System.Xml.XPath.XPathNavigator> 类访问 <xref:System.Xml.XPath.XPathDocument> 或 <xref:System.Xml.XmlDocument> 对象中的强类型 XML 数据。  
