...
# <a name="how-to-perform-basic-string-manipulations"></a><span data-ttu-id="0b6ce-104">如何：执行基本字符串操作</span><span class="sxs-lookup"><span data-stu-id="0b6ce-104">How to: perform basic string manipulations</span></span>

<span data-ttu-id="0b6ce-105">下面的示例使用[基本字符串操作](basic-string-operations.md)主题中所述的一些方法来构造一个类，模拟现实应用程序执行字符串操作。</span><span class="sxs-lookup"><span data-stu-id="0b6ce-105">The following example uses some of the methods discussed in the [Basic string operations](basic-string-operations.md) topics to construct a class that performs string manipulations in a manner that might be found in a real-world application.</span></span> <span data-ttu-id="0b6ce-106">`MailToData` 类将个人的姓名和地址存储在单独的属性中，并提供一种将 `City`、`State` 和 `Zip` 字段合并成向用户显示的单个字符串的方式。</span><span class="sxs-lookup"><span data-stu-id="0b6ce-106">The `MailToData` class stores the name and address of an individual in separate properties and provides a way to combine the `City`, `State`, and `Zip` fields into a single string for display to the user.</span></span> <span data-ttu-id="0b6ce-107">此外，该类允许用户以单个字符串的形式输入将城市、州/省和邮政编码信息；应用程序会自动分析此字符串，并将正确的信息输入到相应的属性中。</span><span class="sxs-lookup"><span data-stu-id="0b6ce-107">Furthermore, the class allows the user to enter the city, state, and ZIP Code information as a single string; the application automatically parses the single string and enters the proper information into the corresponding property.</span></span>

<span data-ttu-id="0b6ce-108">为简单起见，此示例使用带命令行接口的控制台应用程序。</span><span class="sxs-lookup"><span data-stu-id="0b6ce-108">For simplicity, this example uses a console application with a command-line interface.</span></span>

## <a name="example"></a><span data-ttu-id="0b6ce-109">示例</span><span class="sxs-lookup"><span data-stu-id="0b6ce-109">Example</span></span>
...
<span data-ttu-id="0b6ce-110">执行上面的代码时，系统会要求用户输入其姓名和地址。</span><span class="sxs-lookup"><span data-stu-id="0b6ce-110">When the preceding code is executed, the user is asked to enter his or her name and address.</span></span> <span data-ttu-id="0b6ce-111">应用程序将这些信息放入相应的属性并向用户显示这些信息，同时创建一个显示城市、州/省和邮政编码信息的字符串。</span><span class="sxs-lookup"><span data-stu-id="0b6ce-111">The application places the information in the appropriate properties and displays the information back to the user, creating a single string that displays the city, state, and ZIP Code information.</span></span>

## <a name="see-also"></a><span data-ttu-id="0b6ce-112">另请参阅</span><span class="sxs-lookup"><span data-stu-id="0b6ce-112">See Also</span></span>

[<span data-ttu-id="0b6ce-113">基本字符串操作</span><span class="sxs-lookup"><span data-stu-id="0b6ce-113">Basic string operations</span></span>](basic-string-operations.md)
