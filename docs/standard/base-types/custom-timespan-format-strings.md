...
A<xref:System.TimeSpan>格式字符串定义的字符串表示形式<xref:System.TimeSpan>格式设置操作生成的值。 自定义格式字符串仅包含一个或多个自定义<xref:System.TimeSpan>格式说明符以及任意数量的原义字符。 不是任何字符串[标准 TimeSpan 格式字符串](../../../docs/standard/base-types/standard-timespan-format-strings.md)解释为自定义<xref:System.TimeSpan>格式字符串。  
  
> [!IMPORTANT]
>  自定义<xref:System.TimeSpan>格式说明符不包含占位符分隔符符号，如分离天小时、 分钟、 小时或之后秒的小数部分的秒数的符号。 相反，这些符号必须以字符串形式包含在自定义格式字符串中。 例如，`"dd\.hh\:mm"` 将句点 (.) 定义为天与小时之间的分隔符，将冒号 (:) 定义为小时与分钟之间的分隔符。  
>   
>  自定义 <xref:System.TimeSpan> 格式说明符还不包括正负符号，无法区分正负时间间隔。 若要包含正负符号，必须使用条件逻辑构造格式字符串。 [其他字符](#Other)部分包括一个示例。  
  
 字符串表示形式<xref:System.TimeSpan>值由调用的重载生成<xref:System.TimeSpan.ToString%2A?displayProperty=nameWithType>方法，并通过支持复合格式设置，如<xref:System.String.Format%2A?displayProperty=nameWithType>。 有关更多信息，请参见[格式设置类型](../../../docs/standard/base-types/formatting-types.md)和[复合格式设置](../../../docs/standard/base-types/composite-formatting.md)。 下面的示例演示如何使用在格式设置操作的自定义格式字符串。  
 ...
 自定义<xref:System.TimeSpan>格式字符串还由<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>和<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法来定义的所需的格式输入字符串的分析操作中使用。 （分析将值的字符串表示形式转换成该值。）以下示例演示了标准格式字符串在分析操作中的用法。  
...
|"dd"-"引起"|时间间隔中的整天数，根据需要使用前导零填充。<br /><br /> 详细信息： ["dd"-"引起"自定义格式说明符](#ddSpecifier)。|`new TimeSpan(6, 14, 32, 17, 685):`<br /><br /> `ddd` --> "006"<br /><br /> `dd\.hh\:mm` --> "06.14:32"|  
...
|“ff”|时间间隔中的百分之几秒。<br /><br /> 详细信息：["ff"自定义格式说明符](#ffSpecifier)。|`TimeSpan.FromSeconds(6.895)`：<br /><br /> `ff` --> 89<br /><br /> `ss\.ff` --> 06.89|  
...
|*字符串*|文本字符串分隔符。<br /><br /> 详细信息：[其他字符](#Other)。|`new TimeSpan(14, 32, 17):`<br /><br /> `hh':'mm':'ss` --> "14:32:17"|  
|\|转义字符。<br /><br /> 详细信息：[其他字符](#Other)。|`new TimeSpan(14, 32, 17):`<br /><br /> `hh\:mm\:ss` --> "14:32:17"|  
...
## <a name="the-d-custom-format-specifier"></a>“d”自定义格式说明符  
 "D"自定义格式说明符输出的值<xref:System.TimeSpan.Days%2A?displayProperty=nameWithType>属性，它表示时间间隔内的整天数。 它输出中的完整天数<xref:System.TimeSpan>值，即使的值有多个数字。 如果值<xref:System.TimeSpan.Days%2A?displayProperty=nameWithType>属性为零，则此说明符输出"0"。  
...
## <a name="the-dd-dddddddd-custom-format-specifiers"></a>“dd”-“dddddddd”自定义格式说明符  
 "Dd"、"ddd"、"dddd"、"ddddd"、"dddddd"、"ddddddd"和"引起"自定义格式说明符输出的值<xref:System.TimeSpan.Days%2A?displayProperty=nameWithType>属性，它表示时间间隔内的整天数。  
  
 输出字符串包含格式说明符中的“d”字符数指定的最小位数，会根据需要使用前导零填充。 如果天数中的位数超过格式说明符中的“d”字符数，则完整天数会在结果字符串中输出。  
  
 下面的示例使用这些格式说明符来显示的字符串表示形式两个<xref:System.TimeSpan>值。 第一个时间间隔的天数部分的值为 0；第二个的天数部分的值为 365。  
...
## <a name="the-h-custom-format-specifier"></a>“h”自定义格式说明符  
 "H"自定义格式说明符输出的值<xref:System.TimeSpan.Hours%2A?displayProperty=nameWithType>属性，它表示在未计入其天组件的一部分的时间间隔的整小时数。 如果将它返回一个数字的字符串值的值<xref:System.TimeSpan.Hours%2A?displayProperty=nameWithType>属性是 0 到 9，并且如果返回两个数字的字符串值的值<xref:System.TimeSpan.Hours%2A?displayProperty=nameWithType>属性范围为 10 到 23。  
...
## <a name="the-hh-custom-format-specifier"></a>“hh”自定义格式说明符  
 "Hh"自定义格式说明符输出的值<xref:System.TimeSpan.Hours%2A?displayProperty=nameWithType>属性，它表示在未计入其天组件的一部分的时间间隔的整小时数。 对于 0 到 9 的值，输出字符串包含一个前导零。  
...
## <a name="the-m-custom-format-specifier"></a>“m”自定义格式说明符  
 "M"自定义格式说明符输出的值<xref:System.TimeSpan.Minutes%2A?displayProperty=nameWithType>属性，表示未计入其天组件的一部分的时间间隔内整分钟数。 如果将它返回一个数字的字符串值的值<xref:System.TimeSpan.Minutes%2A?displayProperty=nameWithType>属性是 0 到 9，并且如果返回两个数字的字符串值的值<xref:System.TimeSpan.Minutes%2A?displayProperty=nameWithType>属性的范围为 10 到 59 之间。  
...
## <a name="the-mm-custom-format-specifier"></a>“mm”自定义格式说明符  
 "Mm"自定义格式说明符输出的值<xref:System.TimeSpan.Minutes%2A?displayProperty=nameWithType>属性，表示不是其小时或天组件的一部分包括的时间间隔内整分钟数。 对于 0 到 9 的值，输出字符串包含一个前导零。  
...
## <a name="the-s-custom-format-specifier"></a>“s”自定义格式说明符  
 "S"自定义格式说明符将输出的值<xref:System.TimeSpan.Seconds%2A?displayProperty=nameWithType>属性，它表示在不是其小时数、 天数或分钟数部分的一部分包括的时间间隔的整秒数。 如果将它返回一个数字的字符串值的值<xref:System.TimeSpan.Seconds%2A?displayProperty=nameWithType>属性是 0 到 9，并且如果返回两个数字的字符串值的值<xref:System.TimeSpan.Seconds%2A?displayProperty=nameWithType>属性的范围为 10 到 59 之间。  
...
## <a name="the-ss-custom-format-specifier"></a>“ss”自定义格式说明符  
 "Ss"自定义格式说明符输出的值<xref:System.TimeSpan.Seconds%2A?displayProperty=nameWithType>属性，它表示在不是其小时数、 天数或分钟数部分的一部分包括的时间间隔的整秒数。 对于 0 到 9 的值，输出字符串包含一个前导零。  
...
## <a name="thef-custom-format-specifier"></a>"F"自定义格式说明符  
 “f”自定义格式说明符输出时间间隔中的十分之几秒。 在格式设置操作中，会截断其余任何小数位数。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法中，输入的字符串必须包含恰好一个小数位。  
  
 如果“f”自定义格式说明符单独使用，则指定“%f”，以便它不会错误地解释为标准格式字符串。  
  
 下面的示例使用"f"自定义格式说明符来显示十分之几秒的<xref:System.TimeSpan>值。 “f”首先用作唯一的格式说明符，然后在自定义格式字符串中与“s”说明符结合使用。  
...
## <a name="the-ff-custom-format-specifier"></a>“ff”自定义格式说明符  
 “ff”自定义格式说明符输出时间间隔中的百分之几秒。 在格式设置操作中，会截断其余任何小数位数。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法中，输入的字符串必须包含恰好两个小数位。  
  
 下面的示例使用"ff"自定义格式说明符来显示的百分之几秒<xref:System.TimeSpan>值。 “ff”首先用作唯一的格式说明符，然后在自定义格式字符串中与“s”说明符结合使用。  
...
## <a name="the-fff-custom-format-specifier"></a>“fff”自定义格式说明符  
 “fff”自定义格式说明符（包含三个“f”字符）输出时间间隔中的毫秒。 在格式设置操作中，会截断其余任何小数位数。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法中，输入的字符串必须包含 3 个小数位。  
  
 下面的示例使用"fff"自定义格式说明符来显示中的毫秒数<xref:System.TimeSpan>值。 “fff”首先用作唯一的格式说明符，然后在自定义格式字符串中与“s”说明符结合使用。  
...
## <a name="the-ffff-custom-format-specifier"></a>“ffff”自定义格式说明符  
 “ffff”自定义格式说明符（包含四个“f”字符）输出时间间隔中的万分之几秒。 在格式设置操作中，会截断其余任何小数位数。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法中，输入的字符串必须包含 4 个小数位。  
  
 下面的示例使用"ffff"自定义格式说明符来显示在第二个万分<xref:System.TimeSpan>值。 “ffff”首先用作唯一的格式说明符，然后在自定义格式字符串中与“s”说明符结合使用。  
...
## <a name="the-fffff-custom-format-specifier"></a>“fffff”自定义格式说明符  
 “fffff”自定义格式说明符（包含五个“f”字符）输出时间间隔中的十万分之几秒。 在格式设置操作中，会截断其余任何小数位数。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法中，输入的字符串必须包含正好有五个小数位。  
  
 下面的示例使用"fffff"自定义格式说明符来显示-的十万分之几秒<xref:System.TimeSpan>值。 “fffff”首先用作唯一的格式说明符，然后在自定义格式字符串中与“s”说明符结合使用。  
...
## <a name="the-ffffff-custom-format-specifier"></a>“ffffff”自定义格式说明符  
 “ffffff”自定义格式说明符（包含六个“f”字符）输出时间间隔中的百万分之几秒。 在格式设置操作中，会截断其余任何小数位数。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法中，输入的字符串必须包含完全六个小数位。  
  
 下面的示例使用"ffffff"自定义格式说明符来显示的百万分之几秒<xref:System.TimeSpan>值。 它首先用作唯一的格式说明符，然后在自定义格式字符串中与“s”说明符结合使用。  
...
## <a name="the-fffffff-custom-format-specifier"></a>“fffffff”自定义格式说明符  
 “fffffff”自定义格式说明符（包含六个“f”字符）输出时间间隔中的千万分之几秒（或时钟周期的小数）。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法中，输入的字符串必须包含完全七个小数位。  
  
 下面的示例使用"fffffff"自定义格式说明符来显示的小数部分中的刻度数<xref:System.TimeSpan>值。 它首先用作唯一的格式说明符，然后在自定义格式字符串中与“s”说明符结合使用。  
...
## <a name="the-f-custom-format-specifier"></a>“F”自定义格式说明符  
 “F”自定义格式说明符输出时间间隔中的十分之几秒。 在格式设置操作中，会截断其余任何小数位数。 如果时间间隔的十分之几秒的值为零，则它不包含在结果字符串中。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法，第二个数字十分之一的状态是可选的。  
  
 如果“F”自定义格式说明符单独使用，则指定“%F”，以便它不会错误地解释为标准格式字符串。  
  
 下面的示例使用"F"自定义格式说明符来显示十分之几秒的<xref:System.TimeSpan>值。 它还在分析操作中使用此自定义格式说明符。  
...
## <a name="the-ff-custom-format-specifier"></a>“FF”自定义格式说明符  
 “FF”自定义格式说明符输出时间间隔中的百分之几秒。 在格式设置操作中，会截断其余任何小数位数。 如果存在任何尾随小数零，则它们不包含在结果字符串中。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法，存在十分之几和第二个数字的百分位是可选的。  
  
 下面的示例使用"FF"自定义格式说明符来显示的百分之几秒<xref:System.TimeSpan>值。 它还在分析操作中使用此自定义格式说明符。  
...
## <a name="the-fff-custom-format-specifier"></a>“FFF”自定义格式说明符  
 “FFF”自定义格式说明符（包含三个“F”字符）输出时间间隔中的毫秒。 在格式设置操作中，会截断其余任何小数位数。 如果存在任何尾随小数零，则它们不包含在结果字符串中。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法，十分几、 百分位和第二个数字的千分位的存在是可选的。  
  
 下面的示例使用"FFF"自定义格式说明符来显示千分之几秒的<xref:System.TimeSpan>值。 它还在分析操作中使用此自定义格式说明符。  
...
## <a name="the-ffff-custom-format-specifier"></a>“FFFF”自定义格式说明符  
 “FFFF”自定义格式说明符（包含四个“F”字符）输出时间间隔中的万分之几秒。 在格式设置操作中，会截断其余任何小数位数。 如果存在任何尾随小数零，则它们不包含在结果字符串中。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法，存在十分几、 百分位、 分之几和第二个数字的万分是可选的。  
  
 下面的示例使用"FFFF"自定义格式说明符来显示在第二个万分<xref:System.TimeSpan>值。 它还在分析操作中使用“FFFF”自定义格式说明符。  
...
## <a name="the-fffff-custom-format-specifier"></a>“FFFFF”自定义格式说明符  
 “FFFFF”自定义格式说明符（包含五个“F”字符）输出时间间隔中的十万分之几秒。 在格式设置操作中，会截断其余任何小数位数。 如果存在任何尾随小数零，则它们不包含在结果字符串中。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法，存在十分几、 百分位、 分之几、 万分和的第二个数字的十万分之几是可选的。  
  
 下面的示例使用"FFFFF"自定义格式说明符来显示-的十万分之几秒<xref:System.TimeSpan>值。 它还在分析操作中使用“FFFFF”自定义格式说明符。  
...
## <a name="the-ffffff-custom-format-specifier"></a>“FFFFFF”自定义格式说明符  
 “FFFFFF”自定义格式说明符（包含六个“F”字符）输出时间间隔中的百万分之几秒。 在格式设置操作中，会截断其余任何小数位数。 如果存在任何尾随小数零，则它们不包含在结果字符串中。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法，存在十分几、 百分位、 分之几、 万分、 十万分之几和第二个数字的百万分之几是可选的。  
  
 下面的示例使用"FFFFFF"自定义格式说明符来显示的百万分之几秒<xref:System.TimeSpan>值。 它还在分析操作中使用此自定义格式说明符。  
...
## <a name="the-fffffff-custom-format-specifier"></a>“FFFFFFF”自定义格式说明符  
 “FFFFFFF”自定义格式说明符（包含六个“F”字符）输出时间间隔中的千万分之几秒（或时钟周期的小数）。 如果存在任何尾随小数零，则它们不包含在结果字符串中。 在分析操作中调用<xref:System.TimeSpan.ParseExact%2A?displayProperty=nameWithType>或<xref:System.TimeSpan.TryParseExact%2A?displayProperty=nameWithType>方法，将输入字符串中的七个小数位数的状态是可选的。  
  
 下面的示例使用"FFFFFFF"自定义格式说明符来显示秒的小数部分<xref:System.TimeSpan>值。 它还在分析操作中使用此自定义格式说明符。  
...
## <a name="other-characters"></a>其他字符  
 格式字符串中的任何其他未转义字符（包括空白字符）都会解释为自定义格式说明符。 在大多数情况下，是否存在的任何其他未转义的字符都会导致<xref:System.FormatException>。  
  
 可通过两种方法在格式字符串中包含文本字符：  
  
-   将它括在单引号（文本字符串分隔符）中。  
  
-   在它前面加上反斜杠 ("\\")，它被解释为转义符。 这意味着在 C# 中，格式字符串必须是 @-quoted，或者文本字符的前面必须加上额外的反斜杠。  
