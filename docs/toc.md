...
## [并行处理、并发和异步](standard/parallel-processing-and-concurrency.md)
...
### [内存\<T> 和跨度\<T> 使用准则](standard/memory-and-spans/memory-t-usage-guidelines.md)
## [本机互操作性](standard/native-interop/index.md)
### [P/Invoke](standard/native-interop/pinvoke.md)
### [类型封送](standard/native-interop/type-marshalling.md)
### [自定义结构封送](standard/native-interop/customize-struct-marshalling.md)
### [自定义参数封送](standard/native-interop/customize-parameter-marshalling.md)
### [字符集和封送处理](standard/native-interop/charset.md)
...
### [全局工具](core/tools/global-tools.md)
#### [创建全局工具](core/tools/global-tools-how-to-create.md)
### [扩展性模型](core/tools/extensibility.md)
### [持续集成](core/tools/using-ci-with-cli.md)
### [自定义模板](core/tools/custom-templates.md)
### [启用 TAB 自动补全](core/tools/enable-tab-autocomplete.md)
...
### [dotnet-install 脚本](core/tools/dotnet-install-script.md)
### 项目修改命令
#### 参考资料
...
### [可为空引用类型](csharp/nullable-references.md)
...
## [引用](visual-basic/reference/index.md)
...
## 概述
### [什么是 ML.NET？](machine-learning/what-is-mldotnet.md)
...
### [应用分类特征工程 ](machine-learning/how-to-guides/train-model-categorical-ml-net.md)
### [应用文本特征工程 ](machine-learning/how-to-guides/train-model-textual-ml-net.md)
...
### [使用多个列加载数据](machine-learning/how-to-guides/load-data-from-mult-column-csv-ml-net.md)
### [从多个文件加载数据](machine-learning/how-to-guides/load-data-from-multiple-files-ml-net.md)
### [从文本文件加载数据](machine-learning/how-to-guides/load-data-from-text-file-ml-net.MD)
### [使用 PredictionFunction 一次执行一个预测](machine-learning/how-to-guides/single-predict-model-ml-net.md)
...
### [使用广义加性模型来解释模型](machine-learning/how-to-guides/use-gams-for-model-explainability.md)
### [使用指标来评估模型质量](machine-learning/how-to-guides/verify-model-quality-ml-net.md)
## 参考
### [API 参考](https://docs.microsoft.com/dotnet/api/?view=ml-dotnet)
