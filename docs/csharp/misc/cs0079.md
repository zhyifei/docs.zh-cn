...
事件“event”只能出现在 += 或 -= 的左边  
 ...
 未正确调用 [event](../../csharp/language-reference/keywords/event.md) 。 有关详细信息，请参阅[事件](../../csharp/programming-guide/events/index.md)并[委托](../../csharp/programming-guide/delegates/index.md)。  
