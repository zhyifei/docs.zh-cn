...
-   向具有 coclass 的程序集添加一个引用（大多数情况下，接口和 coclass 应位于同一程序集中） 请参阅 [/引用](../../csharp/language-reference/compiler-options/reference-compiler-option.md) 或 [添加引用对话框](http://msdn.microsoft.com/en-us/2feb0fe2-0805-4cc9-8cba-b0315849dfb7) 获取信息。  
