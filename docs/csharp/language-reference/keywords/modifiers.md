...
|[事件](../../../csharp/language-reference/keywords/event.md)|声明事件。|  
|[extern](../../../csharp/language-reference/keywords/extern.md)|指示在外部实现方法。|  
|[new](../../../csharp/language-reference/keywords/new.md)|显式隐藏继承自基类的成员。|  
|[替代](../../../csharp/language-reference/keywords/override.md)|提供从基类继承的虚拟成员的新实现。|  
|[partial](../../../csharp/language-reference/keywords/partial-type.md)|在同一程序集中定义分部类、结构和方法。|  
|[只读](../../../csharp/language-reference/keywords/readonly.md)|声明一个字段，该字段只能赋值为该声明的一部分或者在同一个类的构造函数中。|  
