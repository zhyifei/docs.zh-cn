...
转义序列无法识别  
 ...
 在\\字符串[中，反斜杠 (](../builtin-types/reference-types.md#the-string-type)) 的后面是一个意外字符。 编译器需要一个有效的转义字符。 有关详细信息，请参阅[字符转义](../../../standard/base-types/character-escapes-in-regular-expressions.md)。  
