...
对程序集“assembly”签名时加密失败 —“原因”  
 ...
 有关详细信息，请参阅[如何：使用强名称对程序集进行签名](../../../standard/assembly/sign-strong-name.md)、[/keyfile（C# 编译器选项）](../compiler-options/keyfile-compiler-option.md)和 [/delaysign（C# 编译器选项）](../compiler-options/delaysign-compiler-option.md)。  
