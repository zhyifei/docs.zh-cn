...
[switch](../builtin-types/void.md) 匹配表达式中的 [void](../keywords/switch.md) 方法调用生成 CS0151。 通过调用返回整型类型（如 [int](../builtin-types/integral-numeric-types.md) 或 [long](../builtin-types/integral-numeric-types.md)）的方法可修复该错误。
