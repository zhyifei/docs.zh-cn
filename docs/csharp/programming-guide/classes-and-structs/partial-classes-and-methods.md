...
有关详细信息，请参阅 [C# 语言规范](../../language-reference/language-specification/index.md)中的[分部类型](~/_csharplang/spec/classes.md#partial-types)。 该语言规范是 C# 语法和用法的权威资料。
...
- [partial（类型）](../../../csharp/language-reference/keywords/partial-type.md)
