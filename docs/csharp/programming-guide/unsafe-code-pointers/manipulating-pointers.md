...
---
# <a name="manipulating-pointers-c-programming-guide"></a>操作指针（C# 编程指南）
本部分包括以下指针操作：  
  
 [递增和递减](../../../csharp/programming-guide/unsafe-code-pointers/how-to-increment-and-decrement-pointers.md)  
