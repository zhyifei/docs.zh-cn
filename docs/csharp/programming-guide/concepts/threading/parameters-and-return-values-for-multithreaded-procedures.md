...
```  
 ...
 可以通过使用 <xref:System.Threading.ThreadPool.QueueUserWorkItem%2A> 方法的可选 `ByVal` 状态对象变量来向线程池线程提供参数并返回值。 线程计时器线程也支持将状态对象用于此目的。 有关线程池和线程计时器的信息，请参阅[线程池 (C#)](../../../../csharp/programming-guide/concepts/threading/thread-pooling.md) 和[计时器](../../../../standard/threading/timers.md)。  
