...
即使使用[如何流处理可访问标头信息的 XML 片段 (C#)](./how-to-stream-xml-fragments-with-access-to-header-information.md) 中说明的技术，在试图装配包含转换的文档的 XML 树时，内存占用量也会过大。
...
## <a name="example"></a>示例  
 以下示例在[如何流处理可访问标头信息的 XML 片段 (C#)](./how-to-stream-xml-fragments-with-access-to-header-information.md) 中的示例基础上建立。
...
## <a name="example"></a>示例  
以下示例同样在[如何流处理可访问标头信息的 XML 片段 (C#)](./how-to-stream-xml-fragments-with-access-to-header-information.md) 中的示例基础上建立。
