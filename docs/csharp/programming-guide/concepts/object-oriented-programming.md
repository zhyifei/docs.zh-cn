...
---
# <a name="object-oriented-programming-c"></a><span data-ttu-id="1f355-102">面向对象的编程 (C#)</span><span class="sxs-lookup"><span data-stu-id="1f355-102">Object-Oriented Programming (C#)</span></span>
<span data-ttu-id="1f355-103">C# 提供对面向对象的编程（包括封装、继承和多形性）的完整支持。</span><span class="sxs-lookup"><span data-stu-id="1f355-103">C# provides full support for object-oriented programming including encapsulation, inheritance, and polymorphism.</span></span>  
  
 <span data-ttu-id="1f355-104">“封装”意味着将一组相关属性、方法和其他成员视为一个单元或对象。</span><span class="sxs-lookup"><span data-stu-id="1f355-104">*Encapsulation* means that a group of related properties, methods, and other members are treated as a single unit or object.</span></span>  
  
 <span data-ttu-id="1f355-105">“继承”描述基于现有类创建新类的能力。</span><span class="sxs-lookup"><span data-stu-id="1f355-105">*Inheritance* describes the ability to create new classes based on an existing class.</span></span>  
  
 <span data-ttu-id="1f355-106">多形性意味着可以有多个可互换使用的类，即使每个类以不同方式实现相同属性或方法。</span><span class="sxs-lookup"><span data-stu-id="1f355-106">*Polymorphism* means that you can have multiple classes that can be used interchangeably, even though each class implements the same properties or methods in different ways.</span></span>  
  
 <span data-ttu-id="1f355-107">本节介绍下列概念：</span><span class="sxs-lookup"><span data-stu-id="1f355-107">This section describes the following concepts:</span></span>  
  
-   [<span data-ttu-id="1f355-108">类和对象</span><span class="sxs-lookup"><span data-stu-id="1f355-108">Classes and Objects</span></span>](#Classes)  
  
    -   [<span data-ttu-id="1f355-109">类成员</span><span class="sxs-lookup"><span data-stu-id="1f355-109">Class Members</span></span>](#Members)  
  
         [<span data-ttu-id="1f355-110">属性和字段</span><span class="sxs-lookup"><span data-stu-id="1f355-110">Properties and Fields</span></span>](#Properties)  
  
         [<span data-ttu-id="1f355-111">方法</span><span class="sxs-lookup"><span data-stu-id="1f355-111">Methods</span></span>](#Methods)  
  
         [<span data-ttu-id="1f355-112">构造函数</span><span class="sxs-lookup"><span data-stu-id="1f355-112">Constructors</span></span>](#Constructors)  
  
         [<span data-ttu-id="1f355-113">终结器</span><span class="sxs-lookup"><span data-stu-id="1f355-113">Finalizers</span></span>](#Finalizers)  
  
         [<span data-ttu-id="1f355-114">事件</span><span class="sxs-lookup"><span data-stu-id="1f355-114">Events</span></span>](#Events)  
  
         [<span data-ttu-id="1f355-115">嵌套类</span><span class="sxs-lookup"><span data-stu-id="1f355-115">Nested Classes</span></span>](#NestedClasses)  
  
    -   [<span data-ttu-id="1f355-116">访问修饰符和访问级别</span><span class="sxs-lookup"><span data-stu-id="1f355-116">Access Modifiers and Access Levels</span></span>](#AccessModifiers)  
  
    -   [<span data-ttu-id="1f355-117">实例化类</span><span class="sxs-lookup"><span data-stu-id="1f355-117">Instantiating Classes</span></span>](#InstantiatingClasses)  
  
    -   [<span data-ttu-id="1f355-118">静态类和成员</span><span class="sxs-lookup"><span data-stu-id="1f355-118">Static Classes and Members</span></span>](#Static)  
  
    -   [<span data-ttu-id="1f355-119">匿名类型</span><span class="sxs-lookup"><span data-stu-id="1f355-119">Anonymous Types</span></span>](#AnonymousTypes)  
  
-   [<span data-ttu-id="1f355-120">继承</span><span class="sxs-lookup"><span data-stu-id="1f355-120">Inheritance</span></span>](#Inheritance)  
  
    -   [<span data-ttu-id="1f355-121">重写成员</span><span class="sxs-lookup"><span data-stu-id="1f355-121">Overriding Members</span></span>](#Overriding)  
  
-   [<span data-ttu-id="1f355-122">接口</span><span class="sxs-lookup"><span data-stu-id="1f355-122">Interfaces</span></span>](#Interfaces)  
  
-   [<span data-ttu-id="1f355-123">泛型</span><span class="sxs-lookup"><span data-stu-id="1f355-123">Generics</span></span>](#Generics)  
...
```  
 ...
 <span data-ttu-id="1f355-130">C# 还提供了类的轻量版本，称为“结构”。当需要创建大量对象但不希望因此占用太多内存时，可以使用此轻量版本。</span><span class="sxs-lookup"><span data-stu-id="1f355-130">C# also provides a light version of classes called *structures* that are useful when you need to create large array of objects and do not want to consume too much memory for that.</span></span>  
  
 <span data-ttu-id="1f355-131">定义结构：</span><span class="sxs-lookup"><span data-stu-id="1f355-131">To define a structure:</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-132">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-132">For more information, see:</span></span>  
  
-   [<span data-ttu-id="1f355-133">类</span><span class="sxs-lookup"><span data-stu-id="1f355-133">class</span></span>](../../../csharp/language-reference/keywords/class.md)  
...
```  
 ...
 <span data-ttu-id="1f355-141">属性具有 get 和 set 过程，它们对如何设置或返回值提供更多的控制。</span><span class="sxs-lookup"><span data-stu-id="1f355-141">Properties have get and set procedures, which provide more control on how values are set or returned.</span></span>  
  
 <span data-ttu-id="1f355-142">C# 允许你创建私有字段来存储属性值，或者使用常说的“自动实现的属性”，这些属性自动在后台创建此字段，并为属性过程提供基本逻辑。</span><span class="sxs-lookup"><span data-stu-id="1f355-142">C# allows you either to create a private field for storing the property value or use so-called auto-implemented properties that create this field automatically behind the scenes and provide the basic logic for the property procedures.</span></span>  
  
 <span data-ttu-id="1f355-143">定义自动实现的属性：</span><span class="sxs-lookup"><span data-stu-id="1f355-143">To define an auto-implemented property:</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-144">如果你需要执行一些其他操作来读取和写入属性值，请定义一个用于存储属性值的字段，并提供用于存储和检索该字段的基本逻辑：</span><span class="sxs-lookup"><span data-stu-id="1f355-144">If you need to perform some additional operations for reading and writing the property value, define a field for storing the property value and provide the basic logic for storing and retrieving it:</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-145">大多数属性的方法或过程都是既可以设置也可以获取属性值。</span><span class="sxs-lookup"><span data-stu-id="1f355-145">Most properties have methods or procedures to both set and get the property value.</span></span> <span data-ttu-id="1f355-146">但你可以创建只读或只写属性来限制对它们的修改或读取。</span><span class="sxs-lookup"><span data-stu-id="1f355-146">However, you can create read-only or write-only properties to restrict them from being modified or read.</span></span> <span data-ttu-id="1f355-147">在 C# 中，可以忽略 `get` 或 `set` 属性方法。</span><span class="sxs-lookup"><span data-stu-id="1f355-147">In C#, you can omit the `get` or `set` property method.</span></span> <span data-ttu-id="1f355-148">但是，自动实现的属性不能为只读或只写。</span><span class="sxs-lookup"><span data-stu-id="1f355-148">However, auto-implemented properties cannot be read-only or write-only.</span></span>  
  
 <span data-ttu-id="1f355-149">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-149">For more information, see:</span></span>  
  
-   [<span data-ttu-id="1f355-150">get</span><span class="sxs-lookup"><span data-stu-id="1f355-150">get</span></span>](../../../csharp/language-reference/keywords/get.md)  
...
```  
 ...
 <span data-ttu-id="1f355-155">对于同一方法，一个类可以有多个实现，也叫“重载”，这些实现的区别在于参数个数或参数类型的不同。</span><span class="sxs-lookup"><span data-stu-id="1f355-155">A class can have several implementations, or *overloads*, of the same method that differ in the number of parameters or parameter types.</span></span>  
  
 <span data-ttu-id="1f355-156">重载方法：</span><span class="sxs-lookup"><span data-stu-id="1f355-156">To overload a method:</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-157">大多数情况下，方法是在类定义中声明的。</span><span class="sxs-lookup"><span data-stu-id="1f355-157">In most cases you declare a method within a class definition.</span></span> <span data-ttu-id="1f355-158">但是，C# 还支持“扩展方法”，这种方法允许你将方法添加到实际类定义之外的现有类中。</span><span class="sxs-lookup"><span data-stu-id="1f355-158">However, C# also supports *extension methods* that allow you to add methods to an existing class outside the actual definition of the class.</span></span>  
  
 <span data-ttu-id="1f355-159">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-159">For more information, see:</span></span>  
  
-   [<span data-ttu-id="1f355-160">方法</span><span class="sxs-lookup"><span data-stu-id="1f355-160">Methods</span></span>](../../../csharp/programming-guide/classes-and-structs/methods.md)  
...
```  
 ...
 <span data-ttu-id="1f355-169">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-169">For more information, see:</span></span>  
...
-   <span data-ttu-id="1f355-182">若要引发事件，请调用事件委托。</span><span class="sxs-lookup"><span data-stu-id="1f355-182">To raise an event, invoke the event delegate.</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-187">若要创建嵌套类的实例，请使用容器类的名称，后接一个点，再接嵌套类的名称：</span><span class="sxs-lookup"><span data-stu-id="1f355-187">To create an instance of the nested class, use the name of the container class followed by the dot and then followed by the name of the nested class:</span></span>  
...
|<span data-ttu-id="1f355-191">C# 修饰符</span><span class="sxs-lookup"><span data-stu-id="1f355-191">C# Modifier</span></span>|<span data-ttu-id="1f355-192">定义</span><span class="sxs-lookup"><span data-stu-id="1f355-192">Definition</span></span>|  
|------------------|----------------|  
|[<span data-ttu-id="1f355-193">公用</span><span class="sxs-lookup"><span data-stu-id="1f355-193">public</span></span>](../../../csharp/language-reference/keywords/public.md)|<span data-ttu-id="1f355-194">同一程序集中的任何其他代码或引用该程序集的其他程序集都可以访问该类型或成员。</span><span class="sxs-lookup"><span data-stu-id="1f355-194">The type or member can be accessed by any other code in the same assembly or another assembly that references it.</span></span>|  
|[<span data-ttu-id="1f355-195">专用</span><span class="sxs-lookup"><span data-stu-id="1f355-195">private</span></span>](../../../csharp/language-reference/keywords/private.md)|<span data-ttu-id="1f355-196">只有同一类中的代码可以访问该类型或成员。</span><span class="sxs-lookup"><span data-stu-id="1f355-196">The type or member can only be accessed by code in the same class.</span></span>|  
|[<span data-ttu-id="1f355-197">受保护</span><span class="sxs-lookup"><span data-stu-id="1f355-197">protected</span></span>](../../../csharp/language-reference/keywords/protected.md)|<span data-ttu-id="1f355-198">只有同一类或派生类中的代码可以访问该类型或成员。</span><span class="sxs-lookup"><span data-stu-id="1f355-198">The type or member can only be accessed by code in the same class or in a derived class.</span></span>|  
|[<span data-ttu-id="1f355-199">内部</span><span class="sxs-lookup"><span data-stu-id="1f355-199">internal</span></span>](../../../csharp/language-reference/keywords/internal.md)|<span data-ttu-id="1f355-200">同一程序集中的任何代码都可以访问该类型或成员，但其他程序集中的代码不可以。</span><span class="sxs-lookup"><span data-stu-id="1f355-200">The type or member can be accessed by any code in the same assembly, but not from another assembly.</span></span>|  
|[<span data-ttu-id="1f355-201">受保护内部</span><span class="sxs-lookup"><span data-stu-id="1f355-201">protected internal</span></span>](../../../csharp/language-reference/keywords/protected-internal.md)|<span data-ttu-id="1f355-202">同一程序集中的任何代码或其他程序集中的任何派生类都可以访问该类型或成员。</span><span class="sxs-lookup"><span data-stu-id="1f355-202">The type or member can be accessed by any code in the same assembly, or by any derived class in another assembly.</span></span>|  
|[<span data-ttu-id="1f355-203">私有受保护</span><span class="sxs-lookup"><span data-stu-id="1f355-203">private protected</span></span>](../../../csharp/language-reference/keywords/private-protected.md)|<span data-ttu-id="1f355-204">同一个类或基类程序集中的派生类中的代码，可以访问该类型或成员。</span><span class="sxs-lookup"><span data-stu-id="1f355-204">The type or member can be accessed by code in the same class or in a derived class within the base class assembly.</span></span>|  
...
```  
 ...
 <span data-ttu-id="1f355-208">实例化类之后，可以为该实例的属性和字段赋值，还可以调用类方法。</span><span class="sxs-lookup"><span data-stu-id="1f355-208">After instantiating a class, you can assign values to the instance's properties and fields and invoke class methods.</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-209">若要在类的实例化过程中为属性赋值，请使用对象初始值设定项：</span><span class="sxs-lookup"><span data-stu-id="1f355-209">To assign values to properties during the class instantiation process, use object initializers:</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-210">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-210">For more information, see:</span></span>  
  
-   [<span data-ttu-id="1f355-211">new 运算符</span><span class="sxs-lookup"><span data-stu-id="1f355-211">new Operator</span></span>](../../../csharp/language-reference/keywords/new-operator.md)  
...
```  
 ...
 <span data-ttu-id="1f355-216">若要访问静态成员，请使用类的名称，但不要创建此类的对象：</span><span class="sxs-lookup"><span data-stu-id="1f355-216">To access the static member, use the name of the class without creating an object of this class:</span></span>  
  
```csharp  
Console.WriteLine(SampleClass.SampleString);  
```  
  
 <span data-ttu-id="1f355-217">C# 中的静态类只有静态成员，无法进行实例化。</span><span class="sxs-lookup"><span data-stu-id="1f355-217">Static  classes in C# have static members only and cannot be instantiated.</span></span> <span data-ttu-id="1f355-218">静态成员也无法访问非静态属性、字段或方法</span><span class="sxs-lookup"><span data-stu-id="1f355-218">Static members also cannot access non-static  properties, fields or methods</span></span>  
...
> [!NOTE]
>  <span data-ttu-id="1f355-230">C# 不支持多重继承。</span><span class="sxs-lookup"><span data-stu-id="1f355-230">C# doesn't support multiple inheritance.</span></span> <span data-ttu-id="1f355-231">即，只能为一个派生类指定一个基类。</span><span class="sxs-lookup"><span data-stu-id="1f355-231">That is, you can specify only one base class for a derived class.</span></span>  
  
 <span data-ttu-id="1f355-232">从基类继承：</span><span class="sxs-lookup"><span data-stu-id="1f355-232">To inherit from a base class:</span></span>  
  
```csharp  
class DerivedClass:BaseClass{}  
```  
  
 <span data-ttu-id="1f355-233">默认情况下，可以继承所有类。</span><span class="sxs-lookup"><span data-stu-id="1f355-233">By default all classes can be inherited.</span></span> <span data-ttu-id="1f355-234">但你可以指定不得将某个类用作基类，也可以创建只能用作基类的类。</span><span class="sxs-lookup"><span data-stu-id="1f355-234">However, you can specify whether a class must not be used as a base class, or create a class that can be used as a base class only.</span></span>  
  
 <span data-ttu-id="1f355-235">指定不得将某个类用作基类：</span><span class="sxs-lookup"><span data-stu-id="1f355-235">To specify that a class cannot be used as a base class:</span></span>  
  
```csharp  
public sealed class A { }  
```  
  
 <span data-ttu-id="1f355-236">指定只能用作基类且无法实例化的类：</span><span class="sxs-lookup"><span data-stu-id="1f355-236">To specify that a class can be used as a base class only and cannot be instantiated:</span></span>  
  
```csharp  
public abstract class B { }  
```  
  
 <span data-ttu-id="1f355-237">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-237">For more information, see:</span></span>  
  
-   [<span data-ttu-id="1f355-238">sealed</span><span class="sxs-lookup"><span data-stu-id="1f355-238">sealed</span></span>](../../../csharp/language-reference/keywords/sealed.md)  
...
|<span data-ttu-id="1f355-245">C# 修饰符</span><span class="sxs-lookup"><span data-stu-id="1f355-245">C# Modifier</span></span>|<span data-ttu-id="1f355-246">定义</span><span class="sxs-lookup"><span data-stu-id="1f355-246">Definition</span></span>|  
|------------------|----------------|  
|[<span data-ttu-id="1f355-247">virtual</span><span class="sxs-lookup"><span data-stu-id="1f355-247">virtual</span></span>](../../../csharp/language-reference/keywords/virtual.md)|<span data-ttu-id="1f355-248">允许在派生类中重写类成员。</span><span class="sxs-lookup"><span data-stu-id="1f355-248">Allows a class member to be overridden in a derived class.</span></span>|  
|[<span data-ttu-id="1f355-249">替代</span><span class="sxs-lookup"><span data-stu-id="1f355-249">override</span></span>](../../../csharp/language-reference/keywords/override.md)|<span data-ttu-id="1f355-250">重写基类中定义的虚拟（可重写）成员。</span><span class="sxs-lookup"><span data-stu-id="1f355-250">Overrides a virtual (overridable) member defined in the base class.</span></span>|  
...
```  
 ...
 <span data-ttu-id="1f355-261">在类中实现接口：</span><span class="sxs-lookup"><span data-stu-id="1f355-261">To implement an interface in a class:</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-262">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-262">For more information, see:</span></span>  
  
 [<span data-ttu-id="1f355-263">接口</span><span class="sxs-lookup"><span data-stu-id="1f355-263">Interfaces</span></span>](../../../csharp/programming-guide/interfaces/index.md)  
...
```  
 ...
 <span data-ttu-id="1f355-269">创建泛型类的实例：</span><span class="sxs-lookup"><span data-stu-id="1f355-269">To create an instance of a generic class:</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-270">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-270">For more information, see:</span></span>  
  
-   [<span data-ttu-id="1f355-271">泛型</span><span class="sxs-lookup"><span data-stu-id="1f355-271">Generics</span></span>](~/docs/standard/generics/index.md)  
...
> [!NOTE]
>  <span data-ttu-id="1f355-277">事件处理程序就是通过委托调用的方法。</span><span class="sxs-lookup"><span data-stu-id="1f355-277">Event handlers are nothing more than methods that are invoked through delegates.</span></span> <span data-ttu-id="1f355-278">有关在事件处理中使用委托的详细信息，请参阅[事件](../../../standard/events/index.md)。</span><span class="sxs-lookup"><span data-stu-id="1f355-278">For more information about using delegates in event handling, see [Events](../../../standard/events/index.md).</span></span>  
  
 <span data-ttu-id="1f355-279">创建委托：</span><span class="sxs-lookup"><span data-stu-id="1f355-279">To create a delegate:</span></span>  
  
```csharp  
public delegate void SampleDelegate(string str);  
```  
  
 <span data-ttu-id="1f355-280">创建对与委托指定的签名相匹配的方法的引用：</span><span class="sxs-lookup"><span data-stu-id="1f355-280">To create a reference to a method that matches the signature specified by the delegate:</span></span>  
...
```  
 ...
 <span data-ttu-id="1f355-281">有关详细信息，请参见:</span><span class="sxs-lookup"><span data-stu-id="1f355-281">For more information, see:</span></span>  
  
-   [<span data-ttu-id="1f355-282">委托</span><span class="sxs-lookup"><span data-stu-id="1f355-282">Delegates</span></span>](../../../csharp/programming-guide/delegates/index.md)  
  
-   [<span data-ttu-id="1f355-283">委托</span><span class="sxs-lookup"><span data-stu-id="1f355-283">delegate</span></span>](../../../csharp/language-reference/keywords/delegate.md)  
  
## <a name="see-also"></a><span data-ttu-id="1f355-284">请参阅</span><span class="sxs-lookup"><span data-stu-id="1f355-284">See Also</span></span>  
 [<span data-ttu-id="1f355-285">C# 编程指南</span><span class="sxs-lookup"><span data-stu-id="1f355-285">C# Programming Guide</span></span>](../../../csharp/programming-guide/index.md)
