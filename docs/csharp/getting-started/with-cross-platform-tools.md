...
# <a name="-getting-started-with-c-using-the-cross-platform-command-line-tools"></a>🔧 C# 和跨平台命令行工具入门

> **注意**
> 
> 尚未编写此主题！ 
>
> 欢迎提供建议，以帮助我们确定范围和方法。 可在 GitHub 处跟踪有关此[问题](https://github.com/dotnet/docs/issues/945)的状态并提供相关建议。
> 
