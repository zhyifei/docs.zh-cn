...
[字符串内插](interpolated-strings.yml)教程将介绍如何将值插入到字符串中。 你将学习如何创建带有嵌入式 C# 表达式的内插字符串，以及如何控制输出字符串的格式设置。 本教程也可[下载到计算机本地进行学习](interpolated-strings-local.md)。

若要更好地学习本教程，需要先完成 [Hello World](hello-world.yml)、[C# 中的数字](numbers-in-csharp.yml)以及[分支和循环](branches-and-loops.yml)课程。
