---
title: "异步 UI 编程 - C# 指南 | Microsoft Docs"
description: "了解如何在对异步操作进行编程的同时让 UI 一直及时响应"
keywords: C#, UWP, XAML
ms.date: 08/24/2016
ms.topic: article
ms.prod: .net
...
# <a name="-asynchronous-ui-programming"></a>🔧 异步 UI 编程

> **注意**
> 
> 尚未编写此主题！ 
>
> 欢迎提供建议，以帮助我们确定范围和方法。 可在 GitHub 处跟踪有关此[问题](https://github.com/dotnet/docs/issues/951)的状态并提供相关建议。
> 
