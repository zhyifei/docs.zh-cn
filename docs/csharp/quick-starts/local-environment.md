...
在 [C# 中的数字](numbers-in-csharp-local.md)快速入门教程中，你将了解计算机如何存储数字以及如何执行不同数字类型的运算。 读者将学习四舍五入的基础知识，以及如何使用 C# 执行数学运算。 
...
[分支和循环](branches-and-loops-local.md)快速入门教程将介绍根据变量中存储的值选择不同代码执行路径的基础知识。 读者将学习控制流的基础知识，这是程序决定选择不同操作的基本依据。 
