---
title: "结合使用 C# Interactive 和 Powershell | C# Guide"
description: "探索 Windows 命令行中的 C# Interactive Shell"
...
# <a name="-using-c-interactive-with-powershell"></a>🔧使用 C# Interactive 和 Powershell

> **注意**
> 
> 尚未编写此主题！ 
>
> 欢迎提供建议，以帮助我们确定范围和方法。 可在 GitHub 处跟踪有关此[问题](https://github.com/dotnet/docs/issues/970)的状态并提供相关建议。
> 
