...
## <a name="com-client"></a><span data-ttu-id="ca7c7-106">COM 客户端</span><span class="sxs-lookup"><span data-stu-id="ca7c7-106">COM Client</span></span>  
...
## <a name="net-server"></a><span data-ttu-id="ca7c7-107">.NET 服务器</span><span class="sxs-lookup"><span data-stu-id="ca7c7-107">.NET Server</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="ca7c7-108">请参阅</span><span class="sxs-lookup"><span data-stu-id="ca7c7-108">See Also</span></span>  
 [<span data-ttu-id="ca7c7-109">向 COM 公开 .NET Framework 组件</span><span class="sxs-lookup"><span data-stu-id="ca7c7-109">Exposing .NET Framework Components to COM</span></span>](../../../docs/framework/interop/exposing-dotnet-components-to-com.md)
