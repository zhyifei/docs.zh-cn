---
title: "如何：将托管代码 DCOM 迁移到 WCF | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### 步骤 5：运行服务  
 最后，通过向服务应用程序添加以下行并启动此应用程序，你可以在控制台应用程序中自承载服务。  有关托管 WCF 服务应用程序的其他方式的详细信息，请参阅[承载服务](../../../docs/framework/wcf/hosting-services.md)。  
