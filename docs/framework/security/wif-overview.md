...
- 利用适用于 Visual Studio 11 的新的标识和访问工具，您可以使用基于声明的标识保护您的应用程序，并接受来自多个标识提供程序的用户。 您可以从以下 URL 下载此 WIF 工具：<https://go.microsoft.com/fwlink/?LinkID=245849>或直接从 Visual Studio 11 中搜索"标识"直接在扩展管理器中。 有关详细信息，请参阅[用于 Visual Studio 2012 的标识和访问工具](../../../docs/framework/security/identity-and-access-tool-for-vs.md)。  
