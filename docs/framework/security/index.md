...
- [Windows Identity Foundation 4.5 概述](../../../docs/framework/security/wif-overview.md)

  - [基于声明的标识模型](../../../docs/framework/security/claims-based-identity-model.md)

  - [使用 WIF 的基于声明的授权](../../../docs/framework/security/claims-based-authorization-using-wif.md)

  - [WIF 声明编程模型](../../../docs/framework/security/wif-claims-programming-model.md)
...
- [WIF 代码示例索引](../../../docs/framework/security/wif-code-sample-index.md)

- [WIF 扩展](../../../docs/framework/security/wif-extensions.md)

- [WIF API 参考](../../../docs/framework/security/wif-api-reference.md)

- [WIF 配置参考](../../../docs/framework/security/wif-configuration-reference.md)

  - [WIF 配置架构约定](../../../docs/framework/security/wif-configuration-schema-conventions.md)
