...
## <a name="machine-configuration-files"></a>计算机配置文件  
 计算机配置文件 Machine.config 包含应用于整个计算机的设置。 此文件位于 %*runtime install path*%\Config 目录中。 Machine.config 包含整个计算机范围内的程序集绑定、内置[远程处理信道](http://msdn.microsoft.com/en-us/6e9b60e0-9bc0-47b4-a8ef-3b78585f9a18)和 ASP.NET 的配置设置。  
...
-   ASP.NET 承载的应用。  
     ...
     有关 ASP.NET 配置文件的详细信息，请参阅 [ASP.NET 配置设置](http://msdn.microsoft.com/en-us/116608f3-c03d-4413-9fc7-978703e18b0f)  
...
## <a name="see-also"></a>另请参阅  
 ...
 [指定程序集的位置](../../../docs/framework/configure-apps/specify-assembly-location.md)   
 [重定向程序集版本](../../../docs/framework/configure-apps/redirect-assembly-versions.md)   
 [使用配置文件注册远程对象](http://msdn.microsoft.com/en-us/bc503ee1-c811-4f82-9525-470343326adc)   
 [ASP.NET 网站管理](http://msdn.microsoft.com/library/1298034b-5f7d-464d-abd1-ad9e6b3eeb7e)   
 [NIB：安全策略管理](http://msdn.microsoft.com/en-us/d754e05d-29dc-4d3a-a2c2-95eaaf1b82b9)   
 [Caspol.exe（代码访问安全性策略工具）](../../../docs/framework/tools/caspol-exe-code-access-security-policy-tool.md)   
