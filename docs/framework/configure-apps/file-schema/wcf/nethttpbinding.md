...
Represents a binding that a Windows Communication Foundation (WCF) service can use to configure and expose endpoints that are able to communicate over HTTP. 如果用于双工协定，将使用 Web Sockets，否则将使用 HTTP。  
