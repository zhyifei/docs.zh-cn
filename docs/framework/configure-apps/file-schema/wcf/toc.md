...
######## [<add>的<defaultPorts>](add-of-defaultports.md)
...
####### [<connectionPoolSettings>的<namedPipeTransport>](connectionpoolsettings.md)
...
##### [<add>的<namespaceTable>](add-of-namespacetable.md)
