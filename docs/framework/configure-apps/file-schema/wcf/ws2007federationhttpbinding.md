...
|`textEncoding`|设置要用来在绑定上发出消息的字符集编码。 包括以下有效值：<br /><br /> BigEndianUnicodeUnicode 大字节序编码。<br />Unicode16位编码。<br />UTF88位编码。<br /><br /> 默认值为 UTF8。 此属性的类型为 <xref:System.Text.Encoding>。|
