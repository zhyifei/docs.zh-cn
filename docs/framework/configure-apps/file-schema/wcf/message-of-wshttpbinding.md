...
---
# <a name="message-of-wshttpbinding"></a>\<wsHttpBinding > 的\<消息 >
定义[ \<wsHttpBinding >](wshttpbinding.md)的消息级安全性设置。  
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **\<绑定 >** \
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ **\<安全 >** ](security-of-wshttpbinding.md)\
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; **\<消息 >**  
...
|元素|描述|  
|-------------|-----------------|  
|[\<security>](security-of-wshttpbinding.md)|定义[ \<wsHttpBinding >](wshttpbinding.md)的安全设置。|  
