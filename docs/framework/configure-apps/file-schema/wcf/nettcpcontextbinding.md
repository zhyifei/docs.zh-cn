...
|contextProtectionLevel|一个有效的 <xref:System.Net.Security.ProtectionLevel> 值，指定用于传播上下文信息的 SOAP 标头的所需保护级别。  默认值为 <xref:System.Net.Security.ProtectionLevel.Sign>。|  
