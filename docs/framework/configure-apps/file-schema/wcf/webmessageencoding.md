...
|`writeEncoding`|指定要用来在绑定上发出消息的字符集编码。 有效值为：<br /><br /> -UnicodeFffeTextEncoding： Unicode Big Endian 编码。<br />-Utf16TextEncoding： Unicode 编码。<br />-Utf8TextEncoding：8位编码。<br /><br /> 默认值为 Utf8TextEncoding。 此属性的类型为 <xref:System.Text.Encoding>。|  
