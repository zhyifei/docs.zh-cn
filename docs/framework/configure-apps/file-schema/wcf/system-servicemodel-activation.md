...
## <a name="sample-configuration-file"></a><span data-ttu-id="ec5e8-106">示例配置文件</span><span class="sxs-lookup"><span data-stu-id="ec5e8-106">Sample Configuration File</span></span>  
 <span data-ttu-id="ec5e8-107">下面是侦听器进程 SMSvcHost.exe 所使用的示例配置文件 (SMSvcHost.exe.config)。</span><span class="sxs-lookup"><span data-stu-id="ec5e8-107">The following is a sample configuration file (SMSvcHost.exe.config), which is used by the listener process SMSvcHost.exe.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="ec5e8-108">请参阅</span><span class="sxs-lookup"><span data-stu-id="ec5e8-108">See Also</span></span>  
