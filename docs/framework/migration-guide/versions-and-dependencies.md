...
|3.5|2.0|-   启用 AJAX 的网站<br />-   LINQ<br />-   动态数据<br />-   [更多...](http://msdn.microsoft.com/library/ms171868\(v=vs.90\).aspx)|2008|✓ 10<br />✓ 8.1*<br />✓ 8\*<br />✓ 7<br />+ Vista|✓2008 R2 SP1*<br />+ 2012 R2<br />+ 2012<br />+ 2008 SP2<br />+ 2003|请参阅[说明](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md)|  
