...
---
# <a name="runtime-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="a77a2-102">针对 .NET Framework 4.7.2 到 4.8 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="a77a2-102">Runtime Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="a77a2-103">如果要从 .NET Framework 4.7.2 迁移到 4.8，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="a77a2-103">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a77a2-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a77a2-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a77a2-105">核心</span><span class="sxs-lookup"><span data-stu-id="a77a2-105">Core</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a77a2-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a77a2-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a77a2-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a77a2-107">Windows Presentation Foundation (WPF)</span></span>
