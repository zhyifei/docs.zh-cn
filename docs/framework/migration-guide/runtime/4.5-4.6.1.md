---
title: "从.NET Framework 4.5 到 4.6.1 进行迁移的运行时更改"
ms.date: 06/16/2017
...
ms.assetid: 15b2bd07-383f-4fee-addf-ca793e8af6b2
author: conniey
ms.author: ronpet
manager: wpickett
ms.openlocfilehash: 52edfcf898712a3d059b31002f4d6af9750e8527
ms.sourcegitcommit: 32f5e1db8755ed7dfac0b4ec764fa809e5a7548c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2017
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-461"></a><span data-ttu-id="6b188-102">从.NET Framework 4.5 到 4.6.1 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="6b188-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="6b188-103">如果你要迁移从.NET Framework 4.5 到 4.6.1，查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="6b188-103">If you are migrating from the .NET Framework 4.5 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="6b188-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="6b188-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="6b188-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="6b188-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="6b188-106">核心</span><span class="sxs-lookup"><span data-stu-id="6b188-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="6b188-107">数据</span><span class="sxs-lookup"><span data-stu-id="6b188-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="6b188-108">调试器</span><span class="sxs-lookup"><span data-stu-id="6b188-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="6b188-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="6b188-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="6b188-110">网络</span><span class="sxs-lookup"><span data-stu-id="6b188-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="6b188-111">序列化</span><span class="sxs-lookup"><span data-stu-id="6b188-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="6b188-112">安装和部署</span><span class="sxs-lookup"><span data-stu-id="6b188-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="6b188-113">工具</span><span class="sxs-lookup"><span data-stu-id="6b188-113">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="6b188-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="6b188-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="6b188-115">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="6b188-115">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="6b188-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="6b188-116">Windows Presentation Foundation (WPF)</span></span>
