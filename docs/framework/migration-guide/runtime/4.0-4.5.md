...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-45"></a>从.NET Framework 4.0 为 4.5 的迁移的运行时更改

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

如果为 4.5，要从.NET Framework 4.0 进行迁移，请查看可能影响你的应用的应用程序兼容性问题的以下主题：
