---
title: "从.NET Framework 4.6.1 到 4.6.2 进行迁移的运行时更改"
ms.date: 06/16/2017
...
ms.author: ronpet
manager: wpickett
ms.openlocfilehash: f32cda012c4b9d3fb0bf2cbae188466043ade074
ms.sourcegitcommit: 32f5e1db8755ed7dfac0b4ec764fa809e5a7548c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2017
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-462"></a><span data-ttu-id="64910-102">从.NET Framework 4.6.1 到 4.6.2 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="64910-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="64910-103">如果你要从.NET Framework 4.6.1 到 4.6.2 迁移，请查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="64910-103">If you are migrating from the .NET Framework 4.6.1 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="64910-104">核心</span><span class="sxs-lookup"><span data-stu-id="64910-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="64910-105">数据</span><span class="sxs-lookup"><span data-stu-id="64910-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="64910-106">全球化</span><span class="sxs-lookup"><span data-stu-id="64910-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="64910-107">安全性</span><span class="sxs-lookup"><span data-stu-id="64910-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="64910-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="64910-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="64910-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="64910-109">Windows Presentation Foundation (WPF)</span></span>
