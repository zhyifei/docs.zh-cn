...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="b6f35-102">从.NET Framework 4.5 到 4.5.1 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="b6f35-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="b6f35-103">如果你将文件从.NET Framework 4.5 迁移，对 4.5.1，查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="b6f35-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b6f35-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b6f35-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b6f35-105">核心</span><span class="sxs-lookup"><span data-stu-id="b6f35-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b6f35-106">序列化</span><span class="sxs-lookup"><span data-stu-id="b6f35-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b6f35-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b6f35-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b6f35-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b6f35-108">Windows Presentation Foundation (WPF)</span></span>
