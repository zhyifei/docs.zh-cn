...
manager: wpickett
ms.workload: dotnet
ms.openlocfilehash: 2190bfd119bc7629ee63b146b1b3b5549c553349
ms.sourcegitcommit: 16186c34a957fdd52e5db7294f291f7530ac9d24
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/22/2017
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="118eb-102">针对 .NET Framework 4.5 到 4.5.1 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="118eb-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="118eb-103">如果要从 .NET Framework 4.5 迁移到 4.5.1，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="118eb-103">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="118eb-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="118eb-104">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="118eb-105">核心</span><span class="sxs-lookup"><span data-stu-id="118eb-105">Core</span></span>
...
## <a name="serialization"></a><span data-ttu-id="118eb-106">序列化</span><span class="sxs-lookup"><span data-stu-id="118eb-106">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="118eb-107">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="118eb-107">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="118eb-108">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="118eb-108">Windows Presentation Foundation (WPF)</span></span>
