...
author: chlowell
ms.openlocfilehash: 33badd271f6a50307dc5ee85d232dd186ccb7d2e
ms.sourcegitcommit: 7588136e355e10cbc2582f389c90c127363c02a5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/15/2020
ms.locfileid: "73196111"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="269b5-102">针对 .NET Framework 4.5.2 到 4.6 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="269b5-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="269b5-103">如果要从 .NET Framework 4.5.2 迁移到 4.6，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="269b5-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="269b5-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="269b5-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="269b5-105">核心</span><span class="sxs-lookup"><span data-stu-id="269b5-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="269b5-106">data</span><span class="sxs-lookup"><span data-stu-id="269b5-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="269b5-107">调试器</span><span class="sxs-lookup"><span data-stu-id="269b5-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="269b5-108">网络</span><span class="sxs-lookup"><span data-stu-id="269b5-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="269b5-109">序列化</span><span class="sxs-lookup"><span data-stu-id="269b5-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="269b5-110">安装和部署</span><span class="sxs-lookup"><span data-stu-id="269b5-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="269b5-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="269b5-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="269b5-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="269b5-112">Windows Presentation Foundation (WPF)</span></span>
