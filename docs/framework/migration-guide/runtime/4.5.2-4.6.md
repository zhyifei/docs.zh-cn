...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="88360-102">针对 .NET Framework 4.5.2 到 4.6 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="88360-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="88360-103">如果要从 .NET Framework 4.5.2 迁移到 4.6，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="88360-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="88360-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="88360-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="88360-105">核心</span><span class="sxs-lookup"><span data-stu-id="88360-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="88360-106">数据</span><span class="sxs-lookup"><span data-stu-id="88360-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="88360-107">调试器</span><span class="sxs-lookup"><span data-stu-id="88360-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="88360-108">网络</span><span class="sxs-lookup"><span data-stu-id="88360-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="88360-109">序列化</span><span class="sxs-lookup"><span data-stu-id="88360-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="88360-110">安装和部署</span><span class="sxs-lookup"><span data-stu-id="88360-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="88360-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="88360-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="88360-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="88360-112">Windows Presentation Foundation (WPF)</span></span>
