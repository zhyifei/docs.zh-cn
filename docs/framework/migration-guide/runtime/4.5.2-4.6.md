---
title: "从.NET Framework 4.5.2 到 4.6 进行迁移的运行时更改"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="80795-102">从.NET Framework 4.5.2 到 4.6 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="80795-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="80795-103">如果你要迁移从.NET Framework 4.5.2 到 4.6，请查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="80795-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="80795-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="80795-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="80795-105">核心</span><span class="sxs-lookup"><span data-stu-id="80795-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="80795-106">数据</span><span class="sxs-lookup"><span data-stu-id="80795-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="80795-107">调试器</span><span class="sxs-lookup"><span data-stu-id="80795-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="80795-108">网络</span><span class="sxs-lookup"><span data-stu-id="80795-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="80795-109">序列化</span><span class="sxs-lookup"><span data-stu-id="80795-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="80795-110">安装和部署</span><span class="sxs-lookup"><span data-stu-id="80795-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="80795-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="80795-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="80795-112">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="80795-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="80795-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="80795-113">Windows Presentation Foundation (WPF)</span></span>
