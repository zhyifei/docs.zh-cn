...
author: chlowell
ms.author: ronpet
ms.openlocfilehash: db059973a6e27b5f0c247f6efcf746d77404d9fd
ms.sourcegitcommit: 4d8efe00f2e5ab42e598aff298d13b8c052d9593
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/16/2019
ms.locfileid: "68237766"
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a><span data-ttu-id="7f342-102">针对 .NET Framework 4.7 到 4.7.1 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="7f342-102">Runtime Changes for Migration from .NET Framework 4.7 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="7f342-103">如果要从 .NET Framework 4.7 迁移到 4.7.1，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="7f342-103">If you are migrating from the .NET Framework 4.7 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="jit"></a><span data-ttu-id="7f342-104">JIT</span><span class="sxs-lookup"><span data-stu-id="7f342-104">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="7f342-105">安全性</span><span class="sxs-lookup"><span data-stu-id="7f342-105">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7f342-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="7f342-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7f342-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7f342-107">Windows Presentation Foundation (WPF)</span></span>
