...
ms.locfileid: "67857738"
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a><span data-ttu-id="90f68-102">针对 .NET Framework 4.7 到 4.7.1 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="90f68-102">Runtime Changes for Migration from .NET Framework 4.7 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="90f68-103">如果要从 .NET Framework 4.7 迁移到 4.7.1，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="90f68-103">If you are migrating from the .NET Framework 4.7 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="jit"></a><span data-ttu-id="90f68-104">JIT</span><span class="sxs-lookup"><span data-stu-id="90f68-104">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="90f68-105">安全性</span><span class="sxs-lookup"><span data-stu-id="90f68-105">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="90f68-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="90f68-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="90f68-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="90f68-107">Windows Presentation Foundation (WPF)</span></span>
