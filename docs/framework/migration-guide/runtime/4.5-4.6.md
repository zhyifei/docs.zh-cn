...
ms.locfileid: "37072090"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="cc11f-102">针对 .NET Framework 4.5 到 4.6 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="cc11f-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="cc11f-103">如果要从 .NET Framework 4.5 迁移到 4.6，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="cc11f-103">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="cc11f-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="cc11f-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="cc11f-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="cc11f-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="cc11f-106">核心</span><span class="sxs-lookup"><span data-stu-id="cc11f-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="cc11f-107">数据</span><span class="sxs-lookup"><span data-stu-id="cc11f-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="cc11f-108">调试器</span><span class="sxs-lookup"><span data-stu-id="cc11f-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="cc11f-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="cc11f-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="cc11f-110">网络</span><span class="sxs-lookup"><span data-stu-id="cc11f-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="cc11f-111">序列化</span><span class="sxs-lookup"><span data-stu-id="cc11f-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="cc11f-112">安装和部署</span><span class="sxs-lookup"><span data-stu-id="cc11f-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cc11f-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="cc11f-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cc11f-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="cc11f-114">Windows Presentation Foundation (WPF)</span></span>
