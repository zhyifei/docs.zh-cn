...
ms.workload:
- dotnet
ms.openlocfilehash: 147c12536dca269fb2fedf0d371179fc6343ec14
ms.sourcegitcommit: 935d5267c44f9bce801468ef95f44572f1417e8c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/28/2018
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a><span data-ttu-id="fdd15-102">针对 .NET Framework 4.0 到 4.5.2 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="fdd15-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="fdd15-103">如果要从 .NET Framework 4.0 迁移到 4.5.2，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="fdd15-103">If you are migrating from the .NET Framework 4.0 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="fdd15-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="fdd15-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="fdd15-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="fdd15-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="fdd15-106">核心</span><span class="sxs-lookup"><span data-stu-id="fdd15-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="fdd15-107">数据</span><span class="sxs-lookup"><span data-stu-id="fdd15-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="fdd15-108">调试器</span><span class="sxs-lookup"><span data-stu-id="fdd15-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="fdd15-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="fdd15-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="fdd15-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="fdd15-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="fdd15-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="fdd15-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="fdd15-112">网络</span><span class="sxs-lookup"><span data-stu-id="fdd15-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="fdd15-113">打印</span><span class="sxs-lookup"><span data-stu-id="fdd15-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="fdd15-114">序列化</span><span class="sxs-lookup"><span data-stu-id="fdd15-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="fdd15-115">Web 应用程序</span><span class="sxs-lookup"><span data-stu-id="fdd15-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="fdd15-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="fdd15-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="fdd15-117">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="fdd15-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="fdd15-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="fdd15-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="fdd15-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="fdd15-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="fdd15-120">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="fdd15-120">XML, XSLT</span></span>
