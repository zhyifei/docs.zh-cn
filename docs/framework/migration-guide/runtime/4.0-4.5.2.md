---
title: "从.NET Framework 4.0 到 4.5.2 进行迁移的运行时更改"
ms.date: 06/16/2017
...
ms.author: ronpet
manager: wpickett
ms.openlocfilehash: a7a035c87162e3da77c4f3ef7ed1339928cf11a7
ms.sourcegitcommit: 32f5e1db8755ed7dfac0b4ec764fa809e5a7548c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2017
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a><span data-ttu-id="3c14a-102">从.NET Framework 4.0 到 4.5.2 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="3c14a-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="3c14a-103">如果你要从迁移.NET Framework 4.0 到 4.5.2，查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="3c14a-103">If you are migrating from the .NET Framework 4.0 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="3c14a-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="3c14a-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="3c14a-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3c14a-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3c14a-106">核心</span><span class="sxs-lookup"><span data-stu-id="3c14a-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="3c14a-107">数据</span><span class="sxs-lookup"><span data-stu-id="3c14a-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="3c14a-108">调试器</span><span class="sxs-lookup"><span data-stu-id="3c14a-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3c14a-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3c14a-109">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="3c14a-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="3c14a-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="3c14a-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="3c14a-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="3c14a-112">网络</span><span class="sxs-lookup"><span data-stu-id="3c14a-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="3c14a-113">打印</span><span class="sxs-lookup"><span data-stu-id="3c14a-113">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3c14a-114">序列化</span><span class="sxs-lookup"><span data-stu-id="3c14a-114">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="3c14a-115">Web 应用程序</span><span class="sxs-lookup"><span data-stu-id="3c14a-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3c14a-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3c14a-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="3c14a-117">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="3c14a-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3c14a-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3c14a-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3c14a-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3c14a-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="3c14a-120">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="3c14a-120">XML, XSLT</span></span>
