...
ms.workload:
- dotnet
ms.openlocfilehash: b7e9861aef97210d25895f06a932b466d73363f6
ms.sourcegitcommit: 935d5267c44f9bce801468ef95f44572f1417e8c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/28/2018
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="e6e5d-102">针对 .NET Framework 4.5 到 4.6.2 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="e6e5d-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="e6e5d-103">如果要从 .NET Framework 4.5 迁移到 4.6.2，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="e6e5d-103">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="e6e5d-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="e6e5d-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="e6e5d-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e6e5d-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e6e5d-106">核心</span><span class="sxs-lookup"><span data-stu-id="e6e5d-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e6e5d-107">数据</span><span class="sxs-lookup"><span data-stu-id="e6e5d-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="e6e5d-108">调试器</span><span class="sxs-lookup"><span data-stu-id="e6e5d-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e6e5d-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e6e5d-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="e6e5d-110">全球化</span><span class="sxs-lookup"><span data-stu-id="e6e5d-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="e6e5d-111">网络</span><span class="sxs-lookup"><span data-stu-id="e6e5d-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="e6e5d-112">安全性</span><span class="sxs-lookup"><span data-stu-id="e6e5d-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e6e5d-113">序列化</span><span class="sxs-lookup"><span data-stu-id="e6e5d-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="e6e5d-114">安装和部署</span><span class="sxs-lookup"><span data-stu-id="e6e5d-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="e6e5d-115">工具</span><span class="sxs-lookup"><span data-stu-id="e6e5d-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e6e5d-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e6e5d-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e6e5d-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e6e5d-117">Windows Presentation Foundation (WPF)</span></span>
