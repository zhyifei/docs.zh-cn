---
title: "针对 .NET Framework 4.5 到 4.6.2 迁移的运行时更改"
ms.date: 06/16/2017
...
manager: wpickett
ms.workload: dotnet
ms.openlocfilehash: aa738c2bcc8e403b83cd75b506af7a1840702575
ms.sourcegitcommit: 16186c34a957fdd52e5db7294f291f7530ac9d24
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/22/2017
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="1ed21-102">针对 .NET Framework 4.5 到 4.6.2 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="1ed21-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="1ed21-103">如果要从 .NET Framework 4.5 迁移到 4.6.2，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="1ed21-103">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="1ed21-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="1ed21-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="1ed21-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="1ed21-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="1ed21-106">核心</span><span class="sxs-lookup"><span data-stu-id="1ed21-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="1ed21-107">数据</span><span class="sxs-lookup"><span data-stu-id="1ed21-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="1ed21-108">调试器</span><span class="sxs-lookup"><span data-stu-id="1ed21-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="1ed21-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="1ed21-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="1ed21-110">全球化</span><span class="sxs-lookup"><span data-stu-id="1ed21-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="1ed21-111">网络</span><span class="sxs-lookup"><span data-stu-id="1ed21-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="1ed21-112">安全性</span><span class="sxs-lookup"><span data-stu-id="1ed21-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="1ed21-113">序列化</span><span class="sxs-lookup"><span data-stu-id="1ed21-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="1ed21-114">安装和部署</span><span class="sxs-lookup"><span data-stu-id="1ed21-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="1ed21-115">工具</span><span class="sxs-lookup"><span data-stu-id="1ed21-115">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1ed21-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="1ed21-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="1ed21-117">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="1ed21-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1ed21-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1ed21-118">Windows Presentation Foundation (WPF)</span></span>
