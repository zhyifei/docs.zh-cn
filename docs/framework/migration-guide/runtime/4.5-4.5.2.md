...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="312a9-102">针对 .NET Framework 4.5 到 4.5.2 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="312a9-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="312a9-103">如果要从 .NET Framework 4.5 迁移到 4.5.2，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="312a9-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="312a9-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="312a9-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="312a9-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="312a9-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="312a9-106">核心</span><span class="sxs-lookup"><span data-stu-id="312a9-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="312a9-107">数据</span><span class="sxs-lookup"><span data-stu-id="312a9-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="312a9-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="312a9-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="312a9-109">序列化</span><span class="sxs-lookup"><span data-stu-id="312a9-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="312a9-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="312a9-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="312a9-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="312a9-111">Windows Presentation Foundation (WPF)</span></span>
