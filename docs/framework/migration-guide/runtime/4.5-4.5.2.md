...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a>针对 .NET Framework 4.5 到 4.5.2 迁移的运行时更改

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

如果要从 .NET Framework 4.5 迁移到 4.5.2，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：
