...
author: chlowell
ms.author: ronpet
ms.openlocfilehash: f313a2e510a94815ada4ad1d3684fa1901d05f85
ms.sourcegitcommit: 5b6d778ebb269ee6684fb57ad69a8c28b06235b9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/08/2019
ms.locfileid: "59172726"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="249ef-102">针对 .NET Framework 4.5.1 到 4.6 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="249ef-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="249ef-103">如果要从 .NET Framework 4.5.1 迁移到 4.6，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="249ef-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="249ef-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="249ef-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="249ef-105">核心</span><span class="sxs-lookup"><span data-stu-id="249ef-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="249ef-106">数据</span><span class="sxs-lookup"><span data-stu-id="249ef-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="249ef-107">调试器</span><span class="sxs-lookup"><span data-stu-id="249ef-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="249ef-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="249ef-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="249ef-109">网络</span><span class="sxs-lookup"><span data-stu-id="249ef-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="249ef-110">序列化</span><span class="sxs-lookup"><span data-stu-id="249ef-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="249ef-111">安装和部署</span><span class="sxs-lookup"><span data-stu-id="249ef-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="249ef-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="249ef-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="249ef-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="249ef-113">Windows Presentation Foundation (WPF)</span></span>
