---
title: "从.NET Framework 4.5.1 到 4.6 进行迁移的运行时更改"
ms.date: 06/16/2017
...
ms.assetid: f8d3999b-d13b-43ea-85e2-0e0c3eaa7481
author: conniey
ms.author: ronpet
manager: wpickett
ms.openlocfilehash: 5476bd93838ea29abec7b556b5b432222fbf4035
ms.sourcegitcommit: 32f5e1db8755ed7dfac0b4ec764fa809e5a7548c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2017
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="a53e5-102">从.NET Framework 4.5.1 到 4.6 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="a53e5-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a53e5-103">如果你要迁移从.NET Framework 4.5.1 到 4.6，请查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="a53e5-103">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a53e5-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a53e5-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a53e5-105">核心</span><span class="sxs-lookup"><span data-stu-id="a53e5-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a53e5-106">数据</span><span class="sxs-lookup"><span data-stu-id="a53e5-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a53e5-107">调试器</span><span class="sxs-lookup"><span data-stu-id="a53e5-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a53e5-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a53e5-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="a53e5-109">网络</span><span class="sxs-lookup"><span data-stu-id="a53e5-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a53e5-110">序列化</span><span class="sxs-lookup"><span data-stu-id="a53e5-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a53e5-111">安装和部署</span><span class="sxs-lookup"><span data-stu-id="a53e5-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a53e5-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a53e5-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="a53e5-113">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="a53e5-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a53e5-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a53e5-114">Windows Presentation Foundation (WPF)</span></span>
