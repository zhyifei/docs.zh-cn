...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-451"></a>从.NET Framework 4.0 到 4.5.1 进行迁移的运行时更改

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

如果你要对 4.5.1 迁移从.NET Framework 4.0，请查看可能影响你的应用的应用程序兼容性问题的以下主题：
