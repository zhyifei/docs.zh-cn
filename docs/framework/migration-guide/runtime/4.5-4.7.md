---
title: "从.NET Framework 4.5 到 4.7 进行迁移的运行时更改"
ms.date: 06/16/2017
...
ms.author: ronpet
manager: wpickett
ms.openlocfilehash: c7467bdf62730516a439902f0bd430a2266ce4af
ms.sourcegitcommit: 32f5e1db8755ed7dfac0b4ec764fa809e5a7548c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2017
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="eccbc-102">从.NET Framework 4.5 到 4.7 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="eccbc-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="eccbc-103">如果你要迁移从.NET Framework 4.5 到 4.7，查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="eccbc-103">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="eccbc-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="eccbc-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="eccbc-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="eccbc-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="eccbc-106">核心</span><span class="sxs-lookup"><span data-stu-id="eccbc-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="eccbc-107">数据</span><span class="sxs-lookup"><span data-stu-id="eccbc-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="eccbc-108">调试器</span><span class="sxs-lookup"><span data-stu-id="eccbc-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="eccbc-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="eccbc-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="eccbc-110">全球化</span><span class="sxs-lookup"><span data-stu-id="eccbc-110">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="eccbc-111">JIT</span><span class="sxs-lookup"><span data-stu-id="eccbc-111">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="eccbc-112">网络</span><span class="sxs-lookup"><span data-stu-id="eccbc-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="eccbc-113">安全性</span><span class="sxs-lookup"><span data-stu-id="eccbc-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="eccbc-114">序列化</span><span class="sxs-lookup"><span data-stu-id="eccbc-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="eccbc-115">安装和部署</span><span class="sxs-lookup"><span data-stu-id="eccbc-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="eccbc-116">工具</span><span class="sxs-lookup"><span data-stu-id="eccbc-116">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="eccbc-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="eccbc-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="eccbc-118">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="eccbc-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="eccbc-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="eccbc-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="eccbc-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="eccbc-120">Windows Workflow Foundation (WF)</span></span>
