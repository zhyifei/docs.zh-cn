...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a>针对 .NET Framework 4.5 到 4.7 迁移的运行时更改

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

如果要从 .NET Framework 4.5 迁移到 4.7，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：
