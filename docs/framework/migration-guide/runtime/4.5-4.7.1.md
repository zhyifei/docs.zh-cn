...
author: chlowell
ms.author: ronpet
ms.openlocfilehash: 69bc309477ab03ce24e25805773e4412c904588e
ms.sourcegitcommit: 3d5d33f384eeba41b2dff79d096f47ccc8d8f03d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/04/2018
ms.locfileid: "33389975"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="3e2c9-102">针对 .NET Framework 4.5 到 4.7.1 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="3e2c9-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="3e2c9-103">如果要从 .NET Framework 4.5 迁移到 4.7.1，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="3e2c9-103">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="3e2c9-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="3e2c9-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="3e2c9-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="3e2c9-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="3e2c9-106">核心</span><span class="sxs-lookup"><span data-stu-id="3e2c9-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="3e2c9-107">数据</span><span class="sxs-lookup"><span data-stu-id="3e2c9-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="3e2c9-108">调试器</span><span class="sxs-lookup"><span data-stu-id="3e2c9-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="3e2c9-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="3e2c9-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="3e2c9-110">全球化</span><span class="sxs-lookup"><span data-stu-id="3e2c9-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="3e2c9-111">网络</span><span class="sxs-lookup"><span data-stu-id="3e2c9-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="3e2c9-112">安全性</span><span class="sxs-lookup"><span data-stu-id="3e2c9-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="3e2c9-113">序列化</span><span class="sxs-lookup"><span data-stu-id="3e2c9-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="3e2c9-114">安装和部署</span><span class="sxs-lookup"><span data-stu-id="3e2c9-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="3e2c9-115">工具</span><span class="sxs-lookup"><span data-stu-id="3e2c9-115">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="3e2c9-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="3e2c9-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="3e2c9-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="3e2c9-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="3e2c9-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="3e2c9-118">Windows Workflow Foundation (WF)</span></span>
