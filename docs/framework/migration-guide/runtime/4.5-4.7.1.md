---
title: "从.NET Framework 4.5 到 4.7.1 进行迁移的运行时更改 |Microsoft 文档"
ms.date: 10/09/2017
...
ms.author: ronpet
manager: wpickett
ms.openlocfilehash: 30a715d347beb8642b23968cf62d813e6d4e4f28
ms.sourcegitcommit: 32f5e1db8755ed7dfac0b4ec764fa809e5a7548c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/25/2017
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="ba7da-102">从.NET Framework 4.5 到 4.7.1 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="ba7da-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="ba7da-103">如果你要迁移从.NET Framework 4.5 到 4.7.1，查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="ba7da-103">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="ba7da-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="ba7da-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="ba7da-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="ba7da-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="ba7da-106">核心</span><span class="sxs-lookup"><span data-stu-id="ba7da-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="ba7da-107">数据</span><span class="sxs-lookup"><span data-stu-id="ba7da-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="ba7da-108">调试器</span><span class="sxs-lookup"><span data-stu-id="ba7da-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="ba7da-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="ba7da-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="ba7da-110">全球化</span><span class="sxs-lookup"><span data-stu-id="ba7da-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="ba7da-111">网络</span><span class="sxs-lookup"><span data-stu-id="ba7da-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="ba7da-112">安全性</span><span class="sxs-lookup"><span data-stu-id="ba7da-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="ba7da-113">序列化</span><span class="sxs-lookup"><span data-stu-id="ba7da-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="ba7da-114">安装和部署</span><span class="sxs-lookup"><span data-stu-id="ba7da-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="ba7da-115">工具</span><span class="sxs-lookup"><span data-stu-id="ba7da-115">Tools</span></span>

[!include[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="ba7da-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="ba7da-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="ba7da-117">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="ba7da-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="ba7da-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="ba7da-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="ba7da-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="ba7da-119">Windows Workflow Foundation (WF)</span></span>
