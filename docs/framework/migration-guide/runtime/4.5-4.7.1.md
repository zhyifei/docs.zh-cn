---
title: 针对 .NET Framework 4.5 到 4.7.1 迁移的运行时更改
ms.date: 04/05/2018
ms.assetid: d95b719a-836c-4510-b964-bd788048c04b
author: chlowell
ms.author: ronpet
ms.openlocfilehash: ab3d3e3d9abb924142cec4ab5751827000066857
ms.sourcegitcommit: 9e18e4a18284ae9e54c515e30d019c0bbff9cd37
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/28/2018
ms.locfileid: "37070832"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-471"></a><span data-ttu-id="2be0e-102">针对 .NET Framework 4.5 到 4.7.1 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="2be0e-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="2be0e-103">如果要从 .NET Framework 4.5 迁移到 4.7.1，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="2be0e-103">If you are migrating from the .NET Framework 4.5 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="2be0e-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="2be0e-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="2be0e-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="2be0e-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="2be0e-106">核心</span><span class="sxs-lookup"><span data-stu-id="2be0e-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="2be0e-107">数据</span><span class="sxs-lookup"><span data-stu-id="2be0e-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="2be0e-108">调试器</span><span class="sxs-lookup"><span data-stu-id="2be0e-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="2be0e-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="2be0e-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="2be0e-110">全球化</span><span class="sxs-lookup"><span data-stu-id="2be0e-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="2be0e-111">网络</span><span class="sxs-lookup"><span data-stu-id="2be0e-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="2be0e-112">安全性</span><span class="sxs-lookup"><span data-stu-id="2be0e-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="2be0e-113">序列化</span><span class="sxs-lookup"><span data-stu-id="2be0e-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="2be0e-114">安装和部署</span><span class="sxs-lookup"><span data-stu-id="2be0e-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="2be0e-115">工具</span><span class="sxs-lookup"><span data-stu-id="2be0e-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="2be0e-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="2be0e-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2be0e-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2be0e-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="2be0e-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="2be0e-118">Windows Workflow Foundation (WF)</span></span>
