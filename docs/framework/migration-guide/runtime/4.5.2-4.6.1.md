...
author: chlowell
ms.author: ronpet
ms.openlocfilehash: 38064ae115efb69bd665db2b1a2422fa4ce0675d
ms.sourcegitcommit: c7f3e2e9d6ead6cc3acd0d66b10a251d0c66e59d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 09/09/2018
ms.locfileid: "44204638"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="a3829-102">针对 .NET Framework 4.5.2 到 4.6.1 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="a3829-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="a3829-103">如果要从 .NET Framework 4.5.2 迁移到 4.6.1，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="a3829-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="a3829-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a3829-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a3829-105">核心</span><span class="sxs-lookup"><span data-stu-id="a3829-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a3829-106">数据</span><span class="sxs-lookup"><span data-stu-id="a3829-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="a3829-107">调试器</span><span class="sxs-lookup"><span data-stu-id="a3829-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="a3829-108">网络</span><span class="sxs-lookup"><span data-stu-id="a3829-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a3829-109">序列化</span><span class="sxs-lookup"><span data-stu-id="a3829-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a3829-110">安装和部署</span><span class="sxs-lookup"><span data-stu-id="a3829-110">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a3829-111">工具</span><span class="sxs-lookup"><span data-stu-id="a3829-111">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a3829-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a3829-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a3829-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a3829-113">Windows Presentation Foundation (WPF)</span></span>
