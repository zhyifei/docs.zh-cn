...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-462"></a>针对 .NET Framework 4.5.1 到 4.6.2 迁移的运行时更改

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

如果要从 .NET Framework 4.5.1 迁移到 4.6.2，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：
