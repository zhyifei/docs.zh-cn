...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-46"></a>针对 .NET Framework 4.0 到 4.6 迁移的运行时更改

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

如果要从 .NET Framework 4.0 迁移到 4.6，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：
