---
title: 针对 .NET Framework 4.0 到 4.6 迁移的运行时更改
ms.date: 04/05/2018
ms.assetid: b572de9e-415f-4720-b890-2b52c464e370
author: chlowell
ms.author: ronpet
ms.openlocfilehash: a802b91f6f08e2a028c36f758c92d8bdb9769453
ms.sourcegitcommit: 5b6d778ebb269ee6684fb57ad69a8c28b06235b9
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/08/2019
ms.locfileid: "59138146"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-46"></a><span data-ttu-id="85966-102">针对 .NET Framework 4.0 到 4.6 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="85966-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="85966-103">如果要从 .NET Framework 4.0 迁移到 4.6，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="85966-103">If you are migrating from the .NET Framework 4.0 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="85966-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="85966-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="85966-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="85966-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="85966-106">核心</span><span class="sxs-lookup"><span data-stu-id="85966-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="85966-107">数据</span><span class="sxs-lookup"><span data-stu-id="85966-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="85966-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="85966-108">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="85966-109">LINQ</span><span class="sxs-lookup"><span data-stu-id="85966-109">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="85966-110">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="85966-110">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="85966-111">网络</span><span class="sxs-lookup"><span data-stu-id="85966-111">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="85966-112">打印</span><span class="sxs-lookup"><span data-stu-id="85966-112">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="85966-113">序列化</span><span class="sxs-lookup"><span data-stu-id="85966-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="85966-114">安装和部署</span><span class="sxs-lookup"><span data-stu-id="85966-114">Setup and Deployment</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="85966-115">Web 应用程序</span><span class="sxs-lookup"><span data-stu-id="85966-115">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="85966-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="85966-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="85966-117">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="85966-117">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="85966-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="85966-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="85966-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="85966-119">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="85966-120">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="85966-120">XML, XSLT</span></span>
