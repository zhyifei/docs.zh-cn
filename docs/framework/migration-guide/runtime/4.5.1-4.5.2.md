...
ms.workload:
- dotnet
ms.openlocfilehash: 0a9479f63fb33bf03c0c7498e81131a48739b5a7
ms.sourcegitcommit: 935d5267c44f9bce801468ef95f44572f1417e8c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/28/2018
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="d74c7-102">针对 .NET Framework 4.5.1 到 4.5.2 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="d74c7-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="d74c7-103">如果要从 .NET Framework 4.5.1 迁移到 4.5.2，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="d74c7-103">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="d74c7-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d74c7-104">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="d74c7-105">数据</span><span class="sxs-lookup"><span data-stu-id="d74c7-105">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="d74c7-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="d74c7-106">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="d74c7-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="d74c7-107">Windows Presentation Foundation (WPF)</span></span>
