---
title: "从.NET Framework 4.6.1 到 4.7 进行迁移的运行时更改"
ms.date: 06/16/2017
...
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="9db78-102">从.NET Framework 4.6.1 到 4.7 进行迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="9db78-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!include[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="9db78-103">如果你要从.NET Framework 4.6.1 到 4.7 迁移，请查看可能影响你的应用的应用程序兼容性问题的以下主题：</span><span class="sxs-lookup"><span data-stu-id="9db78-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="9db78-104">核心</span><span class="sxs-lookup"><span data-stu-id="9db78-104">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="9db78-105">数据</span><span class="sxs-lookup"><span data-stu-id="9db78-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="9db78-106">全球化</span><span class="sxs-lookup"><span data-stu-id="9db78-106">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="9db78-107">JIT</span><span class="sxs-lookup"><span data-stu-id="9db78-107">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="9db78-108">安全性</span><span class="sxs-lookup"><span data-stu-id="9db78-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9db78-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9db78-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9db78-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9db78-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="9db78-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="9db78-111">Windows Workflow Foundation (WF)</span></span>
