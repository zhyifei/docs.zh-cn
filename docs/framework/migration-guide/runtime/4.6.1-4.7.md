...
ms.locfileid: "59224242"
---
# <a name="runtime-changes-for-migration-from-net-framework-461-to-47"></a><span data-ttu-id="da235-102">针对 .NET Framework 4.6.1 到 4.7 迁移的运行时更改</span><span class="sxs-lookup"><span data-stu-id="da235-102">Runtime Changes for Migration from .NET Framework 4.6.1 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="da235-103">如果要从 .NET Framework 4.6.1 迁移到 4.7，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="da235-103">If you are migrating from the .NET Framework 4.6.1 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="da235-104">数据</span><span class="sxs-lookup"><span data-stu-id="da235-104">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="da235-105">全球化</span><span class="sxs-lookup"><span data-stu-id="da235-105">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="da235-106">JIT</span><span class="sxs-lookup"><span data-stu-id="da235-106">JIT</span></span>
...
## <a name="security"></a><span data-ttu-id="da235-107">安全性</span><span class="sxs-lookup"><span data-stu-id="da235-107">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="da235-108">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="da235-108">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="da235-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="da235-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="da235-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="da235-110">Windows Workflow Foundation (WF)</span></span>
