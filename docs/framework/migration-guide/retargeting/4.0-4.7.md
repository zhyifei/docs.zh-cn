...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-47"></a>针对 .NET Framework 4.0 到 4.7 迁移的重定向更改

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

如果要从 .NET Framework 4.0 迁移到 4.7，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：
