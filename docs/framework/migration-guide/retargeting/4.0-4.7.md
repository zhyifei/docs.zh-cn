...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-47"></a>从.NET Framework 4.0 到 4.7 进行迁移的重定目标更改

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

如果你要从迁移.NET Framework 4.0 到 4.7，查看可能影响你的应用的应用程序兼容性问题的以下主题：
