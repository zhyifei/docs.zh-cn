...
manager: wpickett
ms.workload: dotnet
ms.openlocfilehash: d20c10ce741da8517d729bcc20ff790c96ce5c52
ms.sourcegitcommit: 16186c34a957fdd52e5db7294f291f7530ac9d24
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/22/2017
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="e366a-102">针对 .NET Framework 4.5.2 到 4.6.1 迁移的重定向更改</span><span class="sxs-lookup"><span data-stu-id="e366a-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="e366a-103">如果要从 .NET Framework 4.5.2 迁移到 4.6.1，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="e366a-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="e366a-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e366a-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="e366a-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="e366a-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="e366a-106">核心</span><span class="sxs-lookup"><span data-stu-id="e366a-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e366a-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e366a-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="e366a-108">JIT</span><span class="sxs-lookup"><span data-stu-id="e366a-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="e366a-109">网络</span><span class="sxs-lookup"><span data-stu-id="e366a-109">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e366a-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e366a-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="e366a-111">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="e366a-111">Windows Forms</span></span>

[!include[Application.FilterMessage no longer throws for re-entrant implementations of IMessageFilter.PreFilterMessage](~/includes/migration-guide/retargeting/winforms/applicationfiltermessage-no-longer-throws-for-re-entrant-implementations.md)]

## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e366a-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e366a-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="e366a-113">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="e366a-113">XML, XSLT</span></span>
