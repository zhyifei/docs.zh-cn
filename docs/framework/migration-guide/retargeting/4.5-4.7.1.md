...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-471"></a>针对 .NET Framework 4.5 到 4.7.1 迁移的重定向更改

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

如果要从 .NET Framework 4.5 迁移到 4.7.1，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：
