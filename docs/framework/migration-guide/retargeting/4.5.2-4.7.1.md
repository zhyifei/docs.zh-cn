...
ms.workload:
- dotnet
ms.openlocfilehash: 0891e96ec83ba60660abbece3969e593c6a83b53
ms.sourcegitcommit: 935d5267c44f9bce801468ef95f44572f1417e8c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/28/2018
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="c2fbc-102">针对 .NET Framework 4.5.2 到 4.7.1 迁移的重定向更改</span><span class="sxs-lookup"><span data-stu-id="c2fbc-102">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="c2fbc-103">如果要从 .NET Framework 4.5.2 迁移到 4.7.1，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="c2fbc-103">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c2fbc-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c2fbc-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="c2fbc-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="c2fbc-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="c2fbc-106">核心</span><span class="sxs-lookup"><span data-stu-id="c2fbc-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="c2fbc-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="c2fbc-107">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="c2fbc-108">JIT</span><span class="sxs-lookup"><span data-stu-id="c2fbc-108">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="c2fbc-109">网络</span><span class="sxs-lookup"><span data-stu-id="c2fbc-109">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c2fbc-110">安全性</span><span class="sxs-lookup"><span data-stu-id="c2fbc-110">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c2fbc-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c2fbc-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="c2fbc-112">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="c2fbc-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c2fbc-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c2fbc-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c2fbc-114">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c2fbc-114">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="c2fbc-115">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="c2fbc-115">XML, XSLT</span></span>
