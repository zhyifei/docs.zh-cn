---
title: "针对 .NET Framework 4.0 到 4.7.1 迁移的重定向更改 | Microsoft 文档"
ms.date: 10/09/2017
...
manager: wpickett
ms.workload: dotnet
ms.openlocfilehash: d489f0bf606c5f961e3ee7c443b53711cb951fcc
ms.sourcegitcommit: 16186c34a957fdd52e5db7294f291f7530ac9d24
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/22/2017
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-471"></a><span data-ttu-id="1d9ef-102">针对 .NET Framework 4.0 到 4.7.1 迁移的重定向更改</span><span class="sxs-lookup"><span data-stu-id="1d9ef-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.7.1</span></span>

[!include[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!include[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="1d9ef-103">如果要从 .NET Framework 4.0 迁移到 4.7.1，请在以下主题中查看可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="1d9ef-103">If you are migrating from the .NET Framework 4.0 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="1d9ef-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="1d9ef-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="1d9ef-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="1d9ef-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="1d9ef-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="1d9ef-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="1d9ef-107">核心</span><span class="sxs-lookup"><span data-stu-id="1d9ef-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="1d9ef-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="1d9ef-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="1d9ef-109">JIT</span><span class="sxs-lookup"><span data-stu-id="1d9ef-109">JIT</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="1d9ef-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="1d9ef-110">MSBuild</span></span>
...
## <a name="networking"></a><span data-ttu-id="1d9ef-111">网络</span><span class="sxs-lookup"><span data-stu-id="1d9ef-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="1d9ef-112">安全性</span><span class="sxs-lookup"><span data-stu-id="1d9ef-112">Security</span></span>
...
## <a name="visual-basic-net"></a><span data-ttu-id="1d9ef-113">Visual Basic .NET</span><span class="sxs-lookup"><span data-stu-id="1d9ef-113">Visual Basic .NET</span></span>

[!include[VB.NET no longer supports partial namespace qualification for System.Windows APIs](~/includes/migration-guide/retargeting/vb/vbnet-no-longer-supports-partial-namespace-qualification-for-systemwindows.md)]

## <a name="wpf"></a><span data-ttu-id="1d9ef-114">WPF</span><span class="sxs-lookup"><span data-stu-id="1d9ef-114">WPF</span></span>

[!include[Accessibility improvements in WPF](~/includes/migration-guide/retargeting/wpf/accessibility-improvements-wpf.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="1d9ef-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="1d9ef-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="1d9ef-116">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="1d9ef-116">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="1d9ef-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="1d9ef-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="1d9ef-118">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="1d9ef-118">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="1d9ef-119">XML、XSLT</span><span class="sxs-lookup"><span data-stu-id="1d9ef-119">XML, XSLT</span></span>
