...
ms.locfileid: "59230689"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-472"></a><span data-ttu-id="52e90-102">针对 .NET Framework 4.7.1 到 4.7.2 迁移的重定向更改</span><span class="sxs-lookup"><span data-stu-id="52e90-102">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/retargeting/introduction.md)]

<span data-ttu-id="52e90-103">如果要从 .NET Framework 4.7.1 迁移到 4.7.2，请查看以下主题，了解可能影响你的应用的应用程序兼容性问题：</span><span class="sxs-lookup"><span data-stu-id="52e90-103">If you are migrating from the .NET Framework 4.7.1 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="52e90-104">核心</span><span class="sxs-lookup"><span data-stu-id="52e90-104">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="52e90-105">Windows 窗体</span><span class="sxs-lookup"><span data-stu-id="52e90-105">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="52e90-106">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="52e90-106">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="52e90-107">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="52e90-107">Windows Workflow Foundation (WF)</span></span>
