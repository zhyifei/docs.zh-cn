...
|功能|更改|影响|范围|  
|--------|--------|--------|--------|  
|[页面元素](http://msdn.microsoft.com/zh-cn/4123bb66-3fe4-4d62-b70e-33758656b458)的 `enableViewStateMac` 特性|ASP.NET 不再允许开发人员指定：<br /><br /> `<pages enableViewStateMac="false" />`<br /><br /> 或：<br /><br /> `<@Page EnableViewStateMac="false" %>`|现在，针对所有带嵌入视图状态的请求强制执行视图状态消息身份验证代码 \(MAC\)。 仅影响将 <xref:System.Web.UI.Page.EnableViewStateMac%2A> 属性显式设置为 `false` 的应用。<br /><br /> 有关详细信息，请参见[解决视图状态消息身份验证代码 \(MAC\) 错误](http://support.microsoft.com/kb/2915218)。|主要|  
  
<a name="EF"></a>   
## Entity Framework 运行时更改  
