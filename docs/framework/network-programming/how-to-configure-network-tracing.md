...
### <a name="to-configure-network-tracing"></a><span data-ttu-id="f798b-109">配置网络跟踪</span><span class="sxs-lookup"><span data-stu-id="f798b-109">To configure network tracing</span></span>  
