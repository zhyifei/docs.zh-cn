...
10. 在标识的程序集和代码生成器的版本的文件的顶部插入注释：`// This code was auto-generated by Microsoft.VisualStudio.Portable.AddServiceReference, version 1.0.0.0`  
...
14. <xref:System.ServiceModel.MessageContractAttribute.IsWrapped%2A> 不支持可移植子集项目中。  
