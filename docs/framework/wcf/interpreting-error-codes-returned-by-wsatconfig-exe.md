---
title: "解释 wsatConfig.exe 返回的错误代码 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|31|`-traceLevel` 命令行选项无效。|更正 `-traceLevel` 命令行选项以指定以下其中一个有效值，<br /><br /> -   Off<br />-   Error<br />-   Critical<br />-   警告<br />-   信息<br />-   Verbose<br />-   全部|  
