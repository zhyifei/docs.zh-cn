...
若要使用户更轻松地编写您的 WCF 服务的客户端应用程序，可以添加[ \<serviceDebug >](../../../../../docs/framework/configure-apps/file-schema/wcf/servicedebug.md)服务到服务的配置文件的行为。 此行为可用于发布帮助页，以及在返回到客户端的 SOAP 错误的详细信息中返回托管异常信息。
