---
title: "关于异常的参考信息 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
本节列出了 [!INCLUDE[indigo1](../../../../../includes/indigo1-md.md)] 生成的以下领域的所有异常：  
 ...
 [核心通信：HTTP\/HTTPS 传输通道](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/core-communications-http-https-transport-channels.md)  
 ...
 [承载](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/hosting-exceptions.md)  
  
 [对等通道](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/peer-channel.md)  
  
 [MSMQ 集成传输](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/msmq-integration-transport.md)  
  
 [MSMQ 传输](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/msmq-transport.md)  
  
 [可靠消息传递](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/reliable-messaging.md)  
  
 [安全异常](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/security-exceptions.md)  
  
 [服务框架](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework.md)  
  
 [服务框架数据](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/service-framework-data.md)  
  
 [事务格式化程序](../../../../../docs/framework/wcf/diagnostics/exceptions-reference/transaction-formatter.md)  
