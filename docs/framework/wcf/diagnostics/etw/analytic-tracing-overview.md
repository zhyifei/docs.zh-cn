...
### <a name="channels"></a>信道  
 ...
 中的 WCF 的分析跟踪功能[!INCLUDE[netfx_current_short](../../../../../includes/netfx-current-short-md.md)]写入到 Microsoft Windows 的应用程序的服务器-应用程序通道。 此通道专门设计的用户想要监视在生产环境中的 WCF 服务的运行状况。 它定义了一组少量事件，可用于多种运行状况监视和疑难解答情况。  
