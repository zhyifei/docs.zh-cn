...
```  
 ...
 通过使用 [ServiceModel 元数据实用工具 \(Svcutil.exe\)](../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md) 并使其指向正在运行的发布元数据的服务，可以自动生成 [!INCLUDE[indigo2](../../../includes/indigo2-md.md)] 客户端。  
