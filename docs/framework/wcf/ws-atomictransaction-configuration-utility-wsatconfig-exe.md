...
|选项|描述|  
|-------------|-----------------|  
|-accounts： \<account，>|指定可参与 WS-AtomicTransaction 的帐户的逗号分隔列表。 不会检查这些帐户的有效性。|  
...
|-network： \<enable&#124;禁用 >|启用或禁用 WS-AtomicTransaction 网络支持。|  
...
|-traceActivity： \<enable&#124;禁用 >|启用或禁用对活动事件的跟踪。|  
|-traceLevel： \<Off&#124;错误&#124;严重&#124;警告&#124;信息&#124; &#124;所有 >}|指定跟踪级别。|  
|-tracePII： \<enable&#124;禁用 >|启用或禁用对个人身份信息的跟踪。|  
|-traceProp： \<enable&#124;禁用 >|启用或禁用对传播事件的跟踪。|  
