...
|-endpointCert： < 机&#124;\<拇指 >&#124;"Issuer\SubjectName" >|使用由指纹或“颁发者\主题名称”对指定的计算机证书或另一个本地终结点证书。 如果主题名称为空，请为其使用 {EMPTY}。|  
|-maxTimeout：\<秒 >|以秒为单位指定最大超时。 有效值为0至3600。|  
