...
>   
>  `<安装驱动器>:\WF_WCF_Samples\WCF\Basic\Binding\Net\MSMQ\Session`  
 ...
 此服务协定是 `IOrderTaker`，它定义了适合与队列一起使用的单向服务。在以下示例代码中显示的协定中使用的 <xref:System.ServiceModel.SessionMode> 表明消息是会话的一部分。  
