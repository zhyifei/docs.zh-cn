...
## <a name="demonstrates"></a>演示  
 若要运行示例，请生成客户端和服务器项目。 然后打开两个命令窗口, 并将目录更改\<为示例 > \CS\Service\bin\debug \<和 > \CS\Client\bin\debug 目录的示例。 然后, 键入`service.exe` , 然后调用该客户端, 并将其初始值作为输入参数传递。 显示了 10 次滴答的示例输出。  
