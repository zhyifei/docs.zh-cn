...
## <a name="in-this-section"></a>本节内容  
 ...
 演示如何扩展[传输： UDP](../../../../docs/framework/wcf/samples/transport-udp.md)示例，用于使用 Windows 进程激活服务 (WAS) 支持进程激活。  
  
 [传输：通过 UDP 自定义事务](../../../../docs/framework/wcf/samples/transport-custom-transactions-over-udp-sample.md)  
