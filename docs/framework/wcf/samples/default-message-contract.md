...
### <a name="to-set-up-build-and-run-the-sample"></a><span data-ttu-id="1ae92-127">设置、生成和运行示例</span><span class="sxs-lookup"><span data-stu-id="1ae92-127">To set up, build, and run the sample</span></span>  
