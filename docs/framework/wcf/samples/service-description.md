...
服务说明示例演示服务如何在运行时检索其服务说明信息。 该示例基于["入门"，](../../../../docs/framework/wcf/samples/getting-started-sample.md)定义了附加服务操作以返回有关服务的描述性信息。 返回的信息列出了服务的基址和终结点。 服务使用 <xref:System.ServiceModel.OperationContext>、<xref:System.ServiceModel.ServiceHost> 和 <xref:System.ServiceModel.Description.ServiceDescription> 类提供此信息。  
