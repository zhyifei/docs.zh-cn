...
```  
 ...
 客户端实现也使用复数。 在生成的源代码文件 generatedclient.cs 中定义服务协定和数据协定[ServiceModel Metadata Utility Tool (Svcutil.exe)](../../../../docs/framework/wcf/servicemodel-metadata-utility-tool-svcutil-exe.md)从服务元数据。  
