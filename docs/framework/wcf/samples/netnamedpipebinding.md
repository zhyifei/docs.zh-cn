...
> 本主题的最后介绍了此示例的设置过程和生成说明。  
 ...
 绑定是在客户端和服务的配置文件中指定的。 绑定类型在[\<终结点 >](../../configure-apps/file-schema/wcf/endpoint-element.md)的 `binding` 属性或[> 客户端 \<元素的\<终结点 >](../../configure-apps/file-schema/wcf/endpoint-of-client.md)中指定，如以下示例配置所示：  
