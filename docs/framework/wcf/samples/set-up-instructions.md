...
这组主题描述如何设置运行 Windows Communication Foundation (WCF) 服务所需的服务。  
...
## <a name="in-this-section"></a>本节内容  
 ...
 概述设置 Windows 防火墙以允许 WCF 服务正常工作所需的步骤。  
 ...
 概述用于在同一计算机上和跨计算机运行 WCF 示例的步骤。  
  
 [启用对等服务](http://msdn.microsoft.com/library/e7a0fcf4-b0e5-4b26-a7e3-f0f37b60a1f9)  
