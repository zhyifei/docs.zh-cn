...
```  
 ...
 还可以使用[配置编辑器工具（svcconfigeditor.exe）](../../../../docs/framework/wcf/configuration-editor-tool-svcconfigeditor-exe.md)来完成此任务。  
...
1. 通过依次单击 "**开始**"、"**运行 ...** `perfmon`"、 **"确定**"，或从 "控制面板" 中选择 "**管理工具**"，然后双击 "**性能**"，启动性能监视器工具。  
