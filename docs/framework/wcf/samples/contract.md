...
---
# 协定
本节包含演示 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 中协定的示例。  
...
## 本节内容  
 ...
 [使用 DataContractSerializer 和 DataContractResolver 实现 NetDataContractSerializer 的功能](../../../../docs/framework/wcf/samples/datacontractserializer-datacontractresolver-netdatacontractserializer.md)  
