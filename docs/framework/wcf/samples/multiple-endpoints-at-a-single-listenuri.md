---
title: "在单个 ListenUri 中承载多个终结点 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
>  本主题的末尾介绍了此示例的设置过程和生成说明。  
 ...
 如[多终结点](../../../../docs/framework/wcf/samples/multiple-endpoints.md)示例中所述，一个服务可以承载多个终结点，每个终结点都有不同的地址，而且可能还具有不同的绑定。此示例演示了可以在同一个地址承载多个终结点，还演示了服务终结点所具有的两种地址（`EndpointAddress` 和 `ListenUri`）之间的区别。  
...
>   
>  `<安装驱动器>:\WF_WCF_Samples\WCF\Basic\Services\MultipleEndpointsSingleUri`  
