...
## <a name="in-this-section"></a>本节内容  
 ...
 [如何：序列化和反序列化 JSON 数据](../../../../docs/framework/wcf/feature-details/how-to-serialize-and-deserialize-json-data.md)  
 ...
 介绍 JavaScript 对象表示法 (JSON) 编码和 XML infoset，用于在内部由 Windows Communication Foundation (WCF) 表示 JSON 编码数据和文档的对应关系。  
