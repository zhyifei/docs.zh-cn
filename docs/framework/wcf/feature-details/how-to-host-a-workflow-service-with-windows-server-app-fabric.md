...
1.  打开[!INCLUDE[vs_current_long](../../../../includes/vs-current-long-md.md)]和负载中创建的 OrderProcessing 解决方案[创建一个长时间运行的工作流服务](../../../../docs/framework/wcf/feature-details/creating-a-long-running-workflow-service.md)主题。  
