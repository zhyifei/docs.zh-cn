...
服务的元数据中可能包含恶意用户可以利用的关于您的应用程序的敏感信息。 服务使用者可能还要求一种用于获取关于服务的元数据的安全机制。 因此，有时需要使用安全终结点来发布元数据。  
 ...
 通常使用在用于保护应用程序终结点的 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 中定义的标准安全机制来保护元数据终结点。 ([!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [安全概述](../../../../docs/framework/wcf/feature-details/security-overview.md)。)  
