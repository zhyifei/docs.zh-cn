...
必须拥有必需的证书才能建立信任。 若要了解如何在执行以下步骤之前创建和安装新证书，请参阅[如何：在开发过程中在 WCF 中创建和安装临时客户端证书](https://go.microsoft.com/fwlink/?LinkId=158925)。
...
3. 右键单击右窗格中的 `ServiceModelDiagnosticTracing` 值，然后选择 "**修改**"。
