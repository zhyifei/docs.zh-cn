---
title: "如何：创建安全令牌服务 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
-   或者，用于标识要用来对断言进行签名的密钥的 <xref:System.IdentityModel.Tokens.SecurityKeyIdentifier>。  
 ...
 然后此 <xref:System.IdentityModel.Tokens.SecurityKeyIdentifier> 用于创建一个作为 `SamlToken` 一部分的 `SamlSubject`。  
  
 [!code-csharp[c_CreateSTS#4](../../../../samples/snippets/csharp/VS_Snippets_CFX/c_creatests/cs/source.cs#4)]
 [!code-vb[c_CreateSTS#4](../../../../samples/snippets/visualbasic/VS_Snippets_CFX/c_creatests/vb/source.vb#4)]  
  
 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)] [联合示例](../../../../docs/framework/wcf/samples/federation-sample.md).  
  
## 创建响应消息  
 一旦安全令牌服务处理颁发请求并构造要随校验密钥一起颁发的令牌，就需要构造响应消息，其中至少包括请求的令牌、证明令牌和颁发的令牌引用。此颁发的令牌通常是从 <xref:System.IdentityModel.Tokens.SamlAssertion> 中创建的 <xref:System.IdentityModel.Tokens.SamlSecurityToken>，如以下示例所示。  
 ...
 [!INCLUDE[crabout](../../../../includes/crabout-md.md)]当客户端和安全令牌服务同时为共享密钥提供密钥材料时如何构造证明令牌的更多信息，请参见[联合示例](../../../../docs/framework/wcf/samples/federation-sample.md)。  
...
## 示例  
 有关安全令牌服务的完整代码，请参见[联合示例](../../../../docs/framework/wcf/samples/federation-sample.md)。  
