...
```  
 ...
 此示例将加载路由所需的模块和处理程序。 [!INCLUDE[crdefault](../../../../includes/crdefault-md.md)][路由](../../../../docs/framework/wcf/feature-details/routing.md)。 另外，还必须在 `aspNetCompatibilityEnabled` 元素中将 `true` 特性设置为 `<serviceHostingEnvironment>`，如下面的示例所示。  
