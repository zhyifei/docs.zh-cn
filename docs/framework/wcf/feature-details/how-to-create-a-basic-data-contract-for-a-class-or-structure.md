...
本主题演示使用类或结构创建数据协定的基本步骤。 有关数据协定及其使用方式的详细信息, 请参阅[使用数据协定](../../../../docs/framework/wcf/feature-details/using-data-contracts.md)。  
  
 有关演练创建基本 Windows Communication Foundation (WCF) 服务和客户端的步骤的教程, 请参阅[入门教程](../../../../docs/framework/wcf/getting-started-tutorial.md)。 对于包含基本服务和客户端的工作示例应用程序, 请参阅[基本数据协定](../../../../docs/framework/wcf/samples/basic-data-contract.md)。  
