...
## <a name="in-this-section"></a>本节内容  
 ...
 介绍 WCF 以及如何选择正确的模式为你的应用程序的实例和会话模式。  
 ...
 介绍如何使用 WCF 来扩展你现有的逻辑，而不是无需重写它如果 COM + 中承载的基于组件的应用程序逻辑有大量的投资。  
 ...
 描述可以很容易公开从 WCF 服务的联合源的支持。  
  
 [AJAX 集成和 JSON 支持](../../../../docs/framework/wcf/feature-details/ajax-integration-and-json-support.md)  
 描述对 ASP.NET 异步 JavaScript 和 XML (AJAX) 和 JavaScript 对象表示法 (JSON) 数据格式以允许 WCF 服务公开到 AJAX 客户端操作的支持。  
