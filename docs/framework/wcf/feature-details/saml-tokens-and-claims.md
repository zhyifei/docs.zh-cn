...
## <a name="from-claims-to-samlattributes"></a>从 Claim 到 SamlAttribute  
 在 WCF 中, SAML 令牌中的语句作为<xref:System.IdentityModel.Tokens.SamlAttribute>对象<xref:System.IdentityModel.Claims.Claim>进行建模, <xref:System.IdentityModel.Claims.Claim.Right%2A>前提<xref:System.IdentityModel.Claims.Claim>是对象具有属性<xref:System.IdentityModel.Claims.Rights.PossessProperty%2A>且<xref:System.IdentityModel.Claims.Claim.Resource%2A>属性为键入<xref:System.String>。 例如：  
