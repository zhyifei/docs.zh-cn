...
> [!NOTE]
> 支持凭据的规范是 WS-SecurityPolicy 规范的一部分。 有关详细信息, 请参阅[Web Services 安全性规范](https://go.microsoft.com/fwlink/?LinkId=88537)。  
...
## <a name="programming-supporting-credentials"></a>对支持凭据进行编程  
 若要创建使用支持令牌的服务, 必须创建一个[ \<customBinding >](../../../../docs/framework/configure-apps/file-schema/wcf/custombinding.md)。 (有关详细信息, 请[参阅如何:使用 SecurityBindingElement](../../../../docs/framework/wcf/feature-details/how-to-create-a-custom-binding-using-the-securitybindingelement.md)创建自定义绑定。)  
