...
#### [支持的数据协定序列化程序类型](types-supported-by-the-data-contract-serializer.md)
##### [数据协定中的集合类型](collection-types-in-data-contracts.md)
##### [XML 和 ADO.NET 数据协定中的类型](xml-and-ado-net-types-in-data-contracts.md)
...
##### [控制序列化和反序列化使用 SerializationBinder](controlling-serialization-and-deserialization-with-serializationbinder.md)
#### [使用数据协定解析程序](using-a-data-contract-resolver.md)
### [使用 XmlSerializer 类](using-the-xmlserializer-class.md)
#### [如何： 改善启动时间的 WCF 客户端应用程序使用 XmlSerializer](startup-time-of-wcf-client-applications-using-the-xmlserializer.md)
### [使用消息协定](using-message-contracts.md)
### [创建自定义标头进行签名和-或加密](creating-a-custom-header-that-is-signed-and-or-encrypted.md)
### [使用 Message 类](using-the-message-class.md)
### [筛选](filtering.md)
### [大型数据和流式处理](large-data-and-streaming.md)
#### [如何： 启用流式处理](how-to-enable-streaming.md)
### [有关数据的安全注意事项](security-considerations-for-data.md)
### [数据传输体系结构概述](data-transfer-architectural-overview.md)
## [会话，实例化和并发](sessions-instancing-and-concurrency.md)
### [如何： 创建的服务，需要使用会话](how-to-create-a-service-that-requires-sessions.md)
### [如何： 控制服务实例化](how-to-control-service-instancing.md)
### [单并发模式中排序消息的处理](ordered-processing-of-messages-in-single-concurrency-mode.md)
## [传输](transports.md)
...
#### [使用匿名客户端的消息安全](message-security-with-an-anonymous-client.md)
...
##### [如何： 使用 X.509 证书来保护服务](how-to-secure-a-service-with-an-x-509-certificate.md)
...
#### [管理声明和使用标识模型的授权](managing-claims-and-authorization-with-the-identity-model.md)
...
### [联合身份验证和已颁发的令牌](federation-and-issued-tokens.md)
#### [联合身份验证](federation.md)
#### [联合身份验证和信任](federation-and-trust.md)
...
### [扩展的保护身份验证概述](extended-protection-for-authentication-overview.md)
#### [扩展的保护身份验证示例自述文件](readme-for-extended-protection-authentication-sample.md)
...
##### [Custompeerresolverservice： 客户端注册](inside-the-custompeerresolverservice-client-registrations.md)
...
#### [如何： 访问服务使用单向和请求-答复协定](how-to-access-wcf-services-with-one-way-and-request-reply-contracts.md)
...
### [.NET 远程处理应用程序迁移到 WCF](migrating-net-remoting-applications-to-wcf.md)
