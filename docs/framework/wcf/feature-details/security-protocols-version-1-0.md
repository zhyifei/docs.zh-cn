...
|<span data-ttu-id="4e57e-127">WS-SecurityPolicy 1.1</span><span class="sxs-lookup"><span data-stu-id="4e57e-127">WS-SecurityPolicy 1.1</span></span><br /><br /> <span data-ttu-id="4e57e-128">(2005/07)</span><span class="sxs-lookup"><span data-stu-id="4e57e-128">(2005/07)</span></span>|<http://specs.xmlsoap.org/ws/2005/07/securitypolicy/ws-securitypolicy.pdf><br /><br /> <span data-ttu-id="4e57e-129">如了修正[勘误表](https://lists.oasis-open.org/archives/ws-sx/200512/msg00017.html)提交到 OASIS WS-SX 技术委员会</span><span class="sxs-lookup"><span data-stu-id="4e57e-129">as amended by [errata](https://lists.oasis-open.org/archives/ws-sx/200512/msg00017.html) submitted to OASIS WS-SX Technical Committee</span></span> |  
...
|<span data-ttu-id="4e57e-167">MutualCertificate</span><span class="sxs-lookup"><span data-stu-id="4e57e-167">MutualCertificate</span></span>|<span data-ttu-id="4e57e-168">X509</span><span class="sxs-lookup"><span data-stu-id="4e57e-168">X509</span></span>|<span data-ttu-id="4e57e-169">X509</span><span class="sxs-lookup"><span data-stu-id="4e57e-169">X509</span></span>|<span data-ttu-id="4e57e-170">消息</span><span class="sxs-lookup"><span data-stu-id="4e57e-170">Message</span></span>|  
...
### <a name="11-usernametoken"></a><span data-ttu-id="4e57e-237">1.1 UsernameToken</span><span class="sxs-lookup"><span data-stu-id="4e57e-237">1.1 UsernameToken</span></span>  
 ...
 <span data-ttu-id="4e57e-239">R1101 UsernameToken\Password 元素的 PasswordType 属性必须省略或者值为 #PasswordText（默认值）。</span><span class="sxs-lookup"><span data-stu-id="4e57e-239">R1101 PasswordType attribute on UsernameToken\Password element MUST be either omitted or have value #PasswordText (default).</span></span>  
...
### <a name="15-security-context-token"></a><span data-ttu-id="4e57e-271">1.5 安全上下文令牌</span><span class="sxs-lookup"><span data-stu-id="4e57e-271">1.5 Security Context Token</span></span>  
...
### <a name="24-algorithm-suite"></a><span data-ttu-id="4e57e-284">2.4 算法组</span><span class="sxs-lookup"><span data-stu-id="4e57e-284">2.4 Algorithm Suite</span></span>  
...
## <a name="2-common-message-security-parameters"></a><span data-ttu-id="4e57e-304">2.常用消息安全参数</span><span class="sxs-lookup"><span data-stu-id="4e57e-304">2. Common Message Security Parameters</span></span>  
...
#### <a name="611-usernameovertransport"></a><span data-ttu-id="4e57e-318">6.1.1 UsernameOverTransport</span><span class="sxs-lookup"><span data-stu-id="4e57e-318">6.1.1 UsernameOverTransport</span></span>  
 ...
 <span data-ttu-id="4e57e-322">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-322">Policy</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-323">安全标头布局</span><span class="sxs-lookup"><span data-stu-id="4e57e-323">Security Header Layout</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-333">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-333">Response</span></span>  
...
#### <a name="614-kerberosovertransport"></a><span data-ttu-id="4e57e-343">6.1.4 KerberosOverTransport</span><span class="sxs-lookup"><span data-stu-id="4e57e-343">6.1.4 KerberosOverTransport</span></span>  
...
#### <a name="615-sspinegotiatedovertransport"></a><span data-ttu-id="4e57e-352">6.1.5 SspiNegotiatedOverTransport</span><span class="sxs-lookup"><span data-stu-id="4e57e-352">6.1.5 SspiNegotiatedOverTransport</span></span>  
 ...
 <span data-ttu-id="4e57e-360">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-360">Policy</span></span>  
...
### <a name="security-header-examples"></a><span data-ttu-id="4e57e-361">安全标头示例</span><span class="sxs-lookup"><span data-stu-id="4e57e-361">Security Header Examples</span></span>  
...
#### <a name="621-mutualcertificate-wss10"></a><span data-ttu-id="4e57e-367">6.2.1 MutualCertificate WSS1.0</span><span class="sxs-lookup"><span data-stu-id="4e57e-367">6.2.1 MutualCertificate WSS1.0</span></span>  
 ...
 <span data-ttu-id="4e57e-370">所用绑定为带有以下属性值的非对称绑定：</span><span class="sxs-lookup"><span data-stu-id="4e57e-370">The binding used is an asymmetric binding with the following property values:</span></span>  
...
#### <a name="622-mutualcertificateduplex"></a><span data-ttu-id="4e57e-384">6.2.2 MutualCertificateDuplex</span><span class="sxs-lookup"><span data-stu-id="4e57e-384">6.2.2 MutualCertificateDuplex</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-397">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-397">Security Header Examples: EncryptBeforeSign</span></span>  
...
#### <a name="623-using-symmetricbinding-with-x509-service-authentication"></a><span data-ttu-id="4e57e-399">6.2.3 将 SymmetricBinding 用于 X.509 服务身份验证</span><span class="sxs-lookup"><span data-stu-id="4e57e-399">6.2.3 Using SymmetricBinding with X.509 Service Authentication</span></span>  
 ...
 <span data-ttu-id="4e57e-406">身份验证模式 AnonymousForCertificate、UsernameForCertificate、MutualCertificate WSS11 和 IssuedTokenForCertificate 都使用具有以下属性值的类似的 sp:SymmetricBinding 实例：</span><span class="sxs-lookup"><span data-stu-id="4e57e-406">Authentication modes AnonymousForCertificate, UsernameForCertificate, MutualCertificate WSS11 and IssuedTokenForCertificate all use a similar instance of sp:SymmetricBinding with the following property values:</span></span>  
  
 <span data-ttu-id="4e57e-407">保护令牌：服务器的 X509 证书，包含模式设置为 …/IncludeToken/Never</span><span class="sxs-lookup"><span data-stu-id="4e57e-407">Protection Token: Server’s X509 Certificate, inclusion mode is set to .../IncludeToken/Never</span></span>  
<span data-ttu-id="4e57e-408">令牌保护：False</span><span class="sxs-lookup"><span data-stu-id="4e57e-408">Token Protection: False</span></span>  
  
 <span data-ttu-id="4e57e-409">整个标头和正文签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-409">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="4e57e-410">保护顺序：SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="4e57e-410">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="4e57e-411">加密签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-411">Encrypt Signature: True</span></span>  
  
 <span data-ttu-id="4e57e-412">上述身份验证模式的区别仅在于它们所使用的支持令牌。</span><span class="sxs-lookup"><span data-stu-id="4e57e-412">The above authentication modes only differ by the supporting tokens they use.</span></span> <span data-ttu-id="4e57e-413">AnonymousForCertificate 没有任何支持令牌，MutualCertificate WSS 1.1 将客户端的 X509 证书作为认可支持令牌，UserNameForCertificate 将“用户名令牌”作为签名支持令牌，而 IssuedTokenForCertificate 将颁发的令牌作为认可支持令牌。</span><span class="sxs-lookup"><span data-stu-id="4e57e-413">AnonymousForCertificate does not have any supporting tokens, MutualCertificate WSS 1.1 has the client’s X509 certificate as an endorsing supporting tokens, UserNameForCertificate has a UserName Token as a signed supporting token and IssuedTokenForCertificate has the issued token as an endorsing supporting token.</span></span>  
  
 <span data-ttu-id="4e57e-414">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-414">Policy</span></span>  
  
 <span data-ttu-id="4e57e-415">对称绑定</span><span class="sxs-lookup"><span data-stu-id="4e57e-415">Symmetric Binding</span></span>  
...
#### <a name="624-anonymousforcertificate"></a><span data-ttu-id="4e57e-416">6.2.4 AnonymousForCertificate</span><span class="sxs-lookup"><span data-stu-id="4e57e-416">6.2.4 AnonymousForCertificate</span></span>  
 <span data-ttu-id="4e57e-417">在此身份验证模式下，客户端是匿名的，而使用 X.509 证书对服务进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-417">With this authentication mode the client is anonymous and the service is authenticated using an X.509 certificate.</span></span> <span data-ttu-id="4e57e-418">所用绑定为 6.4.2 中所述的对称绑定的实例。</span><span class="sxs-lookup"><span data-stu-id="4e57e-418">The binding used is an instance of symmetric binding as described in 6.4.2.</span></span>  
  
 <span data-ttu-id="4e57e-419">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-419">Policy</span></span>  
  
 <span data-ttu-id="4e57e-420">请参见上面 6.2.3 中的“策略”以了解绑定详细信息</span><span class="sxs-lookup"><span data-stu-id="4e57e-420">See "Policy" in 6.2.3 above for binding details</span></span>  
  
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-421">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-421">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-422">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-422">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-423">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-423">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-424">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-424">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-425">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-425">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-426">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-426">Response</span></span>  
...
#### <a name="625-usernameforcertificate"></a><span data-ttu-id="4e57e-427">6.2.5 UserNameForCertificate</span><span class="sxs-lookup"><span data-stu-id="4e57e-427">6.2.5 UserNameForCertificate</span></span>  
 <span data-ttu-id="4e57e-428">在此身份验证模式下，客户端使用“用户名令牌”向服务进行身份验证，该令牌作为签名支持令牌出现在 SOAP 层上。</span><span class="sxs-lookup"><span data-stu-id="4e57e-428">With this authentication mode the client authenticates to the service using a Username Token which appears at the SOAP layer as a signed supporting token.</span></span> <span data-ttu-id="4e57e-429">服务使用 X.509 证书对客户端进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-429">The service authenticates to the client using an X.509 certificate.</span></span> <span data-ttu-id="4e57e-430">所用绑定为对称绑定，其保护令牌是由客户端生成的密钥，用服务的公钥进行加密。</span><span class="sxs-lookup"><span data-stu-id="4e57e-430">The binding used is a symmetric binding with the protection token being a key generated by the client, encrypted with the public key of the service.</span></span>  
  
 <span data-ttu-id="4e57e-431">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-431">Policy</span></span>  
  
 <span data-ttu-id="4e57e-432">请参见上面 6.2.3 中的“策略”以了解绑定详细信息</span><span class="sxs-lookup"><span data-stu-id="4e57e-432">See "Policy" in 6.2.3 above for binding details</span></span>  
  
 <span data-ttu-id="4e57e-433">签名支持令牌</span><span class="sxs-lookup"><span data-stu-id="4e57e-433">Signed Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-434">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-434">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-435">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-435">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-436">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-436">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-437">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-437">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-438">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-438">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-439">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-439">Response</span></span>  
...
#### <a name="626-mutualcertificate-wss-11"></a><span data-ttu-id="4e57e-440">6.2.6 MutualCertificate (WSS 1.1)</span><span class="sxs-lookup"><span data-stu-id="4e57e-440">6.2.6 MutualCertificate (WSS 1.1)</span></span>  
 <span data-ttu-id="4e57e-441">在此身份验证模式下，客户端使用 X.509 证书进行身份验证，该证书作为认可支持令牌出现在 SOAP 层上。</span><span class="sxs-lookup"><span data-stu-id="4e57e-441">With this authentication mode the client authenticates using an X.509 certificate which appears at the SOAP layer as an endorsing supporting token.</span></span> <span data-ttu-id="4e57e-442">同样使用 X.509 证书对服务进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-442">The service is also authenticated using an X.509 certificate.</span></span> <span data-ttu-id="4e57e-443">所用绑定为对称绑定，其保护令牌是由客户端生成的密钥，用服务的公钥进行加密。</span><span class="sxs-lookup"><span data-stu-id="4e57e-443">The binding used is a symmetric binding with the protection token being a key generated by the client, encrypted with the public key of the service.</span></span>  
  
 <span data-ttu-id="4e57e-444">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-444">Policy</span></span>  
  
 <span data-ttu-id="4e57e-445">请参见 6.2.3 中的“策略”以了解绑定详细信息</span><span class="sxs-lookup"><span data-stu-id="4e57e-445">See Policy in 6.2.3 for binding details</span></span>  
  
 <span data-ttu-id="4e57e-446">认可支持令牌</span><span class="sxs-lookup"><span data-stu-id="4e57e-446">Endorsing Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-447">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-447">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-448">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-448">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-449">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-449">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-450">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-450">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-451">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-451">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-452">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-452">Response</span></span>  
...
#### <a name="627-issuedtokenforcertificate"></a><span data-ttu-id="4e57e-453">6.2.7 IssuedTokenForCertificate</span><span class="sxs-lookup"><span data-stu-id="4e57e-453">6.2.7 IssuedTokenForCertificate</span></span>  
 <span data-ttu-id="4e57e-454">在此身份验证模式下，客户端不向服务进行身份验证，而是出示一个由 STS 颁发的令牌，并证明掌握了共享密钥。</span><span class="sxs-lookup"><span data-stu-id="4e57e-454">With this authentication mode the client does not authenticate to the service, as such, but instead presents a token issued by a STS and proves knowledge of a shared key.</span></span> <span data-ttu-id="4e57e-455">颁发的令牌作为认可支持令牌出现在 SOAP 层上。</span><span class="sxs-lookup"><span data-stu-id="4e57e-455">The issued token appears at the SOAP layer as an endorsing supporting token.</span></span> <span data-ttu-id="4e57e-456">服务使用 X.509 证书对客户端进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-456">The service authenticates to the client using an X.509 certificate.</span></span> <span data-ttu-id="4e57e-457">所用绑定为对称绑定，其保护令牌是由客户端生成的密钥，用服务的公钥进行加密。</span><span class="sxs-lookup"><span data-stu-id="4e57e-457">The binding used is a symmetric binding with the protection token being a key generated by the client, encrypted with the public key of the service.</span></span>  
  
 <span data-ttu-id="4e57e-458">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-458">Policy</span></span>  
  
 <span data-ttu-id="4e57e-459">请参见上面的 6.2.3 以了解绑定详细信息。</span><span class="sxs-lookup"><span data-stu-id="4e57e-459">See Policy in 6.2.3 above for binding details</span></span>  
  
 <span data-ttu-id="4e57e-460">认可支持令牌</span><span class="sxs-lookup"><span data-stu-id="4e57e-460">Endorsing Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-461">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-461">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-462">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-462">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-463">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-463">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-464">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-464">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-465">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-465">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-466">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-466">Response</span></span>  
...
## <a name="63-kerberos"></a><span data-ttu-id="4e57e-467">6.3 Kerberos</span><span class="sxs-lookup"><span data-stu-id="4e57e-467">6.3 Kerberos</span></span>  
 <span data-ttu-id="4e57e-468">在此身份验证模式下，客户端使用 Kerberos 票证向服务进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-468">With this authentication mode the client authenticates to the service using a Kerberos ticket.</span></span> <span data-ttu-id="4e57e-469">该票证还提供服务器身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-469">That same ticket also provides server authentication.</span></span> <span data-ttu-id="4e57e-470">所用绑定为对称绑定，具有以下属性：</span><span class="sxs-lookup"><span data-stu-id="4e57e-470">The binding used is a symmetric binding with the following properties;</span></span>  
  
 <span data-ttu-id="4e57e-471">保护令牌：Kerberos 票证，包含模式设置为 .../IncludeToken/Once</span><span class="sxs-lookup"><span data-stu-id="4e57e-471">Protection Token: Kerberos Ticket, inclusion mode is set to .../IncludeToken/Once</span></span>  
<span data-ttu-id="4e57e-472">令牌保护：False</span><span class="sxs-lookup"><span data-stu-id="4e57e-472">Token Protection: False</span></span>  
  
 <span data-ttu-id="4e57e-473">整个标头和正文签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-473">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="4e57e-474">保护顺序：SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="4e57e-474">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="4e57e-475">加密签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-475">Encrypt Signature: True</span></span>  
  
 <span data-ttu-id="4e57e-476">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-476">Policy</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-477">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-477">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-478">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-478">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-479">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-479">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-480">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-480">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-481">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-481">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-482">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-482">Response</span></span>  
...
#### <a name="64-issuedtoken"></a><span data-ttu-id="4e57e-483">6.4 IssuedToken</span><span class="sxs-lookup"><span data-stu-id="4e57e-483">6.4 IssuedToken</span></span>  
 <span data-ttu-id="4e57e-484">在此身份验证模式下，客户端不向服务进行身份验证，而是提供一个由 STS 颁发的令牌，并证明掌握了共享密钥。</span><span class="sxs-lookup"><span data-stu-id="4e57e-484">With this authentication mode the client does not authenticate to the service, as such, rather the client presents a token issued by an STS and proves knowledge of a shared key.</span></span> <span data-ttu-id="4e57e-485">服务也不向客户端进行身份验证，而是由 STS 将共享密钥作为颁发的令牌的一部分进行加密，这样，只有服务才能解密该密钥。</span><span class="sxs-lookup"><span data-stu-id="4e57e-485">The service is not authenticated to the client, as such, instead the STS encrypts the shared key as part of the issued token such that only the service can decrypt the key.</span></span> <span data-ttu-id="4e57e-486">所用绑定为对称绑定，具有以下属性：</span><span class="sxs-lookup"><span data-stu-id="4e57e-486">The binding used is as symmetric binding with the following properties;</span></span>  
  
 <span data-ttu-id="4e57e-487">保护令牌：颁发的令牌，包含模式设置为 .../IncludeToken/AlwaysToRecipient</span><span class="sxs-lookup"><span data-stu-id="4e57e-487">Protection Token: Issued Token, inclusion mode is set to .../IncludeToken/AlwaysToRecipient</span></span>  
<span data-ttu-id="4e57e-488">令牌保护：False</span><span class="sxs-lookup"><span data-stu-id="4e57e-488">Token Protection: False</span></span>  
  
 <span data-ttu-id="4e57e-489">整个标头和正文签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-489">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="4e57e-490">保护顺序：SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="4e57e-490">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="4e57e-491">加密签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-491">Encrypt Signature: True</span></span>  
  
 <span data-ttu-id="4e57e-492">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-492">Policy</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-493">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-493">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-494">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-494">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-495">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-495">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-496">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-496">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-497">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-497">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-498">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-498">Response</span></span>  
...
### <a name="65-using-sslnegotiated-for-service-authentication"></a><span data-ttu-id="4e57e-499">6.5 将 SslNegotiated 用于服务身份验证</span><span class="sxs-lookup"><span data-stu-id="4e57e-499">6.5 Using SslNegotiated for Service Authentication</span></span>  
 <span data-ttu-id="4e57e-500">本节介绍的一组身份验证模式将对称绑定用于保护令牌，作为安全上下文令牌（符合 WS-SecureConversation (WS-SC)），其键值是通过对 WS-Trust (WS-T) RST/RSTR 消息执行 TLS 协议进行协商的。</span><span class="sxs-lookup"><span data-stu-id="4e57e-500">This section describes a group of authentication modes that use a symmetric binding with the protection token being a Security Context Token per WS-SecureConversation (WS-SC) whose key value is negotiated by executing the TLS protocol over WS-Trust (WS-T) RST/RSTR messages.</span></span> <span data-ttu-id="4e57e-501">有关使用 WS-Trust 实现 TLS 握手的详细信息，请参见 TLSNEGO 中的内容。</span><span class="sxs-lookup"><span data-stu-id="4e57e-501">Details of the TLS handshake implementation using WS-Trust are described in TLSNEGO.</span></span> <span data-ttu-id="4e57e-502">此处的消息示例中，我们假设已通过握手建立了带有关联安全上下文的 SCT。</span><span class="sxs-lookup"><span data-stu-id="4e57e-502">Here in the message examples we will assume that SCT with an associated security context is already established through a handshake.</span></span>  
  
 <span data-ttu-id="4e57e-503">所用绑定为对称绑定，具有以下属性：</span><span class="sxs-lookup"><span data-stu-id="4e57e-503">The binding used is a symmetric binding with the following properties;</span></span>  
  
 <span data-ttu-id="4e57e-504">保护令牌：SslContextToken，包含模式设置为 .../IncludeToken/Never</span><span class="sxs-lookup"><span data-stu-id="4e57e-504">Protection Token: SslContextToken, inclusion mode is set to .../IncludeToken/Never</span></span>  
<span data-ttu-id="4e57e-505">令牌保护：False</span><span class="sxs-lookup"><span data-stu-id="4e57e-505">Token Protection: False</span></span>  
  
 <span data-ttu-id="4e57e-506">整个标头和正文签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-506">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="4e57e-507">保护顺序：SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="4e57e-507">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="4e57e-508">加密签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-508">Encrypt Signature: True</span></span>  
  
#### <a name="651-policy-for-sslnegotiated-service-authentication"></a><span data-ttu-id="4e57e-509">6.5.1 SslNegotiated 服务身份验证的策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-509">6.5.1 Policy for SslNegotiated service authentication</span></span>  
 <span data-ttu-id="4e57e-510">本节介绍的所有身份验证模式的策略都相似，唯一的区别在于，所用的特定签名支持令牌或认可令牌不相同。</span><span class="sxs-lookup"><span data-stu-id="4e57e-510">Policy for all authentication modes in this section are similar and differ only by specific signed supporting or endorsing tokens used.</span></span>  
...
#### <a name="652-anonymousforsslnegotiated"></a><span data-ttu-id="4e57e-511">6.5.2 AnonymousForSslNegotiated</span><span class="sxs-lookup"><span data-stu-id="4e57e-511">6.5.2 AnonymousForSslNegotiated</span></span>  
 <span data-ttu-id="4e57e-512">在此身份验证模式下，客户端是匿名的，而使用 X.509 证书对服务进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-512">With this authentication mode the client is anonymous and the service is authenticated using an X.509 certificate.</span></span> <span data-ttu-id="4e57e-513">所用绑定是对称绑定的一个实例，如上面 6.5.1 中所述。</span><span class="sxs-lookup"><span data-stu-id="4e57e-513">The binding used is an instance of symmetric binding as described in 6.5.1 above.</span></span>  
  
 <span data-ttu-id="4e57e-514">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-514">Policy</span></span>  
  
 <span data-ttu-id="4e57e-515">请参见上面 6.5.1 中的“策略”以了解绑定详细信息。</span><span class="sxs-lookup"><span data-stu-id="4e57e-515">See Policy in 6.5.1 above for binding details.</span></span>  
  
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-516">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-516">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-517">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-517">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-518">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-518">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-519">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-519">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-520">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-520">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-521">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-521">Response</span></span>  
...
#### <a name="653-usernameforsslnegotiated"></a><span data-ttu-id="4e57e-522">6.5.3 UserNameForSslNegotiated</span><span class="sxs-lookup"><span data-stu-id="4e57e-522">6.5.3 UserNameForSslNegotiated</span></span>  
 <span data-ttu-id="4e57e-523">在此身份验证模式下，客户端使用“用户名令牌”进行身份验证，该令牌作为签名支持令牌出现在 SOAP 层上。</span><span class="sxs-lookup"><span data-stu-id="4e57e-523">With this authentication mode the client is authenticates using a Username Token which appears at the SOAP layer as a signed supporting token.</span></span> <span data-ttu-id="4e57e-524">使用 X.509 证书对服务进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-524">The service is authenticated using an X.509 certificate.</span></span> <span data-ttu-id="4e57e-525">所用绑定是对称绑定的一个实例，如上面 6.5.1 中所述。</span><span class="sxs-lookup"><span data-stu-id="4e57e-525">The binding used is an instance of symmetric binding as described in 6.5.1.</span></span>  
  
 <span data-ttu-id="4e57e-526">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-526">Policy</span></span>  
  
 <span data-ttu-id="4e57e-527">请参见上面的第 6.5.1 节以了解绑定详细信息</span><span class="sxs-lookup"><span data-stu-id="4e57e-527">See section 6.5.1 above for binding details</span></span>  
  
 <span data-ttu-id="4e57e-528">签名支持令牌</span><span class="sxs-lookup"><span data-stu-id="4e57e-528">Signed Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-529">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-529">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-530">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-530">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-531">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-531">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-532">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-532">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-533">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-533">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-534">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-534">Response</span></span>  
...
#### <a name="654-issuedtokenforsslnegotiated"></a><span data-ttu-id="4e57e-535">6.5.4 IssuedTokenForSslNegotiated</span><span class="sxs-lookup"><span data-stu-id="4e57e-535">6.5.4 IssuedTokenForSslNegotiated</span></span>  
 <span data-ttu-id="4e57e-536">在此身份验证模式下，客户端不向服务进行身份验证，而是出示一个由 STS 颁发的令牌，并证明掌握了共享密钥。</span><span class="sxs-lookup"><span data-stu-id="4e57e-536">With this authentication mode the client does not authenticate to the service, as such, but instead presents a token issued by an STS and proves knowledge of a shared key.</span></span> <span data-ttu-id="4e57e-537">颁发的令牌作为认可支持令牌出现在 SOAP 层上。</span><span class="sxs-lookup"><span data-stu-id="4e57e-537">The issued token appears at the SOAP layer as an endorsing supporting token.</span></span> <span data-ttu-id="4e57e-538">使用 X.509 证书对服务进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-538">The service is authenticated using an X.509 certificate.</span></span> <span data-ttu-id="4e57e-539">所用绑定是对称绑定的一个实例，如上面 6.5.1 中所述。</span><span class="sxs-lookup"><span data-stu-id="4e57e-539">The binding used is an instance of symmetric binding as described in 6.5.1 above.</span></span>  
  
 <span data-ttu-id="4e57e-540">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-540">Policy</span></span>  
  
 <span data-ttu-id="4e57e-541">请参见上面的第 6.5.1 节以了解绑定详细信息</span><span class="sxs-lookup"><span data-stu-id="4e57e-541">See section 6.5.1 above for binding details</span></span>  
  
 <span data-ttu-id="4e57e-542">认可支持令牌</span><span class="sxs-lookup"><span data-stu-id="4e57e-542">Endorsing Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-543">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-543">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-544">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-544">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-545">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-545">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-546">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-546">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-547">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-547">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-548">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-548">Response</span></span>  
...
#### <a name="655-mutualsslnegotiated"></a><span data-ttu-id="4e57e-549">6.5.5 MutualSslNegotiated</span><span class="sxs-lookup"><span data-stu-id="4e57e-549">6.5.5 MutualSslNegotiated</span></span>  
 <span data-ttu-id="4e57e-550">在此身份验证模式下，客户端和服务都使用 X.509 证书进行身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-550">With this authentication mode the client and the service authenticate using X.509 certificates.</span></span> <span data-ttu-id="4e57e-551">所用绑定是对称绑定的一个实例，如上面 6.5.1 中所述。</span><span class="sxs-lookup"><span data-stu-id="4e57e-551">The binding used is an instance of symmetric binding as described in 6.5.1 above.</span></span>  
  
 <span data-ttu-id="4e57e-552">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-552">Policy</span></span>  
  
 <span data-ttu-id="4e57e-553">请参见上面的第 6.5.1 节以了解绑定详细信息</span><span class="sxs-lookup"><span data-stu-id="4e57e-553">See section 6.5.1 above for binding details</span></span>  
  
 <span data-ttu-id="4e57e-554">认可支持令牌</span><span class="sxs-lookup"><span data-stu-id="4e57e-554">Endorsing Supporting Token</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-555">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-555">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-556">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-556">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-557">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-557">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-558">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-558">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-559">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-559">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-560">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-560">Response</span></span>  
...
### <a name="66-sspinegotiated"></a><span data-ttu-id="4e57e-561">6.6 SspiNegotiated</span><span class="sxs-lookup"><span data-stu-id="4e57e-561">6.6 SspiNegotiated</span></span>  
 <span data-ttu-id="4e57e-562">在此身份验证模式下，将使用协商协议来执行客户端和服务器身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-562">With this authentication mode a negotiation protocol is used to perform client and server authentication.</span></span> <span data-ttu-id="4e57e-563">如果可能，就使用 Kerberos，否则使用 NTLM。</span><span class="sxs-lookup"><span data-stu-id="4e57e-563">Kerberos is used if possible, otherwise NTLM.</span></span> <span data-ttu-id="4e57e-564">所用绑定为对称绑定，具有以下属性：</span><span class="sxs-lookup"><span data-stu-id="4e57e-564">The binding used is a symmetric binding with the following properties;</span></span>  
  
 <span data-ttu-id="4e57e-565">保护令牌：SpnegoContextToken，包含模式设置为 .../IncludeToken/AlwaysToRecipient</span><span class="sxs-lookup"><span data-stu-id="4e57e-565">Protection Token: SpnegoContextToken, inclusion mode is set to .../IncludeToken/AlwaysToRecipient</span></span>  
<span data-ttu-id="4e57e-566">令牌保护：False</span><span class="sxs-lookup"><span data-stu-id="4e57e-566">Token Protection: False</span></span>  
  
 <span data-ttu-id="4e57e-567">整个标头和正文签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-567">Entire Header And Body Signatures: True</span></span>  
  
 <span data-ttu-id="4e57e-568">保护顺序：SignBeforeEncrypt</span><span class="sxs-lookup"><span data-stu-id="4e57e-568">Protection Order: SignBeforeEncrypt</span></span>  
  
 <span data-ttu-id="4e57e-569">加密签名：True</span><span class="sxs-lookup"><span data-stu-id="4e57e-569">Encrypt Signature: True</span></span>  
  
 <span data-ttu-id="4e57e-570">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-570">Policy</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-571">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-571">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-572">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-572">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-573">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-573">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-574">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-574">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-575">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-575">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-576">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-576">Response</span></span>  
...
### <a name="67-secureconversation"></a><span data-ttu-id="4e57e-577">6.7 SecureConversation</span><span class="sxs-lookup"><span data-stu-id="4e57e-577">6.7 SecureConversation</span></span>  
 <span data-ttu-id="4e57e-578">所用绑定为对称绑定，保护令牌为符合 WS-SecureConversation (WS-SC) 的 SCT。</span><span class="sxs-lookup"><span data-stu-id="4e57e-578">The binding used is a symmetric binding with the protection token being a SCT per WS-SecureConversation (WS-SC).</span></span> <span data-ttu-id="4e57e-579">该 SCT 是根据嵌套的绑定使用 WS-Trust (WS-Trust) 或 WS-SecureConversation (WS-SC) 协商的，该嵌套绑定本身是使用协商协议的对称绑定。</span><span class="sxs-lookup"><span data-stu-id="4e57e-579">The SCT is negotiated using WS-Trust (WS-Trust) or WS-SecureConversation (WS-SC) according to a nested binding, which is itself a symmetric binding that uses a negotiation protocol.</span></span> <span data-ttu-id="4e57e-580">如果可能，协商协议将使用 Kerberos 来执行客户端和服务器身份验证。</span><span class="sxs-lookup"><span data-stu-id="4e57e-580">The negotiation protocol will use Kerberos to perform client and server authentication if possible.</span></span> <span data-ttu-id="4e57e-581">如果无法使用 Kerberos，则退而使用 NTLM。</span><span class="sxs-lookup"><span data-stu-id="4e57e-581">If Kerberos cannot be used, it will fall back to NTLM.</span></span>  
  
 <span data-ttu-id="4e57e-582">策略</span><span class="sxs-lookup"><span data-stu-id="4e57e-582">Policy</span></span>  
...
### <a name="security-header-examples-signbeforeencrypt-encryptsignature"></a><span data-ttu-id="4e57e-583">安全标头示例：SignBeforeEncrypt、EncryptSignature</span><span class="sxs-lookup"><span data-stu-id="4e57e-583">Security Header Examples: SignBeforeEncrypt, EncryptSignature</span></span>  
 <span data-ttu-id="4e57e-584">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-584">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-585">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-585">Response</span></span>  
...
### <a name="security-header-examples-encryptbeforesign"></a><span data-ttu-id="4e57e-586">安全标头示例：EncryptBeforeSign</span><span class="sxs-lookup"><span data-stu-id="4e57e-586">Security Header Examples: EncryptBeforeSign</span></span>  
 <span data-ttu-id="4e57e-587">请求</span><span class="sxs-lookup"><span data-stu-id="4e57e-587">Request</span></span>  
...
```  
 ...
 <span data-ttu-id="4e57e-588">响应</span><span class="sxs-lookup"><span data-stu-id="4e57e-588">Response</span></span>  
