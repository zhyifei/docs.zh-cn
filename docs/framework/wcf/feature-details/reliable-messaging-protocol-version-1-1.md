...
#### TerminateSequence 交换  
 ...
 与 `CloseSequence` 交换一样，终止请求序列将隐式终止答复序列。这意味着 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 发起方在 `TerminateSequence` 消息上包括答复序列的最终 `SequenceAcknowledgement`，且答复序列没有 `TerminateSequence` 交换。  
