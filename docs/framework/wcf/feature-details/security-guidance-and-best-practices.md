...
ms.workload:
- dotnet
ms.openlocfilehash: 370fb63ff043e071d79f209373d225e196a90be7
...
本节中的主题介绍有关创建安全的 [!INCLUDE[indigo1](../../../../includes/indigo1-md.md)] 应用程序的指南和注意事项。 有关 Windows Server AppFabric 和安全，请参阅详细信息[安全模型的 Windows Server App Fabric](http://go.microsoft.com/fwlink/?LinkID=201279&clcid=0x409)  
