...
> [!IMPORTANT]
>  以使 Windows 应用商店应用程序可以跨计算机调用中，您必须启用称为"家庭/工作网络连接"的另一个功能。 此设置也位于“功能”选项卡下面的 Package.appmanifest 文件中。选中“家庭/工作网络连接”复选框。 这样，该应用程序就可以对用户的可信地点（家庭和工作地点）进行入站和出站访问。 将始终阻止关键入站端口。 为了访问 Internet 上的服务，您还必须启用“Internet (客户端}”功能。  
...
## <a name="see-also"></a>另请参阅  
 [Windows 应用商店应用博客中的 WCF](http://blogs.msdn.com/b/piyushjo/archive/2011/09/22/wcf-in-win8-metro-styled-apps-absolutely-supported.aspx)  
 [WCF Windows 应用商店客户端和安全](http://blogs.msdn.com/b/piyushjo/archive/2011/10/11/calling-a-wcf-service-from-a-metro-application-adding-security.aspx)  
 ...
 [调用在从 Windows 应用商店应用的 Azure 中部署的 WCF 服务](http://blogs.msdn.com/b/piyushjo/archive/2011/10/22/calling-a-wcf-service-from-a-metro-application-cross-machine-scenario.aspx)  
