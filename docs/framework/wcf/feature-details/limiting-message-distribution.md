...
-   有关代码段和相关信息，请参见[Peer Channel blog](http://go.microsoft.com/fwlink/?LinkID=114531) \(http:\/\/go.microsoft.com\/fwlink\/?LinkID\=114531\)。  
...
-   有关代码段和相关信息，请参见[Peer Channel blog](http://go.microsoft.com/fwlink/?LinkID=114532) \(http:\/\/go.microsoft.com\/fwlink\/?LinkID\=114532\)。  
...
-   **所用带宽**  
    ...
    -   *高*：首选直接连接，次选 MessagePropagationFilter 或本地筛选器。  
