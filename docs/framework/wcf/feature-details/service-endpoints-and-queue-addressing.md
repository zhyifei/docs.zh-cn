...
## <a name="msmq-addressing"></a>MSMQ 寻址  
 ...
 有关 MSMQ 路径和格式名的详细信息，请参阅[关于消息队列](https://go.microsoft.com/fwlink/?LinkId=94837)。  
...
## <a name="msmqintegrationbinding-and-service-addressing"></a>MsmqIntegrationBinding 和服务寻址  
 ...
 MSMQ 格式名称采用 MSMQ 在[关于消息队列](https://go.microsoft.com/fwlink/?LinkId=94837)中指定的形式。  
