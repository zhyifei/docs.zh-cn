...
-   <xref:System.ServiceModel.Dispatcher.ClientRuntime.CallbackDispatchRuntime%2A>  
 ...
 有关示例，演示跨截获[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]客户端，请参阅[如何： 检查或修改消息客户端上](../../../../docs/framework/wcf/extending/how-to-inspect-or-modify-messages-on-the-client.md)。  
...
### <a name="using-the-clientoperation-class"></a>使用 ClientOperation 类  
 ...
 使用 <xref:System.ServiceModel.Dispatcher.ClientRuntime.Operations%2A> 属性可以查找表示特定服务操作的 <xref:System.ServiceModel.Dispatcher.ClientOperation> 对象。 您可以使用下面的属性将自定义对象插入到 [!INCLUDE[indigo2](../../../../includes/indigo2-md.md)] 客户端系统中：  
...
-   使用 <xref:System.ServiceModel.Dispatcher.ClientOperation.SyncMethod%2A> 属性控制将哪个方法映射到操作。  
 ...
 有关示例，演示跨截获[!INCLUDE[indigo2](../../../../includes/indigo2-md.md)]客户端，请参阅[如何： 检查或修改参数](../../../../docs/framework/wcf/extending/how-to-inspect-or-modify-parameters.md)。  
