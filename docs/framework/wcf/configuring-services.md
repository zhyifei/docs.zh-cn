...
## <a name="in-this-section"></a>本节内容  
 ...
 Windows Communication Foundation (WCF) 服务是可配置使用.NET Framework 技术的配置。 大多数情况下，XML 元素添加到托管 WCF 服务的 Internet 信息服务 (IIS) 网站的 Web.config 文件中。 这些元素允许您更改详细信息，例如每台计算机上的终结点地址（用于与服务进行通信的实际地址）。  
