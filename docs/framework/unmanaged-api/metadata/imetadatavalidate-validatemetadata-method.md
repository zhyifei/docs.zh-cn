...
ms.tgt_pltfrm: 
ms.topic: reference
api_name: IMetaDataValidate.ValidateMetaData
...
---
# <a name="imetadatavalidatevalidatemetadata-method"></a>IMetaDataValidate::ValidateMetaData 方法
验证在当前元数据范围内的对象的元数据签名。  
