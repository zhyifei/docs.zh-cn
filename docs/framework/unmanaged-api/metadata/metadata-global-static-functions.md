...
开头[!INCLUDE[net_v40_long](../../../../includes/net-v40-long-md.md)]的文档`_Cor*`， `CoInitialize*`， `CoUninitialize*`，和`CoEEShutDownCOM`函数，与承载相关，位于[弃用的 CLR 承载函数](../../../../docs/framework/unmanaged-api/hosting/deprecated-clr-hosting-functions.md)。 没有与元数据相关的全局静态函数。  
