...
|`ofNoTransform`|指示应该禁用 .winmd 文件的自动转换。 也就是说，应该禁用从 Windows 运行时类型到 .NET Framework 类型的投影。 有关详细信息，请参阅[Windows 运行时和 CLR-使用.NET 和 Windows 运行时其下方后台](https://msdn.microsoft.com/magazine/jj651569.aspx)。|  
