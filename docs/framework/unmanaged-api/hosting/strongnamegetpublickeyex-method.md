...
## <a name="parameters"></a>parameters  
 `pwzKeyContainer`  
 [在]包含公钥/私钥对的密钥容器的名称。 如果`pbKeyBlob`为 null，`szKeyContainer`则必须在加密服务提供商 （CSP） 中指定有效的容器。 在这种情况下，`StrongNameGetPublicKeyEx`该方法从存储在容器中的密钥对中提取公钥。  
