...
尝试进入关键节由当前[IHostCrst](../../../../docs/framework/unmanaged-api/hosting/ihostcrst-interface.md)实例。  
...
## <a name="remarks"></a>备注  
 `TryEnter` 将立即返回，并指示是否调用线程已进入关键节。 此方法将镜像 Wind32`TryEnterCriticalSection`函数。  
