...
#### <a name="parameters"></a>参数  
 ...
 [out]最大主机可以分配给服务输入/输出请求线程池中的线程数指向的指针。  
...
## <a name="remarks"></a>备注  
 主机可能想对可以分配给来处理 I/O 请求，原因例如实现、 性能或可伸缩性的线程数的独有控制。 主机不为此，需要实现`GetMaxThreads`。 在这种情况下，主机应通过此方法返回 E_NOTIMPL。  
