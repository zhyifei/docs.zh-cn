...
ms.locfileid: "66490143"
---
# <a name="net-framework-4-hosting-global-static-functions"></a>.NET Framework 4 承载全局静态函数
.NET Framework 4 引入了一种新的导出的方法，在 MSCorEE.dll 中：[CLRCreateIntstance](../../../../docs/framework/unmanaged-api/hosting/clrcreateinstance-function.md)。  
