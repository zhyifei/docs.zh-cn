...
#### <a name="parameters"></a>参数  
 ...
 [in]数组以 null 结尾的字符串，在窗体中的"名称、 属性 = value..."指定的部分程序集标识列表。  
  
 `dwNumOfReferences`  
 [in]中的项的数目`ppwzAssemblyReferences`。  
  
 `ppReferenceList`  
 [out]接口指针`ICLRAssemblyReferenceList`对象，其中包含有关列表中指定的程序集的程序集标识数据`ppwzAssemblyReferences`。  
