...
---
# <a name="ihostmanualeventreset-method"></a>IHostManualEvent::Reset 方法
重置当前[IHostManualEvent](../../../../docs/framework/unmanaged-api/hosting/ihostmanualevent-interface.md)为非终止状态的实例。  
