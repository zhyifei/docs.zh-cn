...
- [演练：下载 ClickOnce 部署 API 使用设计器中使用按需程序集](/visualstudio/deployment/walkthrough-downloading-assemblies-on-demand-with-the-clickonce-deployment-api-using-the-designer)
