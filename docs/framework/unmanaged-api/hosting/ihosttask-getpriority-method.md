...
获取当前[IHostTask](../../../../docs/framework/unmanaged-api/hosting/ihosttask-interface.md)实例所表示的任务的线程优先级别。  
...
## <a name="parameters"></a>参数  
 `pPriority`  
 弄指向一个整数的指针，该整数指示当前 `IHostTask` 实例所表示的任务的线程优先级别。  
  
## <a name="return-value"></a>返回值  
  
|HRESULT|描述|  
|-------------|-----------------|  
|S_OK|`GetPriority` 成功返回。|  
