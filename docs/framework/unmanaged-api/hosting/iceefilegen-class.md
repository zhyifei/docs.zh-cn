...
---
# <a name="iceefilegen-class"></a><span data-ttu-id="a60fb-102">ICeeFileGen 类</span><span class="sxs-lookup"><span data-stu-id="a60fb-102">ICeeFileGen Class</span></span>
<span data-ttu-id="a60fb-103">提供用于创建本机可移植可执行文件 （PE） 文件的功能。</span><span class="sxs-lookup"><span data-stu-id="a60fb-103">Provides functionality for creating a native portable executable (PE) file.</span></span> <span data-ttu-id="a60fb-104">编译器通常使用该接口来生成其编译的输出可执行文件。</span><span class="sxs-lookup"><span data-stu-id="a60fb-104">The interface will typically be used by compilers to generate their compiled output executable.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="a60fb-105">`ICeeFileGen`支持 .NET 框架基础结构，不打算直接从代码中使用。</span><span class="sxs-lookup"><span data-stu-id="a60fb-105">`ICeeFileGen` supports the .NET Framework infrastructure and is not intended to be used directly from your code.</span></span>  
  
 <span data-ttu-id="a60fb-106">此接口已被弃用，将在将来的版本中删除。</span><span class="sxs-lookup"><span data-stu-id="a60fb-106">This interface has been deprecated and will be removed in a future release.</span></span>  
  
## <a name="syntax"></a><span data-ttu-id="a60fb-107">语法</span><span class="sxs-lookup"><span data-stu-id="a60fb-107">Syntax</span></span>  
...
## <a name="requirements"></a><span data-ttu-id="a60fb-108">要求</span><span class="sxs-lookup"><span data-stu-id="a60fb-108">Requirements</span></span>  
 <span data-ttu-id="a60fb-109">**平台：** 请参阅[系统要求](../../../../docs/framework/get-started/system-requirements.md)。</span><span class="sxs-lookup"><span data-stu-id="a60fb-109">**Platforms:** See [System Requirements](../../../../docs/framework/get-started/system-requirements.md).</span></span>  
  
 <span data-ttu-id="a60fb-110">**标题：** ICeeFileGen.h</span><span class="sxs-lookup"><span data-stu-id="a60fb-110">**Header:** ICeeFileGen.h</span></span>  
  
 <span data-ttu-id="a60fb-111">**.NET 框架版本：** 1.0</span><span class="sxs-lookup"><span data-stu-id="a60fb-111">**.NET Framework Version:** 1.0</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="a60fb-112">另请参阅</span><span class="sxs-lookup"><span data-stu-id="a60fb-112">See also</span></span>

- [<span data-ttu-id="a60fb-113">承载接口</span><span class="sxs-lookup"><span data-stu-id="a60fb-113">Hosting Interfaces</span></span>](../../../../docs/framework/unmanaged-api/hosting/hosting-interfaces.md)
