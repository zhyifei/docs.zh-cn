...
请求主机关闭以前通过调用到打开的端口[CreateIoCompletionPort](../../../../docs/framework/unmanaged-api/hosting/ihostiocompletionmanager-createiocompletionport-method.md)。  
...
## <a name="remarks"></a>备注  
 `hPort` 必须由以前通过调用创建的端口的句柄`CreateIoCompletionPort`。  
