...
向宿主通知公共语言运行时（CLR）将通过对[ICLRPolicyManager：： SetActionOnTimeout](../../../../docs/framework/unmanaged-api/hosting/iclrpolicymanager-setactionontimeout-method.md)方法的调用来执行指定的操作，以响应超时。  
...
## <a name="parameters"></a>参数  
 `operation`  
 中[EClrOperation](../../../../docs/framework/unmanaged-api/hosting/eclroperation-enumeration.md)值之一，指示已超时的操作的类型。  
  
 `action`  
 中[EPolicyAction](../../../../docs/framework/unmanaged-api/hosting/epolicyaction-enumeration.md)值之一，指示 CLR 响应超时所采取的操作。  
