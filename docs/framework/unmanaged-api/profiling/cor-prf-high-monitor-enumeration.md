...
[仅在 .NET Framework 4.5.2 及更高版本中受支持]  
 ...
 除了在[COR_PRF_MONITOR](../../../../docs/framework/unmanaged-api/profiling/cor-prf-monitor-enumeration.md)枚举中找到的标记外，还提供了标志，在加载时探查器可以指定给[ICorProfilerInfo5：： SetEventMask2](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo5-seteventmask2-method.md)方法。  
...
## <a name="remarks"></a>备注  
 `COR_PRF_HIGH_MONITOR` 标志与[ICorProfilerInfo5：： GetEventMask2](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo5-geteventmask2-method.md)和[ICorProfilerInfo5：： SetEventMask2](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo5-seteventmask2-method.md)方法的 `pdwEventsHigh` 参数一起使用。  
