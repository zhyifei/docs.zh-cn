...
## <a name="in-this-section"></a>本节内容  
 ...
 [COR_PRF_CODE_INFO 结构](../../../../docs/framework/unmanaged-api/profiling/cor-prf-code-info-structure.md)  
 表示存储在内存中的一个本机代码连续块。  
  
 [COR_PRF_EX_CLAUSE_INFO 结构](../../../../docs/framework/unmanaged-api/profiling/cor-prf-ex-clause-info-structure.md)  
 存储有关特定的异常子句实例及其关联的帧的信息。  
  
 [COR_PRF_FUNCTION 结构](../../../../docs/framework/unmanaged-api/profiling/cor-prf-function-structure.md)  
 ...
 [COR_PRF_GC_GENERATION_RANGE 结构](../../../../docs/framework/unmanaged-api/profiling/cor-prf-gc-generation-range-structure.md)  
 描述一个正进行垃圾回收的内存范围（即块）。  
