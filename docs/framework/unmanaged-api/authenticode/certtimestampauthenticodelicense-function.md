...
## <a name="parameters"></a>参数  
 ...
 [out] 指向 CRYPT_DATA_BLOB 的指针，用于接收 base64 编码的时间戳签名。 调用方负责在使用后释放 `pTimestampSignatureBlob`->`HepFree()` `pbData`。 请参阅[CRYPTOAPI_BLOB](/windows/win32/api/dpapi/ns-dpapi-crypt_integer_blob)结构。  
