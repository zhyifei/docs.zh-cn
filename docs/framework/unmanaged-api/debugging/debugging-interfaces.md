...
## <a name="in-this-section"></a>本节内容  
 ...
 [ICLRDebuggingLibraryProvider 接口](../../../../docs/framework/unmanaged-api/debugging/iclrdebugginglibraryprovider-interface.md)  
 ...
 [ICorDebugAppDomain 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugappdomain-interface.md)  
 提供用于调试应用程序域的方法。  
  
 [ICorDebugAppDomain2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugappdomain2-interface.md)  
 ...
 [ICorDebugAppDomainEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugappdomainenum-interface.md)  
 提供一种方法，此方法从枚举中的下一个位置开始，返回指定数目的 `ICorDebugAppDomain` 值。  
  
 [ICorDebugArrayValue 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugarrayvalue-interface.md)  
 表示一维或多维数组的 `ICorDebugHeapValue` 的子类。  
  
 [ICorDebugAssembly 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugassembly-interface.md)  
 表示一个程序集。  
  
 [ICorDebugAssembly2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugassembly2-interface.md)  
 ...
 [ICorDebugAssemblyEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugassemblyenum-interface.md)  
 ...
 [ICorDebugBoxValue 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugboxvalue-interface.md)  
 表示装箱的值类对象的 `ICorDebugHeapValue` 的子类。  
  
 [ICorDebugBreakpoint 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugbreakpoint-interface.md)  
 表示函数中的断点，或值的观察点。  
  
 [ICorDebugBreakpointEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugbreakpointenum-interface.md)  
 实现 `ICorDebugEnum` 方法，并枚举 `ICorDebugBreakpoint` 数组。  
  
 [ICorDebugChain 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugchain-interface.md)  
 表示一个物理或逻辑调用堆栈段。  
  
 [ICorDebugChainEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugchainenum-interface.md)  
 实现 `ICorDebugEnum` 方法，并枚举 `ICorDebugChain` 数组。  
  
 [ICorDebugClass 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugclass-interface.md)  
 表示基类型或复杂类型（即用户定义的类型）。 如果该类型为泛型类型，则 `ICorDebugClass` 表示实例化的泛型类型。  
  
 [ICorDebugClass2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugclass2-interface.md)  
 ...
 [ICorDebugCode2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugcode2-interface.md)  
 ...
 [ICorDebugCodeEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugcodeenum-interface.md)  
 ...
 [ICorDebugContext 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugcontext-interface.md)  
 表示一个上下文对象。 此接口尚未实现。  
  
 [ICorDebugController 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugcontroller-interface.md)  
 ...
 [ICorDebugEditAndContinueSnapshot 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugeditandcontinuesnapshot-interface.md)  
 已过时。 不要使用此接口。  
  
 [ICorDebugEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugenum-interface1.md)  
 作为调试枚举器的抽象基接口。  
  
 [ICorDebugErrorInfoEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugerrorinfoenum-interface.md)  
 已过时。 不要使用此接口。  
  
 [ICorDebugEval 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugeval-interface.md)  
 提供使调试器能够在正在调试的代码的上下文中执行代码的方法。  
  
 [ICorDebugEval2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugeval2-interface.md)  
 ...
 [ICorDebugFrame 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugframe-interface.md)  
 表示当前堆栈上的帧。  
  
 [ICorDebugFrameEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugframeenum-interface.md)  
 实现 `ICorDebugEnum` 方法，并枚举 `ICorDebugFrame` 数组。  
  
 [ICorDebugFunction 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugfunction-interface1.md)  
 表示一个托管函数或方法。  
  
 [ICorDebugFunction2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugfunction2-interface.md)  
 ...
 [ICorDebugFunctionBreakpoint 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugfunctionbreakpoint-interface.md)  
 ...
 [ICorDebugGenericValue 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebuggenericvalue-interface.md)  
 ...
 [ICorDebugHandleValue 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebughandlevalue-interface.md)  
 ...
 [ICorDebugHeapValue 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugheapvalue-interface.md)  
 表示 CLR 垃圾回收器已收集的对象的 `ICorDebugValue` 的子类。  
  
 [ICorDebugHeapValue2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugheapvalue2-interface1.md)  
 ...
 [ICorDebugILFrame 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugilframe-interface.md)  
 表示 MSIL 代码的堆栈帧。  
  
 [ICorDebugILFrame2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugilframe2-interface.md)  
 ...
 [ICorDebugInternalFrame 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebuginternalframe-interface.md)  
 标识调试器的帧类型。  
 ...
 [ICorDebugModule 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugmodule-interface.md)  
 表示 CLR 模块，它是可执行文件或动态链接库 (DLL)。  
  
 [ICorDebugModule2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugmodule2-interface.md)  
 用作 `ICorDebugModule` 的逻辑扩展。  
  
 [ICorDebugModule3 接口](../../../../docs/framework/unmanaged-api/debugging/icordebugmodule3-interface.md)  
 为动态模块创建符号读取器。  
  
 [ICorDebugModuleBreakpoint 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugmodulebreakpoint-interface.md)  
 ...
 [ICorDebugModuleEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugmoduleenum-interface.md)  
 ...
 [ICorDebugNativeFrame 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugnativeframe-interface.md)  
 ...
 [ICorDebugObjectEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugobjectenum-interface.md)  
 实现 `ICorDebugEnum` 方法，并通过对象数组的相对虚拟地址 (RVA) 对其进行枚举。  
  
 [ICorDebugObjectValue 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugobjectvalue-interface.md)  
 表示包含对象的值的 `ICorDebugValue` 的子类。  
  
 [ICorDebugObjectValue2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugobjectvalue2-interface.md)  
 扩展 `ICorDebugObjectValue` 以支持继承和重写。  
  
 [ICorDebugProcess 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugprocess-interface.md)  
 表示正在执行托管代码的进程。  
  
 [ICorDebugProcess2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugprocess2-interface1.md)  
 ...
 [ICorDebugProcessEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugprocessenum-interface.md)  
 实现 `ICorDebugEnum` 方法，并枚举 `ICorDebugProcess` 数组。  
  
 [ICorDebugReferenceValue 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugreferencevalue-interface.md)  
 ...
 [ICorDebugStepper 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugstepper-interface.md)  
 表示在代码执行过程中由调试器执行的一个步骤。此步骤作为命令颁发和完成之间的标识符使用，可以实现取消对某个步骤的执行。  
  
 [ICorDebugStepper2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugstepper2-interface1.md)  
 提供对“仅我的代码”(JMC) 调试的支持。  
  
 [ICorDebugStepperEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugstepperenum-interface.md)  
 实现 `ICorDebugEnum` 方法，并枚举 `ICorDebugStepper` 数组。  
  
 [ICorDebugStringValue 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugstringvalue-interface.md)  
 ...
 [ICorDebugThread 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugthread-interface.md)  
 表示进程中的线程。 `ICorDebugThread` 实例的生存期与它表示的线程的生存期相同。  
  
 [ICorDebugThread2 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugthread2-interface.md)  
 ...
 [ICorDebugThreadEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugthreadenum-interface1.md)  
 实现 `ICorDebugEnum` 方法，并枚举 `ICorDebugThread` 数组。  
  
 [ICorDebugType 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugtype-interface.md)  
 ...
 [ICorDebugTypeEnum 接口 1](../../../../docs/framework/unmanaged-api/debugging/icordebugtypeenum-interface.md)  
