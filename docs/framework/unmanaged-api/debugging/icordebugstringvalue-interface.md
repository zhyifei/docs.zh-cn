...
---
# <a name="icordebugstringvalue-interface1"></a>ICorDebugStringValue 接口 1
...
|方法|描述|  
|------------|-----------------|  
|[GetLength 方法](../../../../docs/framework/unmanaged-api/debugging/icordebugstringvalue-getlength-method.md)|获取引用的字符串中的字符数`ICorDebugStringValue`。|  
