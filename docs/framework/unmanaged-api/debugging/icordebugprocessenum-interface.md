...
---
# <a name="icordebugprocessenum-interface1"></a>ICorDebugProcessEnum 接口 1
...
|方法|描述|  
|------------|-----------------|  
|[Next 方法](../../../../docs/framework/unmanaged-api/debugging/icordebugprocessenum-next-method.md)|获取指定的数目的`ICorDebugProcess`枚举，从当前位置开始中的实例。|  
