...
|方法|描述|  
|------------|-----------------|  
|[GetID 方法](../../../../docs/framework/unmanaged-api/debugging/icorpublishappdomain-getid-method.md)|获取此唯一标识符`ICorPublishAppDomain`。|  
|[GetName 方法](../../../../docs/framework/unmanaged-api/debugging/icorpublishappdomain-getname-method.md)|获取此引用的应用程序域的名称`ICorPublishAppDomain`。|  
