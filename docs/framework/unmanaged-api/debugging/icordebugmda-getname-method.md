...
获取包含由表示托管调试助手 (MDA) 的名称的字符串[ICorDebugMDA](../../../../docs/framework/unmanaged-api/debugging/icordebugmda-interface.md)。  
...
## <a name="remarks"></a>备注  
 MDA 名称是唯一的值。 `GetName`方法是获取 XML 流并从基于架构的流中提取名称的方便性能替代方法。  
