...
|方法|描述|  
|------------|-----------------|  
|[ICorDebugModule3::CreateReaderForInMemorySymbols 方法](icordebugmodule3-createreaderforinmemorysymbols-method.md)|为动态模块创建符号读取器（通常为[ISymUnmanagedReader 接口](../diagnostics/isymunmanagedreader-interface.md)）。|  
