---
title: "&lt;命名空间&gt;元素 (.NET Native) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|值|说明|  
|-----------|-----------------|  
|*命名空间 _ 名称*|命名空间名称。 如果<>\>元素是子[ <> \</> \> ](../../../docs/framework/net-native/application-element-net-native.md)， [ <> \</> \> ](../../../docs/framework/net-native/library-element-net-native.md)，或[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)元素，*命名空间 _ 名称*必须是完全限定的命名空间名称。 如果<>\>元素是另一个子元素<>\>元素，*命名空间 _ 名称*必须是相对的命名空间名称。|  
...
|元素|描述|  
|-------------|-----------------|  
|[<>\>](../../../docs/framework/net-native/application-element-net-native.md)|作为应用程序范围内的类型和元数据可以反应在运行时间的类型成员的容器而服务。 [ <> \> ](../../../docs/framework/net-native/application-element-net-native.md)元素可以具有零个、 一个或多[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)元素。|  
|[<>\>](../../../docs/framework/net-native/assembly-element-net-native.md)|将运行时反射策略应用到指定程序集中的所有类型。|  
|[<>\>](../../../docs/framework/net-native/library-element-net-native.md)|定义包含元数据在运行时间可以用于反射的类型和类型成员的程序集。 [ <> \> ](../../../docs/framework/net-native/library-element-net-native.md)元素可以具有零个或一个[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)元素。|  
...
## <a name="remarks"></a>备注  
 ...
 时的子[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)元素，`<Namespace>`元素会替代所定义的运行时反射策略[ <> \> ](../../../docs/framework/net-native/assembly-element-net-native.md)元素。  
