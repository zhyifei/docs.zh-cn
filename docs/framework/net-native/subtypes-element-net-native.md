---
title: "&lt;子类型&gt;元素 (.NET Native) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
```  
 ...
 由于`<Subtypes>`指令的存在，以下代码以实例化`Derived1`动态地调用实例<xref:System.Activator.CreateInstance%28System.Type%29?displayProperty=fullName>方法成功执行。  这里的块变量是<xref:System.Windows.Controls.TextBlock>一个空白 Windows 应用商店应用程序中的对象。  
