...
3.  [<span data-ttu-id="0b6bf-113">创建更新映射</span><span class="sxs-lookup"><span data-stu-id="0b6bf-113">Create the update map</span></span>](../../../docs/framework/windows-workflow-foundation/dynamic-update.md#Create)  
