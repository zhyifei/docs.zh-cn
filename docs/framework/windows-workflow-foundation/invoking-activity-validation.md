 ...
 **错误：未提供必要活动自变量“Operand2”的值。**  
**错误：未提供所需活动参数"Operand1"的值。**  如果已调用此工作流，将引发 <xref:System.Activities.InvalidWorkflowException>，如下面的示例所示。  
...
**修复工作流定义或提供输入值以修复这些错误："**
**添加"：未提供所需活动参数"Operand2"的值。**
 **"添加"：未提供所需活动参数"Operand1"的值。**  传递正确的自变量之后，工作流将成功完成，如下面的示例所示。  
