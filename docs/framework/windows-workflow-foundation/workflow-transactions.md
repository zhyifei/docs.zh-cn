...
```  
 ...
 有关详细信息，请参阅基本[事务](../../../docs/framework/windows-workflow-foundation/samples/transactions.md)示例和基于方案[事务](../../../docs/framework/windows-workflow-foundation/samples/transactions.md)示例。 有关详细信息，请参阅关于使用<xref:System.ServiceModel.Activities.TransactedReceiveScope>，请参阅[流动的事务流入和流出工作流服务](../../../docs/framework/wcf/feature-details/flowing-transactions-into-and-out-of-workflow-services.md)。  
