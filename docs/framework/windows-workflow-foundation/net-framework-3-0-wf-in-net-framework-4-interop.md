...
> [!NOTE]
> <xref:System.Activities.Statements.Interop> 活动不会显示在工作流设计器工具箱中，除非工作流的项目的 "**目标框架**" 设置设为 **.NET Framework 4.5**。  
