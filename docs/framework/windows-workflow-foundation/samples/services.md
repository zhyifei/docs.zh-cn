...
## <a name="in-this-section"></a>本节内容  
 ...
 [SendParameters 和 ReceiveParameters 活动的基本使用情况](../../../../docs/framework/windows-workflow-foundation/samples/basic-usage-of-sendparameters-and-receiveparameters-activities.md)  
 ...
 [只包含服务的基本 XAML](../../../../docs/framework/windows-workflow-foundation/samples/basic-xaml-only-service.md)  
 演示如何创建只包含 XAML 的服务。  
 ...
 演示如何设置和配置持久双工消息交换使用 Windows Workflow Foundation (WF) 中的消息传递活动。  
 ...
 演示如何设置和配置缓冲的接收功能在 Windows Workflow Foundation (WF)。  
