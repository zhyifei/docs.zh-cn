...
## <a name="travelrulelibrary"></a>TravelRuleLibrary  
 ...
 右键单击**DiscountPolicy**活动，并选择**查看代码**选项以检查的代码旁置 C# 代码，用此活动。 观察 `DiscountLevel` 的依赖项属性设置。 这等效于 <xref:System.Activities.Argument> 中的 [!INCLUDE[netfx_current_short](../../../../includes/netfx-current-short-md.md)]。  
