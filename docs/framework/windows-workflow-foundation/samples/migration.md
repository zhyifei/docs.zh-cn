...
本节包含演示如何迁移使用编写的 Windows Workflow Foundation (WF) 内容的示例[!INCLUDE[netfx35_short](../../../../includes/netfx35-short-md.md)]到[!INCLUDE[netfx40_short](../../../../includes/netfx40-short-md.md)]。  
