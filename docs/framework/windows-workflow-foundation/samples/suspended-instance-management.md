...
## <a name="demonstrates"></a>演示
 <xref:System.ServiceModel.WorkflowServiceHost>在<xref:System.ServiceModel.Activities.Description.WorkflowUnhandledExceptionBehavior> Windows Workflow Foundation <xref:System.ServiceModel.Activities.WorkflowControlEndpoint> (WF) 中提供和。
