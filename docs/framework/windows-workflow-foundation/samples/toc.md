...
#### [有条件的活动组](conditioned-activity-group.md)
#### [使用策略处理的订单](order-processing-with-policy.md)
### [服务](services.md)
#### [绝对延迟](absolute-delay.md)
#### [持久延迟](durable-delay.md)
#### [发送和处理错误](sending-and-handling-faults.md)
#### [SendParameters 和 ReceiveParameters 活动的基本使用情况](basic-usage-of-sendparameters-and-receiveparameters-activities.md)
#### [只包含服务的基本 XAML](basic-xaml-only-service.md)
#### [在工作流服务中设置消息格式](formatting-messages-in-workflow-services.md)
#### [持久双工](durable-duplex.md)
#### [基于内容的关联](content-based-correlation.md)
...
#### [在 Windows 中将事件跟踪到事件跟踪](tracking-events-into-event-tracing-in-windows.md)
