...
|解决方案|描述|主要文件|  
|-|-|-|  
|CodedWorkflow|示例客户端应用程序，它演示如何以编程方式调用集合活动。|**PrintCollection.cs**： 帮助器活动向控制台输出集合中的每个项。<br /><br /> **Program.cs**： 以编程方式生成包含一系列集合活动，并执行它的序列活动。|  
|DesignerWorkflow|示例客户端应用程序，它演示如何在工作流设计器中以声明方式使用集合活动。|**CollectionWorkflow.xaml**： 使用集合活动设计器以声明方式创建工作流。<br /><br /> **PrintCollection.cs**： 帮助器活动向控制台输出集合中的每个项。<br /><br /> **Program.cs**： 调用在 CollectionWorkflow.xaml 中描述的工作流。|  
