...
在中[!INCLUDE[netfx40_short](../../../includes/netfx40-short-md.md)], Microsoft 将发布 Windows Workflow Foundation (WF) 的第二个主要版本。 [!INCLUDE[wf1](../../../includes/wf1-md.md)]在 WinFX 中发布 (这包括了 system.web\* . 命名空间中的类型, 现在称为 WF3) 并在中[!INCLUDE[netfx35_short](../../../includes/netfx35-short-md.md)]得到了增强。 WF3 也是的一部分, [!INCLUDE[netfx40_short](../../../includes/netfx40-short-md.md)]但它存在于新的工作流技术 (system.web.\*命名空间中的类型, 称为 WF4)。 考虑何时采用 WF4 时，重要的是首先要认识到您来控制时间安排。  
...
- 可以创建新的 WF3 应用程序, 并可在 Visual Studio 2012 中编辑现有应用程序并完全支持这些应用程序。  
 ...
 因此, 决定采用 .NET Framework 4 的决策与从 WF3 (\*\*WF4) 迁移到 () 的决策是分离的。 本主题提供 WF 迁移指南的相关链接，涵盖了使用 WF3 和 WF4 的相关信息。  
...
## <a name="wf-migration-whitepapers-and-cookbooks"></a>WF 迁移白皮书和实用手册  
 ...
 [WF 指南:原则](https://go.microsoft.com/fwlink/?LinkId=153854)  
 ...
 [WF 迁移指南:工作](https://go.microsoft.com/fwlink/?LinkId=153858)  
