...
## <a name="wf-migration-white-papers-and-cookbooks"></a>WF 迁移白皮书和指南
 ...
 [WF 迁移： WF3 开发的最佳做法](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
 讨论如何设计 WF3 项目以便可以更轻松地迁移至 WF4。  
  
 [WF 指南：规则](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
 介绍如何将规则相关投资引入 .NET Framework 4 解决方案。  
  
 [WF 指南：状态机](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
 ...
 [WF 迁移指南：自定义活动](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
 提供用于在 WF4 上重新设计 WF3 自定义活动的示例和说明。  
  
 [WF 迁移指南：高级自定义活动](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
 提供将使用 WF3 队列和对子活动进行排程的高级 WF3 自定义活动重新设计为 WF4 自定义活动的指南。  
  
 [WF 迁移指南：工作流](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
 提供用于在 WF4 上重新设计 WF3 工作流的示例和说明。  
  
 [WF 迁移指南：工作流托管](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
 提供将 WF3 承载代码重新设计为 WF4 承载代码的指南。 目标是介绍 WF3 和 WF4 在工作流承载上的关键差异。  
  
 [WF 迁移指南：工作流跟踪](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
 提供用等价 WF4 跟踪代码和配置来重新设计 WF3 跟踪代码和配置的指南。  
  
 [WF 指南：工作流服务](https://docs.microsoft.com/previous-versions/appfabric/ff383417(v=azure.10))  
