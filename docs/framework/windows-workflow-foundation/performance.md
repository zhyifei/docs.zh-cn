...
## <a name="terminology"></a>术语
 ...
 Windows Communication Foundation (WCF) 是用于构建面向服务的应用程序的 Microsoft 的统一编程模型。 它首次引入 WF3 一起.NET 3.0 的一部分，现在是一个重要组成部分[!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)]。
