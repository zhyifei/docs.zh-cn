...
2. <span data-ttu-id="35291-112">使用下面的命令编译此代码：</span><span class="sxs-lookup"><span data-stu-id="35291-112">Use the following command to compile this code:</span></span>
