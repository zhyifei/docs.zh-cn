...
5.  <span data-ttu-id="effde-148">使用标识公钥延迟对程序集签名。</span><span class="sxs-lookup"><span data-stu-id="effde-148">Delay-sign the assembly with the identity public key.</span></span>  
