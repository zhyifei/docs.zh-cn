...
|控件视图|内容视图|  
|------------------|------------------|  
|StatusBar<br /><br /> 编辑 （0 个或多个）<br />-进度栏 （0 个或多个）<br />-图像 （0 个或多个）<br />-按钮 （0 个或多个）|StatusBar<br /><br /> 编辑 （0 个或多个）<br />-Progressbar(0 个或多个）<br />-图像 （0 个或多个）<br />-按钮 （0 个或多个）|  
