...
|控件视图|内容视图|  
|------------------|------------------|  
|Header<br /><br /> -HeaderItem （1个或多个）|None|  
...
## <a name="required-ui-automation-control-patterns"></a>必需的 UI 自动化控件模式  
 下表列出需要由所有标头控件支持的 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 控件模式。 有关控件模式的详细信息，请参阅 [F:System.Windows.Automation.AutomationElementIdentifiers.IsEnabledProperty](ui-automation-control-patterns-overview.md)。  
...
|---------------------------------------------------------------------------------|-------------|-----------|  
|<xref:System.Windows.Automation.AutomationElement.BoundingRectangleProperty> 属性更改事件。|必填|None|  
|<xref:System.Windows.Automation.AutomationElement.IsOffscreenProperty> 属性更改事件。|必填|None|  
...
|<xref:System.Windows.Automation.AutomationElement.StructureChangedEvent>|必填|None|  
