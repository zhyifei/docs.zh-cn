...
具有表、图像和超链接嵌入对象的文本容器示例  
 ...
 ![前面示例的内容视图](../../../docs/framework/ui-automation/media/uia-textpattern-embedded-objects-overview-example2.png "UIA\_TextPattern\_Embedded\_Objects\_Overview\_Example2")  
前述文本容器的一部分的内容视图示例  
