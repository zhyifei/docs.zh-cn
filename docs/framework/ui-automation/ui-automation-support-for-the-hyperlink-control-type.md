...
|<xref:System.Windows.Automation.Provider.IValueProvider.Value>|例如，应用于对象的 `"https://www...."`|Internet 或 Intranet 地址的 URL 是一个包含对用户有意义的信息的超链接示例。 但是，以编程方式的链接仅对应用程序有意义，不建议用于 Value 属性。|  
