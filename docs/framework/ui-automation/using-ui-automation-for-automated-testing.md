...
|图像|HTML|Alt|NameProperty|  
 ...
 有关在提供[!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]程序中实现的信息，请参阅[托管代码的 UI 自动化提供程序](ui-automation-providers-for-managed-code.md)。 [UI Automation Control Patterns](ui-automation-control-patterns.md) 和 [UI Automation Text Pattern](ui-automation-text-pattern.md)中提供了有关实现控件模式的信息。  
