 ...
 **终结点**  
 ...
 ![TextPatternRangeEndpoints &#40; 开始和结束 &#41;。] (../../../docs/framework/ui-automation/media/uia-textpattern-endpoints.PNG "UIA_TextPattern_Endpoints")  
下面显示了一套起始点和终结点。  
