...
## <a name="example"></a>示例  
 此<xref:System.Windows.Automation.AutomationElement.GetCurrentPattern%2A>示例使用<xref:System.Windows.Automation.AutomationElement>类的方法从控件中获取<xref:System.Windows.Automation.TogglePattern>对象, 并返回其<xref:System.Windows.Automation.ToggleState>属性。  
