...
ms.locfileid: "74801393"
---
# <a name="ui-automation-support-for-the-window-control-type"></a>对 Window 控件类型的 UI 自动化支持
> [!NOTE]
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|Window|此值对于所有 UI 框架均相同。|  
...
|控件模式|支持|注释|  
|---------------------|-------------|-----------|  
|<xref:System.Windows.Automation.Provider.IDockProvider>|条件|如果窗口具有可停靠的功能，则必须支持。|  
