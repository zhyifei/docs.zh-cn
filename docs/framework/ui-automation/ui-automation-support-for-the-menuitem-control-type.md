...
菜单项控件的控件视图具有如上所示的 [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] 树结构。 请注意，**帮助**菜单项，包括在内，以更好地阐明子菜单层次结构的典型菜单中的结构。
