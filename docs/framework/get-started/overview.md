...
> [!NOTE]
>  有关面向用户和开发人员的 .NET Framework 的常规介绍，请参阅 [入门](../../../docs/framework/get-started/index.md)。  若要下载 .NET Framework，请参阅[安装指南](../../../docs/framework/install/guide-for-developers.md)。  
...
-   Windows 服务。  请参阅 [Windows 服务应用程序介绍](../../../docs/framework/windows-services/introduction-to-windows-service-applications.md)。  
  
-   使用 Windows Communication Foundation \(WCF\) 的面向服务的应用程序。  请参阅[使用 WCF 的面向服务的应用程序](../../../docs/framework/wcf/developing-service-oriented-applications-with-wcf.md)。  
  
-   使用 Windows Workflow Foundation \(WF\) 的启用工作流程的应用程序。  请参阅[Building Workflows in the .NET Framework](http://msdn.microsoft.com/zh-cn/cbf3880f-dc7b-466d-b808-1109b1223f4a)。  
