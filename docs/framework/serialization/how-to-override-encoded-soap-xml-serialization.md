---
title: "如何：重写编码的 SOAP XML 序列化 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
[代码示例](#tskhowtooverrideencodedsoapxmlserializationanchor1)  
 ...
 将对象的 XML 序列化重写为 SOAP 消息的过程类似于重写标准 XML 序列化的过程。有关重写标准 XML 序列化的信息，请参见[如何：指定 XML 流的替代元素名称](../../../docs/framework/serialization/how-to-specify-an-alternate-element-name-for-an-xml-stream.md)。  
  
### 将对象的序列化重写为 SOAP 消息  
  
1.  创建 [SoapAttributeOverrides](frlrfSystemXmlSerializationSoapAttributeOverridesClassTopic) 类的实例。  
