---
title: "XML 序列化程序生成器工具 (Sgen.exe) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|选项|描述|  
|--------|--------|  
|**\/a**\[**ssembly**\]**:***filename*|为由*文件名*指定的程序集或可执行文件中包含的所有类型生成序列化代码。  只能提供一个文件名。  如果该参数重复，将使用最后一个文件名。|  
...
## 请参阅  
 ...
 [XML Web Services Overview](http://msdn.microsoft.com/zh-cn/9db0c7b8-bca6-462b-9be5-f5f9a7f05a4d)   
