---
title: "基本序列化技术示例 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 请参阅  
 [BinaryFormatter 类](frlrfSystemRuntimeSerializationFormattersBinaryBinaryFormatterClassTopic)   
 [File 类](frlrfSystemIOFileClassTopic)   
 [FileStream 类](frlrfSystemIOFileStreamClassTopic)   
 [IFormatter 接口](frlrfSystemRuntimeSerializationIFormatterClassTopic)   
 [Random 类](https://msdn.microsoft.com/en-us/library/system.random.aspx)   
 [SerializableAttribute 特性](frlrfSystemSerializableAttributeClassTopic)   
 [SoapFormatter 类](frlrfSystemRuntimeSerializationFormattersSoapSoapFormatterClassTopic)   
 [Stream 类](frlrfSystemIOStreamClassTopic)   
