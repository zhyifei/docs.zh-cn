---
title: "Peverify.exe（PEVerify 工具） | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 备注  
 公共语言运行时依赖应用程序代码的类型安全执行，以帮助强制实施安全性和隔离机制。  通常情况下，虽然你可以设置安全策略以允许执行受信任但不可验证的代码，但无法运行不是[可验证类型安全](http://msdn.microsoft.com/zh-cn/095cd1f6-d8db-4c0e-bce2-83ccb34dd5dc)的代码。  
...
## 请参阅  
 ...
 [NIB: Writing Verifiably Type\-Safe Code](http://msdn.microsoft.com/zh-cn/d18f10ef-3b48-4f47-8726-96714021547b)   
 [Type Safety and Security](http://msdn.microsoft.com/zh-cn/095cd1f6-d8db-4c0e-bce2-83ccb34dd5dc)   
