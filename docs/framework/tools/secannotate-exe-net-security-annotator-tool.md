---
title: "SecAnnotate.exe（.NET 安全批注器工具） | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
.NET 安全性批注器工具 \(SecAnnotate.exe\) 是标识一个或多个程序集的 `SecurityCritical` 和 `SecuritySafeCritical` 部分的命令行应用程序。  
 ...
 [安全性批注器](http://go.microsoft.com/fwlink/?LinkId=198007)是一个 Visual Studio 扩展，提供了 SecAnnotate.exe 的图形用户界面，使你能够从 Visual Studio 中运行该工具。  
