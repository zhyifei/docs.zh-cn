---
title: "CorFlags.exe（CorFlags 转换工具） | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
|**\/?**|显示该工具的命令语法和选项。|  
|**\/Force**|强制执行更新，即使程序集具有强名称也是如此。 **Important:**  如果更新具有强名称的程序集，则必须在执行其代码之前再次对其签名。|  
|**\/help**|显示该工具的命令语法和选项。|  
|**\/ILONLY\+**|设置 ILONLY 标志。|  
|**\/ILONLY\-**|清除 ILONLY 标志。|  
|**\/nologo**|取消显示 Microsoft 启动版权标志。|  
|**\/RevertCLRHeader**|将 CLR 标头版本还原到 2.0。|  
|**\/UpgradeCLRHeader**|将 CLR 标头版本升级到 2.5。 **Note:**  程序集必须具有 2.5 版或更高版本的 CLR 标头才能在本机运行。|  
