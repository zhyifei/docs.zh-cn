...
- 在项目中添加对 `System.Data.Services.Client` 程序集的引用。  
 ...
 还可以通过在命令提示符处使用[DataSvcUtil](../../../../docs/framework/data/wcf/wcf-data-service-client-utility-datasvcutil-exe.md)工具来生成客户端数据服务类。 有关详细信息，请参阅[如何：手动生成客户端数据服务](../../../../docs/framework/data/wcf/how-to-manually-generate-client-data-service-classes-wcf-data-services.md)类。  
