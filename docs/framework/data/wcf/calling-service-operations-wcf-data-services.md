...
- [调用 Execute&lt;T&gt; 返回单个实体](calling-service-operations-wcf-data-services.md#ExecuteSingleEntity)  
  
- [调用 Execute&lt;T&gt; 返回基元值集合](calling-service-operations-wcf-data-services.md#ExecutePrimitiveCollection)  
...
### <a name="calling-executet-to-return-a-single-entity"></a>调用 Execute\<T > 返回单个实体  
...
### <a name="calling-executet-to-return-a-collection-of-primitive-values"></a>调用 Execute\<T > 返回基元值集合  
