---
title: "WCF 数据服务 4.5 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# WCF 数据服务 4.5
[!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]（以前称为“ADO.NET Data Services”）是 .NET Framework 的一个组件。可以使用此组件创建一些服务，利用[!INCLUDE[ssODataFull](../../../../includes/ssodatafull-md.md)] 来借助[具象状态传输 \(REST\)](http://go.microsoft.com/fwlink/?LinkId=113919)（可能为英文网页）语义通过 Web 或 Intranet 公开和使用数据。[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] 将数据公开为可通过 URI 寻址的资源。  可使用 GET、PUT、POST 和 DELETE 这些标准 HTTP 谓词来访问和更改数据。[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] 使用[实体数据模型](../../../../docs/framework/data/adonet/entity-data-model.md)的实体关系约定，将资源公开为通过关联相关的实体集。  
 ...
 [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)]可以将源自各种源的数据作为 [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] 源公开。  利用 Visual Studio 工具可使用 ADO.NET 实体框架数据模型，更容易创建基于 [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] 的服务。还可以基于公共语言运行时 \(CLR\) 类，甚至基于后期绑定或未类型化的数据来创建 [!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)] 源。  
...
-   [Silverlight 快速入门](http://go.microsoft.com/fwlink/?LinkID=192782)（可能为英文网页）  
  
-   [Windows Phone 开发 Silverlight 快速入门](http://go.microsoft.com/fwlink/?LinkID=214535)（可能为英文网页）  
...
-   [如何：将数据绑定到 Windows Presentation Foundation 元素](../../../../docs/framework/data/wcf/bind-data-to-wpf-elements-wcf-data-services.md)  
 ...
 -   [白皮书：OData 简介](http://go.microsoft.com/fwlink/?LinkId=220867)（可能为英文网页）  
  
-   [开放式数据协议网站](http://go.microsoft.com/fwlink/?LinkID=184554)（可能为英文网页）  
  
-   [OData：SDK](http://go.microsoft.com/fwlink/?LinkID=185248)（可能为英文网页）  
  
-   [OData：常见问题](http://go.microsoft.com/fwlink/?LinkId=185867)（可能为英文网页）  
  
 我想要观看一些视频…  
 -   [WCF 数据服务初学者指南](http://go.microsoft.com/fwlink/?LinkId=220864)（可能为英文网页）  
  
-   [WCF 数据服务开发人员视频](http://go.microsoft.com/fwlink/?LinkId=220861)（可能为英文网页）  
  
-   [OData：开发人员网站](http://go.microsoft.com/fwlink/?LinkId=185866)（可能为英文网页）  
  
 我想要查看端到端示例  
 -   [MSDN 示例库上的 WCF 数据服务文档示例](http://go.microsoft.com/fwlink/?LinkID=220865)（可能为英文网页）  
  
-   [MSDN 示例库上的其他 WCF 数据服务示例](http://go.microsoft.com/fwlink/?LinkId=220866)（可能为英文网页）  
...
-   [Silverlight 入门](http://go.microsoft.com/fwlink/?LinkId=148366)（可能为英文网页）  
  
 我要创建 Windows Phone 应用程序…  
 -   [Windows Phone 开发 Silverlight 快速入门](http://go.microsoft.com/fwlink/?LinkID=214535)（可能为英文网页）  
  
-   [Windows Phone 的开放式数据协议 \(OData\) 客户端](http://go.microsoft.com/fwlink/?LinkID=208749)（可能为英文网页）  
...
-   [WCF 数据服务开发人员中心](http://go.microsoft.com/fwlink/?LinkId=220868)（可能为英文网页）  
