...
## <a name="in-this-section"></a>本节内容  
 ...
 描述如何使用[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]馈送。  
  
 [在客户端应用程序中使用数据服务](../../../../docs/framework/data/wcf/using-a-data-service-in-a-client-application-wcf-data-services.md)  
 描述如何使用[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]源在.NET Framework 客户端应用程序。  
  
 [快速入门](../../../../docs/framework/data/wcf/quickstart-wcf-data-services.md)  
 演示如何创建和访问一个简单[!INCLUDE[ssODataShort](../../../../includes/ssodatashort-md.md)]-基于服务来公开基于 Northwind 示例数据库的源。  
