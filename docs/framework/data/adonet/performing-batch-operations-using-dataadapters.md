 ...
 **DataAdapter**具有两个与更新相关的事件： **RowUpdating**和**RowUpdated**。 在 ADO.NET 的以前版本中，如果禁用批处理，则每处理一行就会生成一次这些事件。 **RowUpdating**更新之前，生成和**RowUpdated**数据库更新完成后生成。  
