---
title: "如何：执行返回 PrimitiveType 结果的查询 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
本主题演示如何使用 <xref:System.Data.EntityClient.EntityCommand> 针对概念模型执行命令，以及如何使用 <xref:System.Data.EntityClient.EntityDataReader> 检索 <xref:System.Data.Metadata.Edm.PrimitiveType> 结果。  
