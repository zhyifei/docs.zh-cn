...
|POCO 实体|实体框架中的实体，该实体不从<xref:System.Data.Objects.DataClasses.EntityObject>或<xref:System.Data.Objects.DataClasses.ComplexObject>继承，并且不实现实体框架接口。 通常，POCO 实体是在实体框架应用程序中使用的现有域对象。 这些实体支持持久性未知。 有关详细信息，请参阅使用[POCO 实体](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/dd456853(v=vs.100))。|  
