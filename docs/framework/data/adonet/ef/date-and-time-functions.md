...
|`MONTH(date)`|以整数形式返回指定日期的月份。<br /><br /> **参数**<br /><br /> `date`： 类型的表达式`DateTime`或`DateTimeOffset`精度为 0 到 7。<br /><br /> **返回值**<br /><br /> 指定日期的月份（以 `Int32` 表示）。<br /><br /> **示例**<br /><br /> `SqlServer.MONTH(cast('6/9/2006' as DateTime))`|  
|`YEAR(date)`|以整数形式返回指定日期的年度。<br /><br /> **参数**<br /><br /> `date`： 类型的表达式`DateTime`或`DateTimeOffset`精度为 0 到 7。<br /><br /> **返回值**<br /><br /> 指定日期的年度（以 `Int32` 表示）。<br /><br /> **示例**<br /><br /> `SqlServer.YEAR(cast('6/9/2006' as DateTime))`|  
