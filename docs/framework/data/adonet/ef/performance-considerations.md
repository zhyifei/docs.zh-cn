...
|打开数据库连接|中等<sup>1</sup>|根据需要。|与数据库的开放连接会占用宝贵的资源，因为[!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)]打开和关闭数据库连接，仅在需要时。 还可以显式打开连接。 有关详细信息，请参阅[管理连接和事务](http://msdn.microsoft.com/library/b6659d2a-9a45-4e98-acaa-d7a8029e5b99)。|  
