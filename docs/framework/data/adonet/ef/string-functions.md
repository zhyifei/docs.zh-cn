...
|函数|描述|  
|--------------|-----------------|  
|`ASCII(expression)`|返回字符串表达式中最左侧字符的 ASCII 代码值。<br /><br /> **参数**<br /><br /> `expression`：ASCII 的任何有效表达式`String`类型。<br /><br /> **返回值**<br /><br /> 一个 `Int32`。<br /><br /> **示例**<br /><br /> `SqlServer.ASCII('A')`|  
...
|`LEN(expression)`|返回指定 String 表达式中的字符数，其中不包含尾随空格。<br /><br /> **参数**<br /><br /> `expression`：表达式`String`（Unicode 或 ASCII） 类型或`Binary`类型<br /><br /> **返回值**<br /><br /> 一个 `Int32`。<br /><br /> **示例**<br /><br /> `SqlServer.LEN('abcd')`|  
