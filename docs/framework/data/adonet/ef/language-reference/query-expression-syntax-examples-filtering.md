---
title: "查询表达式语法示例：筛选 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# 查询表达式语法示例：筛选
本主题中的示例演示如何使用 `Where` 和 `Where…Contains` 方法以通过查询表达式语法来查询 [AdventureWorks 销售模型](http://msdn.microsoft.com/zh-cn/f16cd988-673f-4376-b034-129ca93c7832)。  请注意，Where…`Contains` 不能用作[已编译的查询](../../../../../../docs/framework/data/adonet/ef/language-reference/compiled-queries-linq-to-entities.md)的一部分。  
