...
### <a name="example"></a>示例  
 以下示例使用 <languageKeyword>1From … From …2</languageKeyword>（与 `From … From …` 方法等效）以选择订单总计高于 10000.00 的所有订单并使用 <xref:System.Linq.Enumerable.SelectMany%2A> 赋值以避免两次请求总计。  
