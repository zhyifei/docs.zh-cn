...
## <a name="using-entity-sql-with-object-queries"></a>将 Entity SQL 与对象查询结合使用  
 ...
 [如何：对数据进行分组](https://msdn.microsoft.com/library/df801d9d-9a8a-4157-97a6-5016b18998e1)  
 ...
 [如何：页查看查询结果](https://msdn.microsoft.com/library/ffc0f920-e7de-42e0-9b12-ef356421d030)  
