...
### <a name="creating-the-sql-server-table"></a><span data-ttu-id="ea960-114">创建 SQL Server 表</span><span class="sxs-lookup"><span data-stu-id="ea960-114">Creating the SQL Server Table</span></span>  
