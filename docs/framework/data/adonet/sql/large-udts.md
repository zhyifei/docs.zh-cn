...
### <a name="getschematable-column-values-for-udts"></a><span data-ttu-id="e56c9-114">UDT 的 GetSchemaTable 列值</span><span class="sxs-lookup"><span data-stu-id="e56c9-114">GetSchemaTable Column Values for UDTs</span></span>  
