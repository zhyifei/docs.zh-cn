---
title: "SQL Server 功能和 ADO.NET | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
1.  [开发（数据库引擎）](http://go.microsoft.com/fwlink/?LinkId=115245)（可能为英文网页）  
  
## 本节内容  
 [枚举 SQL Server 的实例 \(ADO.NET\)](../../../../../docs/framework/data/adonet/sql/enumerating-instances-of-sql-server.md)  
 描述如何枚举 SQL Server 的活动实例。  
  
 [SQL Server 提供程序统计信息](../../../../../docs/framework/data/adonet/sql/provider-statistics-for-sql-server.md)  
