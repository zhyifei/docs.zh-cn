...
> [!NOTE]
>  转换是不同的 SQL Server 2000 和 SQL Server 2005。 如果你打算使用<xref:System.Linq.Queryable.Skip%2A>使用任何复杂度的查询，使用 SQL Server 2005。  
  
 请考虑以下[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]SQL Server 2000 的查询：  
