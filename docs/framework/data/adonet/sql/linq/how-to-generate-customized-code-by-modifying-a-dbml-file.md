...
可以从数据库标记语言C# （.dbml）元数据文件生成 Visual Basic 或源代码。 此方法提供了一个在生成应用程序映射代码前自定义默认 .dbml 文件的机会。 这是一项高级功能。  
...
## <a name="example"></a>示例  
 下面的代码从 .dbml 文件C#生成 Visual Basic 或源代码文件。  
