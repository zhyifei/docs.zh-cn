...
- SQL 引擎:这些演练编写为通过使用 SQL Server Express 来实现。 如果您没有 SQL Server Express，可以免费下载。 有关详细信息, 请参阅[下载示例数据库](../../../../../../docs/framework/data/adonet/sql/linq/downloading-sample-databases.md)。  
