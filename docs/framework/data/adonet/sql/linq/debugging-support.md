...
ms.locfileid: "70247078"
---
# <a name="debugging-support"></a>调试支持
[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]为[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]项目提供常规调试支持。  另请参阅[调试 linq](/visualstudio/debugger/debugging-linq)或[调试 linq](/visualstudio/debugger/debugging-linq)。  
