---
title: "如何：使用代码编辑器自定义实体类 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
使用 [!INCLUDE[vs_current_short](../../../../../../includes/vs-current-short-md.md)] 的开发人员可以使用 [!INCLUDE[vs_ordesigner_long](../../../../../../includes/vs-ordesigner-long-md.md)] 来创建或自定义其实体类。  
 ...
 [如何：将列表示为由数据库生成的列](../../../../../../docs/framework/data/adonet/sql/linq/how-to-represent-columns-as-database-generated.md)  
 ...
 [如何：指定私有存储字段](../../../../../../docs/framework/data/adonet/sql/linq/how-to-specify-private-storage-fields.md)  
