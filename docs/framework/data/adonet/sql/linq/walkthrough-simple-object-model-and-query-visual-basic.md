...
2.  在**项目类型**窗格**新项目**对话框中，单击**Visual Basic**。  
...
3.  另外，请在**添加引用**对话框中，单击 **.NET**、 滚动到并单击 System.Windows.Forms，，然后单击**确定**。  
...
## <a name="next-steps"></a>后续步骤  
 [演练： 跨关系查询 (Visual Basic 中)](../../../../../../docs/framework/data/adonet/sql/linq/walkthrough-querying-across-relationships-visual-basic.md)主题持续到本演练结束。 跨关系查询演练演示如何[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]可以跨表查询，类似于*联接*关系数据库中。  
