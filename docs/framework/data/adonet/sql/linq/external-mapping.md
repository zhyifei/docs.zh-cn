...
> [!NOTE]
>  Visual Studio 用户还会发现此 XSD 文件在 XML 架构对话框中为"LinqToSqlMapping.xsd"。 若要正确使用此文件，来验证外部映射文件，请参阅[如何：验证 DBML 和外部映射文件](../../../../../../docs/framework/data/adonet/sql/linq/how-to-validate-dbml-and-external-mapping-files.md)。  
