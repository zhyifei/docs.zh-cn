...
-   [公共语言运行时 (CLR) 集成概述](http://go.microsoft.com/fwlink/?LinkId=115242)  
...
-   [启用 CLR 集成](http://go.microsoft.com/fwlink/?LinkId=115230)  
...
1.  [部署 CLR 数据库对象](http://go.microsoft.com/fwlink/?LinkId=115232)  
...
-   [CLR 集成安全性](http://go.microsoft.com/fwlink/?LinkId=115234)  
...
-   [调试 CLR 数据库对象](http://go.microsoft.com/fwlink/?LinkId=115236)  
