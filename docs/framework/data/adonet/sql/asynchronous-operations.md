...
> [!NOTE]
>  异步编程是 .NET Framework 的核心功能，并且 ADO.NET 充分利用了标准设计模式。 有关不同的异步技术可供开发人员的详细信息，请参阅[异步调用同步方法](../../../../../docs/standard/asynchronous-programming-patterns/calling-synchronous-methods-asynchronously.md)。  
...
## <a name="in-this-section"></a>本节内容  
 [Windows 应用程序使用回调](../../../../../docs/framework/data/adonet/sql/windows-applications-using-callbacks.md)  
 ...
 [在控制台应用程序中的轮询](../../../../../docs/framework/data/adonet/sql/polling-in-console-applications.md)  
