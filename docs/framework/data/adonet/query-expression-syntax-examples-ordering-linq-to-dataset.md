---
title: "查询表达式语法示例：排序 (LINQ to DataSet) | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
### 示例  
 此示例使用等效于 <xref:System.Linq.Enumerable.OrderByDescending%2A> 方法的 `orderby  descending` \(`Order By … Descending`\) 从高到低排序价格列表。  
...
### 示例  
 此示例使用等效于 <xref:System.Linq.Enumerable.ThenByDescending%2A> 方法的 `OrderBy… Descending` 先按名称然后按定价从高到低对产品列表排序。  
