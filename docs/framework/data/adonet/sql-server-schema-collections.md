...
|SPECIFIC_SCHEMA|字符串|架构的特定名称。|  
|SPECIFIC_NAME|字符串|编录的特定名称。|  
...
|PARAMETER_MODE|字符串|如果是输入参数，返回 IN，如果是输出参数，返回 OUT，如果是输入/输出参数，返回 INOUT。|  
|IS_RESULT|字符串|如果指示属于函数的过程的结果，返回 YES。 否则，返回 NO。|  
|AS_LOCATOR|字符串|如果声明为定位符，返回 YES。 否则，返回 NO。|  
|PARAMETER_NAME|字符串|参数的名称。 如果对应于函数的返回值，返回 NULL。|  
...
|COLLATION_CATALOG|字符串|参数排序规则的编录名称。 如果不属于某种字符类型，返回 NULL。|  
|COLLATION_SCHEMA|字符串|始终返回 NULL。|  
|COLLATION_NAME|字符串|参数分页的名称。 如果不属于某种字符类型，返回 NULL。|  
|CHARACTER_SET_CATALOG|字符串|参数字符集的编录名称。 如果不属于某种字符类型，返回 NULL。|  
|CHARACTER_SET_SCHEMA|字符串|始终返回 NULL。|  
|CHARACTER_SET_NAME|字符串|参数字符集的名称。 如果不属于某种字符类型，返回 NULL。|  
...
|IS_UPDATABLE|字符串|指定视图是否可以更新。 始终返回 NO。|  
