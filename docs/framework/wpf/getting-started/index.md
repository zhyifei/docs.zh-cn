...
|如何设计应用程序 UI？|[在 Visual Studio 中设计 XAML](http://msdn.microsoft.com/library/288e2415-9fcf-408e-bc35-9848315e14fd)|  
|是否是初次使用 .NET？|[.NET Framework 概述](https://msdn.microsoft.com/en-us/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [.NET Framework 应用程序要点](../../../../docs/standard/application-essentials.md)<br /><br /> [Visual C# 和 Visual Basic 入门](https://msdn.microsoft.com/en-us/library/dd492171\(v=vs.140\).aspx)|  
