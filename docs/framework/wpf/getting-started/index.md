...
|是否是初次使用 .NET？|[.NET Framework 概述](../../get-started/overview.md)<br /><br /> [.NET Framework 应用程序要点](../../../../docs/standard/application-essentials.md)<br /><br /> [Visual C# 和 Visual Basic 入门](/visualstudio/ide/getting-started-with-visual-csharp-and-visual-basic)|  
