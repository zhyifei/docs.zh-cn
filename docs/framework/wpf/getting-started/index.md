...
|是否是初次使用 .NET？|[.NET Framework 概述](../../get-started/overview.md)<br /><br /> [.NET Framework 应用程序要点](../../../standard/application-essentials.md)<br /><br /> [Visual C# 和 Visual Basic 入门](/visualstudio/ide/getting-started-with-visual-csharp-and-visual-basic)|  
|有关 WPF 的详细信息...|[Visual Studio 中的 WPF 简介](introduction-to-wpf-in-vs.md)<br /><br /> [XAML 概述 (WPF)](../advanced/xaml-overview-wpf.md)<br /><br /> [Controls](../controls/index.md)<br /><br /> [数据绑定概述](../data/data-binding-overview.md)|  
