...
## <a name="example"></a>示例  
 ...
 有关详细信息<xref:System.Windows.Media.VisualBrush>和其他示例，请参阅[使用图像、 绘图和视觉对象进行绘制](../../../../docs/framework/wpf/graphics-multimedia/painting-with-images-drawings-and-visuals.md)概述。  
