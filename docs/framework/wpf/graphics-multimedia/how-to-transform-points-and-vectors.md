...
ms.locfileid: "61797158"
---
# <a name="how-to-transform-points-and-vectors"></a>如何：转换点和矢量
此示例演示如何使用<xref:System.Windows.Media.Matrix>来转换<xref:System.Windows.Point>和<xref:System.Windows.Vector>对象。  
