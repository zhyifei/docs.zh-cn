...
## <a name="example"></a>示例  
 ...
 了解如何将内容文件，例如媒体文件添加到您的应用程序，请参阅[WPF 应用程序资源、 内容和数据文件](../../../../docs/framework/wpf/app-development/wpf-application-resource-content-and-data-files.md)。 当添加媒体文件时，必须将其添加，作为内容文件，而不是资源文件。  
