...
---
# <a name="how-to-convert-a-bitmapsource-to-an-indexed-pixel-format"></a><span data-ttu-id="67661-102">如何：将 BitmapSource 转换为索引像素格式</span><span class="sxs-lookup"><span data-stu-id="67661-102">How to: Convert a BitmapSource to an Indexed Pixel Format</span></span>
<span data-ttu-id="67661-103">此示例演示如何将转换<xref:System.Windows.Media.Imaging.BitmapSource>到索引的像素格式。</span><span class="sxs-lookup"><span data-stu-id="67661-103">This example shows how to convert a <xref:System.Windows.Media.Imaging.BitmapSource> to an indexed pixel format.</span></span>  
  
## <a name="example"></a><span data-ttu-id="67661-104">示例</span><span class="sxs-lookup"><span data-stu-id="67661-104">Example</span></span>  
