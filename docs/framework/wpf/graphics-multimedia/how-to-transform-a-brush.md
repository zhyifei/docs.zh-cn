...
## <a name="example"></a>示例  
 ...
 有关如何将说明<xref:System.Windows.Media.Brush.RelativeTransform%2A>并<xref:System.Windows.Media.Brush.Transform%2A>属性起作用，请参阅[画笔转换概述](../../../../docs/framework/wpf/graphics-multimedia/brush-transformation-overview.md)。  
  
 有关完整示例，请参阅[画笔示例](https://go.microsoft.com/fwlink/?LinkID=159973)。 有关画笔的详细信息，请参阅[使用纯色和渐变进行绘制概述](../../../../docs/framework/wpf/graphics-multimedia/painting-with-solid-colors-and-gradients-overview.md)。  
