...
此示例演示如何使用代码添加到控件<xref:System.Windows.Media.Animation.Storyboard>已开始后。 若要控制在情节提要[!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)]，使用<xref:System.Windows.Trigger>并<xref:System.Windows.TriggerAction>对象; 有关示例，请参阅[使用事件触发器来控制情节提要启动之后](../../../../docs/framework/wpf/graphics-multimedia/how-to-use-event-triggers-to-control-a-storyboard-after-it-starts.md)。  
 ...
 **注意：** 若要控制使用触发器和情节提要的示例，请参阅[!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)]，请参阅[使用事件触发器来控制情节提要启动之后](../../../../docs/framework/wpf/graphics-multimedia/how-to-use-event-triggers-to-control-a-storyboard-after-it-starts.md)。  
