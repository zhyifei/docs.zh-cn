...
[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 和 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 提供两种用于创建应用程序接口的不同体系结构。 <xref:System.Windows.Forms.Integration?displayProperty=nameWithType>命名空间提供用于启用常见互操作方案的类。 实现互操作功能的两个关键类<xref:System.Windows.Forms.Integration.WindowsFormsHost>是<xref:System.Windows.Forms.Integration.ElementHost>和。 本主题介绍支持哪些互操作方案以及不支持哪些互操作方案。  
...
### <a name="layout-support"></a>布局支持  
 下面的列表介绍当<xref:System.Windows.Forms.Integration.WindowsFormsHost>元素尝试将其承载[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]的控件集成到[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]布局系统中时的已知限制。  
  
- 某些情况下，不能调整 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件的大小，或者大小只能调整为特定尺寸。 例如, [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] <xref:System.Windows.Forms.ComboBox>控件仅支持一个高度, 该高度由控件的字号定义。 在假定元素可垂直拉伸的<xref:System.Windows.Forms.ComboBox> 动态布局中,承载的控件不会按预期拉伸。[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]  
...
### <a name="ambient-properties"></a>环境属性  
 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 控件的某些环境属性具有 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 等效项。 这些环境属性传播到所承载[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]的控件, 并作为<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件上的公共属性公开。 控件<xref:System.Windows.Forms.Integration.WindowsFormsHost>将每个[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]环境属性转换为[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]其等效的。  
...
|行为|支持|不支持|  
|--------------|---------------|-------------------|  
|透明度|[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件呈现支持透明度。 父 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 控件的背景可以成为所承载的 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件的背景。|某些 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件不支持透明度。 例如, <xref:System.Windows.Forms.TextBox>在由[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]承载<xref:System.Windows.Forms.ComboBox>时, 和控件将不透明。|  
|Tab 键次序|所承载的 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件的 Tab 键顺序与这些控件承载于基于 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 的应用程序中时是相同的。<br /><br /> 使用 Tab 键和 Shift+Tab 键从 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 控件切换到 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件将按常规方式工作。<br /><br /> [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]当用户通过控件<xref:System.Windows.Forms.Control.TabStop%2A>选项卡通过`false`控件时, 属性值为的控件不会获得焦点。<br /><br /> -每<xref:System.Windows.Forms.Integration.WindowsFormsHost>个控件都<xref:System.Windows.Forms.Integration.WindowsFormsHost.TabIndex%2A>有一个值, 该值确定<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件将接收焦点的时间。<br />-   [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]<xref:System.Windows.Forms.Integration.WindowsFormsHost>容器内包含的控件遵循<xref:System.Windows.Forms.Control.TabIndex%2A>属性指定的顺序。 从最后一个 Tab 键索引使用 Tab 键切换会将焦点置于下一个 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 控件上（若存在）。 如果不存在其他可聚焦的 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 控件，按 Tab 键将返回到 Tab 键顺序中的第一个 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件。<br />-   <xref:System.Windows.Forms.Integration.WindowsFormsHost.TabIndex%2A>内<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件的值相对于<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件中包含[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]的同级控件。<br />-    按 Tab 键遵循特定于控件的行为。 例如, 在<xref:System.Windows.Forms.TextBox> <xref:System.Windows.Forms.TextBoxBase.AcceptsTab%2A>属性值为的`true`控件中按 tab 键可在文本框中输入一个选项卡, 而不是移动焦点。|不适用。|  
|使用箭头键导航|-在<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件中使用箭头键进行导航与在普通[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]的容器控件中相同:向上键和向左键选择上一个控件, 向下键和向右键选择下一个控件。<br />- <xref:System.Windows.Forms.Integration.WindowsFormsHost>控件中包含的第一个控件的向上键和向左键执行与 SHIFT + TAB 键盘快捷方式相同的操作。 如果有可[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]获得焦点的控件, 焦点将移<xref:System.Windows.Forms.Integration.WindowsFormsHost>到控件外。 此行为不同于中的<xref:System.Windows.Forms.ContainerControl>标准行为, 因为没有环绕最后一个控件。 如果不存在其他可聚焦的 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 控件，焦点将返回到 Tab 键顺序中的最后一个 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件。<br />-包含在<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件中的最后一个控件的向下箭头和向右箭头键执行与 TAB 键相同的操作。 如果有可[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]获得焦点的控件, 焦点将移<xref:System.Windows.Forms.Integration.WindowsFormsHost>到控件外。 此行为不同于中的<xref:System.Windows.Forms.ContainerControl>标准行为, 因为这样做不会换行到第一个控件。 如果不存在其他可聚焦的 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 控件，焦点将返回到 Tab 键顺序中的第一个 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件。|不适用。|  
...
|快捷键|快捷键按常规方式工作，但“不支持”列中注明的情况除外。|在预处理阶段处理的 -   [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 快捷键总是优先于 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 快捷键。 例如, 如果你具有一个<xref:System.Windows.Forms.ToolStrip>定义了 ctrl + s 快捷键的控件, 并且有一个[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]绑定到<xref:System.Windows.Forms.ToolStrip> ctrl + s 的命令, 则始终首先调用控件处理程序, 而不考虑焦点。<br />-   [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]<xref:System.Windows.Forms.Control.KeyDown>事件处理的快捷键在中[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]最后处理。 可以通过重写[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]控件的<xref:System.Windows.Forms.Control.IsInputKey%2A>方法或处理<xref:System.Windows.Forms.Control.PreviewKeyDown>事件来防止此行为。 `true` <xref:System.Windows.Forms.PreviewKeyDownEventArgs.IsInputKey%2A?displayProperty=nameWithType> `true`从方法返回, 或在<xref:System.Windows.Forms.Control.PreviewKeyDown>事件处理程序中将属性的值设置为。 <xref:System.Windows.Forms.Control.IsInputKey%2A>|  
|AcceptsReturn、AcceptsTab 以及其他特定于控件的行为|更改默认键盘行为的属性会像往常一样工作, 假设[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]控件重写要返回`true`的<xref:System.Windows.Forms.Control.IsInputKey%2A>方法。|[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]通过处理<xref:System.Windows.Forms.Control.KeyDown>事件更改默认键盘行为的控件将在宿主[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]控件中最后处理。 因为最后处理这些控件，所以它们可能产生意外行为。|  
|Enter 和 Leave 事件|如果焦点不会转到包含<xref:System.Windows.Forms.Integration.ElementHost>控件, 则在单个<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件中焦点更改时, Enter 和 Leave 事件会照常引发。|发生以下焦点更改时，不会引发 Enter 和 Leave 事件：<br /><br /> -从内部到<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件外。<br />-从外部到<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件内。<br />- <xref:System.Windows.Forms.Integration.WindowsFormsHost>控件外。<br />[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] -从<xref:System.Windows.Forms.Integration.WindowsFormsHost>控件中承载的控件到<xref:System.Windows.Forms.Integration.ElementHost>在同一<xref:System.Windows.Forms.Integration.WindowsFormsHost>中承载的控件。|  
...
### <a name="ambient-properties"></a>环境属性  
 [!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)] 控件的某些环境属性具有 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 等效项。 这些环境属性传播到所承载[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]的控件, 并作为<xref:System.Windows.Forms.Integration.ElementHost>控件上的公共属性公开。 控件将每个[!INCLUDE[TLA#tla_winforms](../../../../includes/tlasharptla-winforms-md.md)]环境属性转换为[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]其等效的。 <xref:System.Windows.Forms.Integration.ElementHost>  
