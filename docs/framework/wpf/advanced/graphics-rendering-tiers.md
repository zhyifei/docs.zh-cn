...
|功能|注意|  
|-------------|-----------|  
|3D 抗锯齿|仅支持 Windows 显示驱动程序模型（WDDM）的操作系统（例如 Windows Vista 和 [!INCLUDE[win7](../../../../includes/win7-md.md)]）支持3D 抗锯齿。|  
