...
---
# <a name="how-to-drag-and-drop-ink"></a><span data-ttu-id="9ccc3-102">如何：拖放墨迹</span><span class="sxs-lookup"><span data-stu-id="9ccc3-102">How to: Drag and Drop Ink</span></span>
## <a name="example"></a><span data-ttu-id="9ccc3-103">示例</span><span class="sxs-lookup"><span data-stu-id="9ccc3-103">Example</span></span>  
 <span data-ttu-id="9ccc3-104">下面的示例创建的应用程序使用户能够从一个拖动所选的笔画<xref:System.Windows.Controls.InkCanvas>相互。</span><span class="sxs-lookup"><span data-stu-id="9ccc3-104">The following example creates an application that enables the user to drag selected strokes from one <xref:System.Windows.Controls.InkCanvas> to the other.</span></span>  
