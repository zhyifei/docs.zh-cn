...
## <a name="improved-quality-and-performance-of-text"></a>改进的文本质量和性能  
 ...
 ![文本与 ClearType y&#45;的反方向&#45;别名](./media/typographyinwpf02.gif "TypographyInWPF02")  
采用 ClearType y 向抗锯齿的文本  
 ...
 ![文本呈现管道示意图](./media/typographyinwpf01.png "TypographyInWPF01")  
文本呈现管线示意图  
...
使用了投影的文本  
 ...
 ![有噪音的文本阴影](./media/shadowtext04.jpg "ShadowText04")  
使用了投影和噪音的文本  
  
 下面的示例演示了应用于文本的外发光效果。  
  
 ![使用 OuterGlowBitmapEffect 的文本阴影](./media/shadowtext05.jpg "ShadowText05")  
使用外发光效果的文本  
...
使用 SkewTransform 的文本  
 ...
 ![旋转文本的文本效果屏幕截图](./media/texteffect01.jpg "TextEffect01")  
旋转文本效果动画的示例  
...
#### <a name="using-flow-documents"></a>使用流文档  
 ...
 ![使用 OpenType 字体示例屏幕截图](./media/typographyinwpf-03.png "TypographyInWPF_03")  
