...
4.  添加以下代码为<xref:System.Windows.UIElement.DragOver>事件处理程序。  
    ...
    -   如果按下 CTRL 键时，设置<xref:System.Windows.DragEventArgs.Effects%2A>属性设置为<xref:System.Windows.DragDropEffects.Copy>。 否则，设置<xref:System.Windows.DragEventArgs.Effects%2A>属性设置为<xref:System.Windows.DragDropEffects.Move>。  
...
5.  添加以下代码为<xref:System.Windows.UIElement.Drop>事件处理程序。  
    ...
    -   如果<xref:System.Windows.UIElement.Drop>未处理事件，检查是否按下了 CTRL 键。  
  
    -   如果时按住 CTRL 键<xref:System.Windows.UIElement.Drop>发生，会复制该圆形控件并将其添加到<xref:System.Windows.Controls.Panel.Children%2A>的集合<xref:System.Windows.Controls.StackPanel>。  
  
    -   如果未按下了 CTRL 键，将移动从圆<xref:System.Windows.Controls.Panel.Children%2A>集合到其父面板的<xref:System.Windows.Controls.Panel.Children%2A>面板已被删除的集合。  
...
10. 在按下 Ctrl 键的同时，将一个圆形控件从其所在的面板拖放到其他面板。 将复制该圆形并将副本添加到<xref:System.Windows.Controls.Panel.Children%2A>接收面板的集合。  
