...
|术语|Definition|  
|----------|----------------|  
|<xref:System.Windows.Forms.Integration.WindowsFormsHost>|可用于将 Windows 窗体控件作为 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] 页的元素进行承载的元素。|  
|<xref:System.Windows.Forms.Integration.ElementHost>|可用于承载 [!INCLUDE[TLA#tla_winclient](../../../../includes/tlasharptla-winclient-md.md)] 控件的 Windows 窗体控件。|  
