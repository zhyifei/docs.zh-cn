...
#### <a name="modifying-the-controls-properties"></a>修改控件属性
 ...
 构建并运行应用程序。 在 Windows 窗体复合控件中添加一些文本，然后单击 **"确定"** 。 文本将显示在标签中。 单击不同的单选按钮查看在控件上的效果。  
