...
4. 从 BAML 提取可本地化资源时，BAML 本地化 API 会尊重可本地化属性。  
  
5. 以后可以将仅包含任意形式的注释的本地化注释文件合并到本地化过程中。  
  
 下面的示例演示如何向 XAML 文件添加本地化注释。  
