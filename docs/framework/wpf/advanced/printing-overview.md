...
-   改进的这两个.NET Framework 的打印性能和[!INCLUDE[TLA#tla_win32](../../../../includes/tlasharptla-win32-md.md)]基于应用程序。  
...
## <a name="gdi-print-path"></a>GDI 打印路径  
 虽然[!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)]应用程序以本机方式支持[!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)]打印路径[!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)]和 Windows 窗体应用程序还可以利用的一些[!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)]功能。 
          [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] 打印机驱动程序 (XPSDrv) 可以将基于 [!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)] 的输出转换为 [!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)] 格式。 对于高级方案，自定义内容的支持转换使用[Microsoft XPS 文档转换器 (MXDC)](https://msdn.microsoft.com/library/windows/desktop/ff686803.aspx)。 同样，[!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)]应用程序还可以输出到[!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)]通过调用之一的打印路径<xref:System.Windows.Xps.XpsDocumentWriter.Write%2A>或<xref:System.Windows.Xps.XpsDocumentWriter.WriteAsync%2A>方法<xref:System.Windows.Xps.XpsDocumentWriter>类和作为目标指定非 XpsDrv 打印机打印队列。  
...
-   有关在上的其他参考资料[!INCLUDE[TLA2#tla_gdi](../../../../includes/tla2sharptla-gdi-md.md)]打印路径及各种[!INCLUDE[TLA2#tla_metro](../../../../includes/tla2sharptla-metro-md.md)]转换选项，请参见[Microsoft XPS 文档转换器 (MXDC)](https://msdn.microsoft.com/library/windows/desktop/ff686803.aspx)和中的"XPSDrv" [Windows 驱动程序工具包](https://msdn.microsoft.com/library/windows/hardware/ff557573.aspx).  
