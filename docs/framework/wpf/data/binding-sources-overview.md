...
|ADO.NET 对象|可以将其绑定到 ADO.NET 对象，如<xref:System.Data.DataTable>。 ADO.NET<xref:System.Data.DataView>实现<xref:System.ComponentModel.IBindingList>接口，它提供了绑定引擎侦听的更改通知。|  
