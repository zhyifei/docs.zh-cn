...
> [!NOTE]
>  此示例是仅用于演示目的。 [!INCLUDE[TLA#tla_net](../../../../includes/tlasharptla-net-md.md)]准则建议您定义个数量级慢于字段集的属性。 有关详细信息，请参阅[NIB： 选择之间属性和方法](http://msdn.microsoft.com/en-us/55825e8f-7e2e-448a-9505-7217cc91b1af)。  
