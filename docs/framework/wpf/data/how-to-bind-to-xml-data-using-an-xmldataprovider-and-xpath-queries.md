...
## <a name="example"></a>示例  
 在以下示例中，数据作为 [!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)] 数据岛**直接嵌入 <xref:System.Windows.FrameworkElement.Resources%2A> 节中。[!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)] 数据岛必须包装在 `<x:XData>` 标记中，并且始终有一个根节点，在本示例中根节点为 *Inventory*。
