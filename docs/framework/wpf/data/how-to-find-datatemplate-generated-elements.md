...
## <a name="example"></a>示例  
 在此示例中， <xref:System.Windows.Controls.ListBox> 绑定到一些 [!INCLUDE[TLA2#tla_xml](../../../../includes/tla2sharptla-xml-md.md)] 数据：  
 ...
 如果你想要检索由指定 <xref:System.Windows.Controls.ListBoxItem> 的 <xref:System.Windows.DataTemplate> 生成的 <xref:System.Windows.Controls.TextBlock> 元素，您需要先获取 <xref:System.Windows.Controls.ListBoxItem>，找到 <xref:System.Windows.Controls.ListBoxItem> 中的 <xref:System.Windows.Controls.ContentPresenter>，然后调用该 <xref:System.Windows.Controls.ContentPresenter> 设置的 <xref:System.Windows.DataTemplate> 的 <xref:System.Windows.FrameworkTemplate.FindName%2A> 。 下面的示例演示如何执行这些步骤。 出于演示目的，此示例将创建一个消息框，显示 <xref:System.Windows.DataTemplate> 生成的 `TextBlock` 的文本内容。  
