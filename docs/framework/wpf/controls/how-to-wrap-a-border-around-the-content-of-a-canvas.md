...
## <a name="example"></a>示例  
 下面的示例演示如何显示`Hello World!`内<xref:System.Windows.Controls.Canvas>元素。 <xref:System.Windows.Controls.Canvas>由包装元素<xref:System.Windows.Controls.Border>元素以便边框概述了元素。  
