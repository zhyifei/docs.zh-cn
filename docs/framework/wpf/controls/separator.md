...
一个<xref:System.Windows.Controls.Separator>控件如绘制线条、 水平或垂直，在控件中，项之间<xref:System.Windows.Controls.ListBox>， <xref:System.Windows.Controls.Menu>，和<xref:System.Windows.Controls.ToolBar>。  
