...
3. 在 XAML 中，创建 <xref:System.Windows.Data.CollectionViewSource> 类的实例，设置[X：Key 指令](../../../desktop-wpf/xaml-services/xkey-directive.md)，并将集合类的实例设置为 <xref:System.Windows.Data.CollectionViewSource.Source%2A>。
