...
### <a name="creating-a-style-for-a-control"></a>为控件创建样式  
 利用 [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]，通过创建                          <xref:System.Windows.Style>，可以同时为许多控件指定相同的外观，而不是在应用程序中设置每个实例的属性。                           下面的示例在应用程序中                          创建应用于每个                          <xref:System.Windows.Controls.Button> 的                           <xref:System.Windows.Style>。                          <xref:System.Windows.Style> 定义通常在                           <xref:System.Windows.ResourceDictionary>（例如                         <xref:System.Windows.FrameworkElement> 的                          <xref:System.Windows.FrameworkElement.Resources%2A> 属性）中以                          [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] 形式定义。  
