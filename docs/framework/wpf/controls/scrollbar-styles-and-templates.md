---
title: "ScrollBar 样式和模板 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
---
# ScrollBar 样式和模板
本主题介绍 <xref:System.Windows.Controls.Primitives.ScrollBar> 控件的样式和模板。  您可以修改默认的 <xref:System.Windows.Controls.ControlTemplate>，以便为控件提供一个独特的外观。  有关更多信息，请参见[通过创建 ControlTemplate 自定义现有控件的外观](../../../../docs/framework/wpf/controls/customizing-the-appearance-of-an-existing-control.md)。  
  
## ScrollBar 部件  
 下表列出了 <xref:System.Windows.Controls.Primitives.ScrollBar> 控件的命名部件。  
  
||||  
|-|-|-|  
|组成部分|类型|说明|  
|PART\_Track|<xref:System.Windows.Controls.Primitives.Track>|指示 <xref:System.Windows.Controls.Primitives.ScrollBar> 位置的元素的容器。|  
