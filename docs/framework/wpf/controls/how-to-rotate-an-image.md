...
ms.locfileid: "61910301"
---
# <a name="how-to-rotate-an-image"></a><span data-ttu-id="a5540-102">如何：旋转图像</span><span class="sxs-lookup"><span data-stu-id="a5540-102">How to: Rotate an Image</span></span>
<span data-ttu-id="a5540-103">此示例演示如何通过将图像旋转 90 度<xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A>属性的<xref:System.Windows.Media.Imaging.BitmapImage>。</span><span class="sxs-lookup"><span data-stu-id="a5540-103">This example shows how to rotate an image 90 degrees by using a <xref:System.Windows.Media.Imaging.BitmapImage.Rotation%2A> property of a <xref:System.Windows.Media.Imaging.BitmapImage>.</span></span>  
  
## <a name="example"></a><span data-ttu-id="a5540-104">示例</span><span class="sxs-lookup"><span data-stu-id="a5540-104">Example</span></span>  
