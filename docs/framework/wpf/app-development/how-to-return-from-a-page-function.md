---
title: "如何：从页函数返回 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
## 示例  
 若要从页函数返回，需要调用 <xref:System.Windows.Navigation.PageFunction%601.OnReturn%2A> 并传递 <xref:System.Windows.Navigation.ReturnEventArgs%601> 的一个实例。  
