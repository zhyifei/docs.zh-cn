...
3. 在 "**启动选项**" 部分，将以下命令行参数添加到 "**命令行参数**" 文本框中：
     ...
     **-DebugSecurityZoneURL**参数的*URL*值是你要模拟为你的应用程序源站点的位置 [!INCLUDE[TLA#tla_url](../../../../includes/tlasharptla-url-md.md)]。

 作为示例，请考虑使用具有以下 URL 的 Web 服务的 [!INCLUDE[TLA#tla_xbap](../../../../includes/tlasharptla-xbap-md.md)]：
