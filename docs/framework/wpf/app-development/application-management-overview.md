...
|将启动屏幕添加到应用程序中|请参阅[将初始屏幕添加到 WPF 应用程序](../../../../docs/framework/wpf/app-development/how-to-add-a-splash-screen-to-a-wpf-application.md)。|  
...
|获取和保存应用程序的状态|请参阅[保持和还原应用程序作用域属性在应用程序会话之间](../../../../docs/framework/wpf/app-development/persist-and-restore-application-scope-properties.md)。|  
...
> [!NOTE]
>  在导航栏的详细信息，请参阅[导航概述](../../../../docs/framework/wpf/app-development/navigation-overview.md)。  
