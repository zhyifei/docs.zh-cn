...
## <a name="wpf-plug-in-for-firefox"></a>用于 Firefox 的 WPF 插件  
 使用 Firefox 的 WPF 插件，可以在 Firefox 浏览器中导航到 Xbap 和松散 [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] 文件，并在顶层或 HTML IFRAME 中运行。 XBAP 是一个 [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] 应用程序，可以将其发布到 Web 服务器并在支持的浏览器中启动该应用程序。 松散 [!INCLUDE[TLA2#tla_xaml](../../../../includes/tla2sharptla-xaml-md.md)] 是只能在受支持的浏览器中导航并显示的仅限 XAML 的文件，与 XML 文件非常类似。  
  
 Firefox 的 [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] 插件与 .NET Framework 3.5 一起安装。 Window 7 包含 .NET Framework 3.5，但不包括用于 Firefox 的 [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] 插件。 不能在 Windows 7 上安装适用于 Firefox 的 [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] 插件。  
  
 .NET Framework 4 不包含用于 Firefox 的 [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] 插件。 但是，如果同时安装了 .NET Framework 3.5 和 .NET Framework 4，则 Firefox 的 WPF 插件将与 .NET Framework 3.5 一起安装。 因此 .NET Framework 4 应用程序仍将运行，因为 WPF 主机将加载正确的框架版本。 有关详细信息，请参阅[WPF 主机（presentationhost.exe）](wpf-host-presentationhost-exe.md)。  
