...
> [!NOTE]
>  有关详细信息上安装、 部署和检测[!INCLUDE[TLA#tla_winfx](../../../../includes/tlasharptla-winfx-md.md)]，请参阅中的讨论[部署 Microsoft.NET Framework 版本 3.0](http://go.microsoft.com/fwlink/?LinkId=96739)。  
