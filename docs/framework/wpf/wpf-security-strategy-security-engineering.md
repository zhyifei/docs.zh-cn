...
- **禁止的 api**:在源代码中搜索, 以确定导致安全问题 (如`strcpy`) 的已知函数的意外用法。 一旦确定, 这些函数将被替换为更安全的替代项。  
...
- 对**来自其他产品的安全问题进行回归**:相关产品的相关安全问题会在何处进行测试。 例如, 已识别出 Internet Explorer 的大约60安全问题的适当变体, 并尝试将[!INCLUDE[TLA2#tla_winclient](../../../includes/tla2sharptla-winclient-md.md)]其适用性用于。  
