...
|功能区|功能|  
|------------------|-------------|  
|常规|浏览器窗口<br /><br /> 源站点访问<br /><br /> IsolatedStorage（512KB 限制）<br /><br /> UIAutomation 提供程序<br /><br /> 命令处理<br /><br /> 输入法编辑器 (IME)<br /><br /> 触笔和墨迹<br /><br /> 使用鼠标捕获和移动事件模拟的拖/放<br /><br /> OpenFileDialog<br /><br /> XAML 反序列化（通过 XamlReader.Load）|  
