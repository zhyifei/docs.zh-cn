...
ms.topic: "article"
helpviewer_keywords: 
  - ".NET Framework 1.1, 在 Windows 8 上运行"
  - "Windows 8, 运行 .NET Framework 1.1 应用程序"
...
---
# 在 Windows 8、Windows 8.1 或 Windows 10 上运行 .NET Framework 1.1 应用
...
## 从 CD 或下载中心安装 .NET Framework 1.1。  
