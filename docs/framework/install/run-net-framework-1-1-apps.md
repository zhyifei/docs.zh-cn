---
title: "在 Windows 8、Windows 8.1 或 Windows 10 上运行 .NET Framework 1.1 应用程序 | Microsoft Docs"
ms.custom: 
ms.date: 03/30/2017
...
---
# <a name="running-net-framework-11-apps-on-windows-8-windows-81-or-windows-10"></a>在 Windows 8、Windows 8.1 或 Windows 10 上运行 .NET Framework 1.1 应用
...
## <a name="installing-the-net-framework-11-from-a-cd-or-download-center"></a>从 CD 或下载中心安装 .NET Framework 1.1。  
...
## <a name="see-also"></a>另请参阅  
 ...
 [在 Windows 8 及更高版本上安装 .NET Framework 3.5](../../../docs/framework/install/net-framework-3-5-on-windows-8-plus.md)
