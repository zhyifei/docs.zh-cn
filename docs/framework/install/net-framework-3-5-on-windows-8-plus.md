---
title: "在 Windows 8、Windows 8.1 或 Windows 10 上安装 .NET Framework 3.5 的疑难解答"
ms.custom: 
ms.date: 04/20/2017
...
1.  按键盘上的 Windows 键 ![Windows 徽标](../../../docs/framework/get-started/media/windowskeyboardlogo.png "Windowskeyboardlogo")，键入 Windows 功能，然后按 Enter。 这将显示“打开或关闭 Windows 功能”  对话框。 或者，打开“控制面板”，单击“程序”项，然后单击“程序和功能”下的“启用或禁用 Windows 功能”。  
...
2.  如果弹出提示，选择“.NET Framework 3.5（包括 .NET 2.0 和 3.0）”  复选框，按“确定”，然后重启计算机。  
 ...
 ![在 Windows 8 或 8.1 上安装 .NET Framework](../../../docs/framework/get-started/media/clr-net35-win8.png "CLR_NET35_Win8")  
