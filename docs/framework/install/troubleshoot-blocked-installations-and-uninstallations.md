...
当你运行[web 或脱机安装程序](../../../docs/framework/install/guide-for-developers.md).NET Framework 4.5 或更高版本中，你可能会遇到禁止或阻止安装.NET Framework 的问题。 下表列出了可能产生的阻碍问题，并提供了指向疑难解答信息的链接。
...
> [!IMPORTANT]
> .NET Framework 4.x 版本是在就地更新，因为无法安装.NET Framework 4.x 的系统上已具有更高版本安装的早期版本。 例如，在使用 Windows 10 秋季创建者更新系统中，无法安装.NET Framework 4.6.2，因为.NET Framework 4.7.1 已预装随操作系统一起。
...
在此表中，4.5。*x*指的是.NET Framework 4.5 和及其后续版本 4.5.1 和 4.5.2、 4.6。*x*指的是.NET Framework 4.6 和其单点发行版中，4.6.1 4.6.2 和 4.7。*x*是指.NET Framework 4.7 和其点版本中，4.7.1。
...
|.NET Framework 4.5*.x*/4.6*.x*/4.7*.x* (*语言*) 需要.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*。 请安装.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*从下载中心，然后重新运行安装程序。|你必须先安装 .NET Framework 指定版本的英文版，然后再安装语言包。 有关详细信息，请参阅安装指南中有关[安装语言包](../../../docs/framework/install/guide-for-developers.md#to-install-language-packs)一节。|  
...
|.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*可再发行组件不适用于此操作系统。 请下载.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*适用于你从 Microsoft 下载中心的操作系统。|你可能尝试安装[!INCLUDE[net_v451](../../../includes/net-v451-md.md)]，4.5.2、 4.6、 4.6.1、 4.6.2、 4.7，或不受支持的平台上的 4.7.1 或你已选择不包含组件，为所有受支持操作系统的安装程序包。 通过使用脱机安装程序再次运行安装 ([4.5.1](http://go.microsoft.com/fwlink/p/?LinkId=309493)， [4.5.2](http://go.microsoft.com/fwlink/p/?LinkId=397706)， [4.6 的](http://go.microsoft.com/fwlink/p/?LinkId=528233)， [4.6.1](http://go.microsoft.com/fwlink/p/?LinkId=671744)，为[4.6.2](http://go.microsoft.com/fwlink/p/?LinkId=780604)，为[4.7](http://go.microsoft.com/fwlink/p/?LinkId=825306))，或为[4.7.1](http://go.microsoft.com/fwlink/p/?LinkId=852090)。 有关详细信息，请参阅适用于受支持操作系统的[安装指南](../../../docs/framework/install/guide-for-developers.md)和[系统需求](../../../docs/framework/get-started/system-requirements.md)。|  
...
|.NET framework 4.5*.x*/4.6*.x*/4.7*.x*尚未安装因为组件存储已损坏。|有关详细信息，请参阅[使用 DISM 或系统更新准备工具修复 Windows 更新错误](https://support.microsoft.com/en-us/kb/947821)。|  
...
|安装程序可能无法正常运行，因为 Windows Update 服务在此计算机上不可用。|可将计算机配置为使用 Windows Server Update Services (WSUS) 而非 Microsoft Windows Update。 有关详细信息，请参阅[尝试在 Windows 8 或 Windows Server 2012 上安装 .NET Framework 3.5 时出现的错误代码](http://support.microsoft.com/kb/2734782)中有关错误代码 0x800F0906 的一节。<br /><br /> 另请参阅 Microsoft 支持网站上的[如何获取 Windows 更新代理的最新版本以帮助管理计算机上的更新](http://go.microsoft.com/fwlink/p/?LinkId=248437)。|  
|安装程序可能无法正常运行，因为后台智能传输服务 (BITS) 在此计算机上不可用。|请参阅 Microsoft 支持网站上的[用于防止基于 Windows Vista 的计算机上的后台智能传输服务 (BITS) 发生崩溃的更新](http://go.microsoft.com/fwlink/p/?LinkId=248680)。|  
...
|.NET Framework 4.5 中。*.x*/4.6*.x*/4.7*.x*已是此操作系统的一部分。 不需要安装.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*可再发行组件。|不执行任何操作。<br /><br /> 要确定系统上安装了哪些版本的 .NET Framework，请参阅[如何：确定安装了哪些 .NET Framework 版本](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md)。 请参阅[系统需求](../../../docs/framework/get-started/system-requirements.md)以了解受支持的操作系统。|  
|.NET Framework 4.5*.x*/4.6*.x*/4.7*.x*不支持此操作系统上。|请参阅[系统需求](../../../docs/framework/get-started/system-requirements.md)以了解受支持的操作系统。<br /><br /> Windows 7 上安装 .NET Framework 失败时，此消息通常会指示未安装 Windows 7 SP1。 在 Windows 7 系统上，.NET Framework 要求安装 Windows 7 SP1。 如果你使用的是 Windows 7 系统，但尚未安装 Service Pack 1，则需要先安装 SP1，然后才能安装 .NET Framework。 有关安装 Windows 7 SP1 的信息，请参阅[了解如何安装 Windows 7 Service Pack 1 (SP1)](http://windows.microsoft.com/en-us/windows7/install-windows-7-service-pack-1)。|  
...
1. 在名称列中，查找[!INCLUDE[net_v45](../../../includes/net-v45-md.md)]、 4.5.1、 4.5.2、 4.6、 4.6.1、 4.6.2、 4.7 或 4.7.1 下载名称，具体的版本取决于你要安装，然后删除这些条目。 有关下载名称，请参阅[安装面向开发人员的 .NET Framework](../../../docs/framework/install/guide-for-developers.md) 一文。

1. 重新运行版本 4.5、 4.5.1、 4.5.2 或 4.6、 4.6.1、 4.6.2、 4.7 或 4.7.1 的.NET Framework 安装。
