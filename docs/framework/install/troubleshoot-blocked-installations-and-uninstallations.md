...
可以确定系统上安装了哪些版本的 .NET Framework。 请参阅[操作说明：确定已安装的 .NET Framework 版本](../../../docs/framework/migration-guide/how-to-determine-which-versions-are-installed.md)以获取详细信息。
