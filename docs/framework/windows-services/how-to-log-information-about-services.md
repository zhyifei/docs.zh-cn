---
title: "如何：记录关于服务的信息 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
4.  将 <xref:System.Diagnostics.EventLog> 组件实例上的 <xref:System.Diagnostics.EventLog.Source%2A> 属性设置为在步骤 3 中创建的源字符串。  
  
5.  通过访问 <xref:System.Diagnostics.EventLog> 组件实例上的 <xref:System.Diagnostics.EventLog.WriteEntry%2A> 方法来编写项。  
