...
## <a name="in-this-section"></a>本节内容  
 ...
 [如何：更改应用程序会话之间设置的值](../../../../docs/framework/winforms/advanced/how-to-change-the-value-of-a-setting-between-application-sessions.md)  
 ...
 [如何：向应用程序中添加多组设置C#](../../../../docs/framework/winforms/advanced/how-to-add-multiple-sets-of-settings-to-your-application-in-csharp.md)  
