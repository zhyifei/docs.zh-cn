...
此过程演示如何在 Visual Studio 中复制在 Windows 窗体上的 Windows Presentation Foundation (WPF) 控件。

## <a name="copy-and-paste-an-elementhost-control-at-design-time"></a>复制并粘贴 ElementHost 控件在设计时
