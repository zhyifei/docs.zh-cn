...
- 使用 <xref:System.Windows.Forms.Control.ControlCollection.Find%2A> 和 <xref:System.Windows.Forms.Control.Focus%2A> 方法可以指定要查找并将焦点提供给的控件的名称。  
...
- 使用 <xref:System.Windows.Forms.ImageList.ImageCollection.Item%2A> 属性可以指定要访问的映像的名称。  
...
- 结合使用 <xref:System.Windows.Forms.TabControl.SelectedTab%2A> 属性和 <xref:System.Windows.Forms.TabControl.TabPageCollection.Item%2A> 属性，以指定要设置为所选选项卡的选项卡页的名称。  
...
- [如何：使用 Windows 窗体 ImageList 组件添加或删除图像](./controls/how-to-add-or-remove-images-with-the-windows-forms-imagelist-component.md)
