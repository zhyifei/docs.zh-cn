...
## <a name="in-this-section"></a>本节内容  
 ...
 [如何：在运行时为 Windows 窗体创建事件处理程序](../../../docs/framework/winforms/how-to-create-event-handlers-at-run-time-for-windows-forms.md)  
 提供有关如何动态响应系统或用户事件的指令。  
  
 [如何：将多个事件连接到 Windows 窗体中的单个事件处理程序](../../../docs/framework/winforms/how-to-connect-multiple-events-to-a-single-event-handler-in-windows-forms.md)  
 ...
 [如何：创建事件处理程序使用设计器](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2010/zwwsdtbk(v=vs.100))  
