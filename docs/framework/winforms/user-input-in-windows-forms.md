...
## <a name="in-this-section"></a>本节内容  
 ...
 [如何：模拟鼠标和键盘事件中的代码](../../../docs/framework/winforms/how-to-simulate-mouse-and-keyboard-events-in-code.md)  
 演示通过编程模拟鼠标和键盘输入的几种不同方式。  
  
 [如何：处理 Windows 窗体控件中的用户输入的事件](../../../docs/framework/winforms/how-to-handle-user-input-events-in-windows-forms-controls.md)  
