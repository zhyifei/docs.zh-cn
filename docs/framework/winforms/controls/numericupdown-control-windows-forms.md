...
## <a name="in-this-section"></a>本节内容  
 ...
 [如何：设置并返回数字值使用 Windows 窗体 NumericUpDown 控件](set-and-return-numeric-values-with-wf-numericupdown-control.md)  
 描述如何测试控件的值。  
...
## <a name="related-sections"></a>相关章节  
 ...
 引入了一个控件类似于<xref:System.Windows.Forms.NumericUpDown>，只不过<xref:System.Windows.Forms.DomainUpDown>控件显示字符串而不是数字值。
