...
> [!NOTE]
> **工具箱**不遵循引用链，因此它不会显示并非由你的解决方案中的项目生成的项。
...
1. 在 Visual Studio 中，创建一个名为基于 Windows 的应用程序项目`ToolboxExample`(**文件** > **新建** > **项目** > **可视化C#** 或**Visual Basic** > **经典桌面** > **Windows 窗体应用程序**)。
...
## <a name="unload-and-reload-a-custom-component"></a>卸载并重新加载自定义组件
