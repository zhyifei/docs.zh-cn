...
## <a name="in-this-section"></a>本节内容  
 ...
 描述<xref:System.Windows.Forms.Control.AutoSize%2A>属性和它在布局中的作用。  
  
 [Windows 窗体控件中的边距和填充](../../../../docs/framework/winforms/controls/margin-and-padding-in-windows-forms-controls.md)  
 描述<xref:System.Windows.Forms.Control.Margin%2A>和<xref:System.Windows.Forms.Control.Padding%2A>属性和布局中的其角色。  
