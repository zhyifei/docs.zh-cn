...
-   默认为 <xref:System.Windows.Forms.ToolStripLayoutStyle.StackWithOverflow>。 此设置会导致<xref:System.Windows.Forms.ToolStrip>若要更改其自动根据所使用的布局<xref:System.Windows.Forms.ToolStrip.Orientation%2A>属性来处理拖动和停靠的方案。  
