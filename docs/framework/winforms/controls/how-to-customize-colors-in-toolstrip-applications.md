---
title: "如何：自定义 ToolStrip 应用程序中的颜色 | Microsoft Docs"
ms.custom: ""
ms.date: "03/30/2017"
...
dev_langs: 
  - "jsharp"
helpviewer_keywords: 
  - "颜色, 在 ToolStrip 控件 [Windows 窗体] 中自定义"
  - "工具栏 [Windows 窗体], 自定义颜色"
  - "ToolStrip 控件 [Windows 窗体], 自定义颜色"
