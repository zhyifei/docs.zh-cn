...
## <a name="in-this-section"></a>本节内容  
 ...
 [如何：使用 Windows 窗体 GroupBox 控件对控件进行分组](../../../../docs/framework/winforms/controls/how-to-group-controls-with-the-windows-forms-groupbox-control.md)  
 介绍如何使用此控件绑定到组控件。  
