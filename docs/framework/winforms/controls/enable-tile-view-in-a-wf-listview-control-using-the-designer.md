...
使用<xref:System.Windows.Forms.ListView>控件的磁贴视图功能, 可以在图形和文本信息之间提供视觉平衡。 磁贴视图中，为项目显示的文本信息与为详细信息视图定义的列信息相同。 平铺视图函数与<xref:System.Windows.Forms.ListView>控件中的分组或插入标记功能结合在一起。
...
2. 在 "**属性**" 窗口中, <xref:System.Windows.Forms.ListView.View%2A>选择属性, 然后选择 "**磁贴**"。
