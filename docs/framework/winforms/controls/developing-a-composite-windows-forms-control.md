...
-   [演练：使用 Visual C# 从 Windows 窗体控件继承](http://msdn.microsoft.com/library/09476da0-8d4c-4a4c-b969-649519dfb438)  
...
-   [演练：使用 Visual C# 创作复合控件](http://msdn.microsoft.com/library/f88481a8-c746-4a36-9479-374ce5f2e91f)）  
