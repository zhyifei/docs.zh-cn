...
---
# <a name="statusbar-control-overview-windows-forms"></a><span data-ttu-id="28653-102">StatusBar 控件概述（Windows 窗体）</span><span class="sxs-lookup"><span data-stu-id="28653-102">StatusBar Control Overview (Windows Forms)</span></span>
> [!IMPORTANT]
