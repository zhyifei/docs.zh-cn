...
6.  将以下代码添加到你的项目的代码文件。  
    ...
    > [!IMPORTANT]
    >  确保`webBrowser1_DocumentCompleted`事件处理程序配置为侦听程序<xref:System.Windows.Forms.WebBrowser.DocumentCompleted>事件。 在 Visual Studio 中，双击<xref:System.Windows.Forms.WebBrowser>控制; 请在文本编辑器中，以编程方式配置侦听器。  
