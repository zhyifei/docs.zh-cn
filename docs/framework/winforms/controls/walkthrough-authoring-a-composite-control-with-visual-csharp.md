...
7. 在 "**工具箱**" 中, 找到并双击 " **DateTimePicker** " 将<xref:System.Windows.Forms.DateTimePicker>控件添加到<xref:System.Windows.Forms.Label>窗体, 然后双击 "**标签**" 添加控件。
...
14. 单击 "小时" 的显示位置。<xref:System.Windows.Forms.DateTimePicker>
