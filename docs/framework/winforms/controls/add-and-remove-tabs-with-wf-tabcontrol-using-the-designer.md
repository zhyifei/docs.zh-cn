...
### <a name="to-add-or-remove-a-tab-using-the-designer"></a>若要添加或删除使用设计器的选项卡  
  
-   在控件的智能标记上，单击**添加选项卡**或**删除选项卡**  
  
     或  
  
     在中**属性**窗口中，单击**省略号**按钮 (![VisualStudioEllipsesButton 屏幕快照](../../../../docs/framework/winforms/media/vbellipsesbutton.png "vbEllipsesButton")) 旁边<xref:System.Windows.Forms.TabControl.TabPages%2A>以打开**TabPage 集合编辑器**。 单击**外**或**删除**按钮。  
