...
> [!NOTE]
>  若要选择文件，而不是文件夹，请使用[OpenFileDialog](../../../../docs/framework/winforms/controls/openfiledialog-component-windows-forms.md)组件。  
...
- [如何：选择使用 Windows 窗体 FolderBrowserDialog 组件的文件夹](../../../../docs/framework/winforms/controls/how-to-choose-folders-with-the-windows-forms-folderbrowserdialog-component.md)
