...
## <a name="in-this-section"></a>本节内容  
 ...
 引入了的一般概念<xref:System.Windows.Forms.ColorDialog>组件，使你可以显示预配置的对话框中，用户可以使用从调色板选择颜色。  
 ...
 [如何：显示调色板使用 ColorDialog 组件](how-to-show-a-color-palette-with-the-colordialog-component.md)  
 介绍如何在运行时通过的实例选择一种颜色<xref:System.Windows.Forms.ColorDialog>组件。  
