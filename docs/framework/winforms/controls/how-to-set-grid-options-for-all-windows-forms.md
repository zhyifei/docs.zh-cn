...
2.  在左窗格中**选项**对话框中，单击**Windows 窗体设计器**。  
     ...
     在右窗格中下,**布局设置**标题时，您可以设置默认为所有新窗体的网格设置。 这些设置包括的网格大小、 是否控件对齐，以及它是否在默认情况下。 此外，您可以选择**SnapToGrid**并**对齐线**布局模式。 对齐线的详细信息，请参阅[演练： Windows 窗体使用对齐线上排列控件](../../../../docs/framework/winforms/controls/walkthrough-arranging-controls-on-windows-forms-using-snaplines.md)。  
