...
---
# <a name="how-to-set-alternating-row-styles-for-the-windows-forms-datagridview-control-using-the-designer"></a>如何：设置为使用设计器在 Windows 窗体 DataGridView 控件中交替行样式
