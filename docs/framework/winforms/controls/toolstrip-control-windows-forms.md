...
## <a name="in-this-section"></a>本节内容  
 ...
 [如何：ToolStrip 控件中启用自动完成](../../../../docs/framework/winforms/controls/how-to-enable-autocomplete-in-toolstrip-controls-in-windows-forms.md)  
 演示 <xref:System.Windows.Forms.ToolStripComboBox> 中的自动完成功能。  
  
 [如何：更改的间距和对齐方式在 Windows 窗体的 ToolStrip 项](../../../../docs/framework/winforms/controls/how-to-change-the-spacing-and-alignment-of-toolstrip-items-in-windows-forms.md)  
 描述在 <xref:System.Windows.Forms.ToolStrip> 上排列 <xref:System.Windows.Forms.ToolStripItem> 的各种方法。  
  
 [如何：更改 ToolStrip 文本和图像在 Windows 窗体中的外观](../../../../docs/framework/winforms/controls/how-to-change-the-appearance-of-toolstrip-text-and-images-in-windows-forms.md)  
 描述如何在 <xref:System.Windows.Forms.ToolStripItem> 控件中定义和修改文本和图像的排列方式。  
  
 [如何：Windows 窗体使用 ToolStripControlHost 包装控件](../../../../docs/framework/winforms/controls/how-to-wrap-a-windows-forms-control-with-toolstripcontrolhost.md)  
 演示如何在 <xref:System.Windows.Forms.ToolStripControlHost> 中承载 <xref:System.Windows.Forms.MonthCalendar> 控件。  
  
 [如何：创建并设置自定义呈现器在 Windows 窗体的 ToolStrip 控件](../../../../docs/framework/winforms/controls/create-and-set-a-custom-renderer-for-the-toolstrip-control-in-wf.md)  
 ...
 [如何：将 ToolStrip 从 toolstripcontainer 移到窗体](../../../../docs/framework/winforms/controls/how-to-move-a-toolstrip-out-of-a-toolstripcontainer-onto-a-form.md)  
 ...
 [如何：启用 TAB 键能够移出 ToolStrip 控件](../../../../docs/framework/winforms/controls/how-to-enable-the-tab-key-to-move-out-of-a-toolstrip-control.md)  
 ...
 [如何：创建具有菜单合并功能和 ToolStrip 控件的 MDI 窗体](../../../../docs/framework/winforms/controls/how-to-create-an-mdi-form-with-menu-merging-and-toolstrip-controls.md)  
