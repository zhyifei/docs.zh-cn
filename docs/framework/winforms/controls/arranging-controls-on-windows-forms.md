...
## <a name="in-this-section"></a>本节内容
 ...
 介绍如何通过将放置在窗体上的控件<xref:System.Windows.Forms.Control.Margin%2A>， <xref:System.Windows.Forms.Control.Padding%2A>，并<xref:System.Windows.Forms.Control.AutoSize%2A>内的属性**窗体设计器**Visual Studio 中。
