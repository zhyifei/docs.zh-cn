...
## <a name="in-this-section"></a>本节内容  
 ...
 描述如何处理 <xref:System.Windows.Forms.DataGridView.CellFormatting> 事件以便为各个单元格提供不同的工具提示。  
