...
## <a name="in-this-section"></a>本节内容  
 ...
 描述如何处理<xref:System.Windows.Forms.DataGridView.CellFormatting>事件，以便为各个单元提供不同的工具提示。  
 ...
 [如何：在 Windows 窗体 DataGridView 控件中控制区段](../../../../docs/framework/winforms/controls/how-to-manipulate-bands-in-the-windows-forms-datagridview-control.md)  
 描述如何在使用类型的对象编程<xref:System.Windows.Forms.DataGridViewBand>，即行和列的基类型。  
  
 [如何：在 Windows 窗体 DataGridView 控件中控制行](../../../../docs/framework/winforms/controls/how-to-manipulate-rows-in-the-windows-forms-datagridview-control.md)  
 描述如何在使用类型的对象编程`DataGridViewRow`。  
 ...
 描述如何在使用类型的对象编程`DataGridViewColumn`。  
 ...
 描述如何使用进行编程`DataGridViewImageColumn`类。  
