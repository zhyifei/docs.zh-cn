...
如果希望在 "**工具箱**" 中显示控件的特殊图标, 则可以使用<xref:System.Drawing.ToolboxBitmapAttribute>指定特定图像。 此类是一个特性，是一种可以附加到其他类上的特殊类。 有关特性的详细信息, 请参阅的C#[特性概述 (Visual Basic](../../../visual-basic/programming-guide/concepts/attributes/index.md) Visual Basic [C#](../../../csharp/programming-guide/concepts/attributes/index.md) )。  
