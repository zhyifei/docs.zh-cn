...
使用的最常见方案之一<xref:System.Windows.Forms.DataGridView>控件是*母版/详细信息*窗体，其中显示了两个数据库表之间的父/子关系。 在主表中选择行，则会导致要使用的相应子数据更新的详细信息表。  
 ...
 若要将代码复制本主题中的一个列表，请参阅[如何：创建使用两个 Windows 窗体 DataGridView 控件的母版/详细信息窗体](../../../../docs/framework/winforms/controls/create-a-master-detail-form-using-two-datagridviews.md)。  
...
- [如何：创建使用两个 Windows 窗体 DataGridView 控件的母版/详细信息窗体](../../../../docs/framework/winforms/controls/create-a-master-detail-form-using-two-datagridviews.md)
