...
1. 设置通过 <xref:System.Windows.Forms.DataGridViewCellStyle> 属性检索的 <xref:System.Windows.Forms.DataGridView.DefaultCellStyle%2A?displayProperty=nameWithType> 的属性。  
