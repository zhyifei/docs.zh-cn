...
- 你的组织可能尚未准备好迁移到云, 或者由于业务原因, 可能无法移到云中。 不过, 您仍可以在自己的数据中心内使用 Windows 容器。

- 你可能有其他正在本地使用的项目, 并且可能会在尝试迁移到云时降低你的停机时间。 例如, 安全或身份验证依赖于本地 Windows Server Active Directory 或任何其他本地资产。

- 如果你现在开始使用 Windows 容器, 则可以从更好的位置逐步迁移到云。 Windows 容器正在成为任何云的部署单元, 无锁定。
