...
可在此处获取完整的链接缩短符存储库, 其中包含说明:[无服务器 URL 缩短符](https://github.com/jeremylikness/serverless-url-shortener)。 可在此处阅读有关简化版本的信息:[Azure Storage for 无服务器 .net 应用 (分钟)](https://blogs.msdn.microsoft.com/webdev/2018/01/25/azure-storage-for-serverless-net-apps-in-minutes/)。
...
* [Azure Storage for 无服务器 .NET 应用 (分钟)](https://blogs.msdn.microsoft.com/webdev/2018/01/25/azure-storage-for-serverless-net-apps-in-minutes/)
