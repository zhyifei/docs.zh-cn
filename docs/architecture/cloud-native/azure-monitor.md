...
![Azure Monitor，这是一项工具的集合，可让你深入了解云本机应用程序的工作方式。 ](./media/azure-monitor.png)
...
![在 Azure 主仪表板 ](./media/azure-monitor.png)
...
![Power BI 仪表板 ](./media/azure-monitor.png)
 **图 7-15**的示例。 Power BI 仪表板的示例。
