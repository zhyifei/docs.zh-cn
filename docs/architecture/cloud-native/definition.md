...
在本指南中，在 [十二个因素的应用程序之外](https://content.pivotal.io/blog/beyond-the-twelve-factor-app)，将 Hoffman 的每一个原始12个因素（以2011编写）为依据。 此外，他还讨论了三个反映当今新式云应用程序设计的其他因素。
...
> *\#第8个因素8指定 "服务跨大量的小型相同进程（副本）进行扩展，而不是在功能最强大的计算机上扩展单个大型实例。"*
