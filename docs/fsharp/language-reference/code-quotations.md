...
## <a name="expr-type"></a><span data-ttu-id="3e683-129">Expr 类型</span><span class="sxs-lookup"><span data-stu-id="3e683-129">Expr Type</span></span>
