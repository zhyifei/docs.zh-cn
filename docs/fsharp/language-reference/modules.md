...
## <a name="referencing-code-in-modules"></a><span data-ttu-id="0506a-131">引用的模块中的代码</span><span class="sxs-lookup"><span data-stu-id="0506a-131">Referencing Code in Modules</span></span>
