...
F # 和 Visual F # 工具支持在 Visual Studio Mac IDE。  若要开始，你应[下载适用于 Mac 的 Visual Studio](https://www.visualstudio.com/downloads/download-visual-studio-vs)，如果你尚未。  本文使用 Visual Studio 社区 2017 for Mac，但你可以使用 F # 与所选的版本。
