...
## <a name="completing-the-requirements"></a><span data-ttu-id="be0d3-153">完成要求</span><span class="sxs-lookup"><span data-stu-id="be0d3-153">Completing the requirements</span></span>
