...
<span data-ttu-id="7bf2c-169">运行此命令时不执行隐式还原。</span><span class="sxs-lookup"><span data-stu-id="7bf2c-169">Doesn't execute an implicit restore when running the command.</span></span>
