...
有关如何训练 GAM 模型并检查和解释结果的示例，请参阅[二进制分类训练器示例](https://github.com/dotnet/machinelearning/blob/master/docs/samples/Microsoft.ML.Samples/Dynamic/Trainers/BinaryClassification/Gam.cs)。
